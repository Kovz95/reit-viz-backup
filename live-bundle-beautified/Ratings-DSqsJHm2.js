...
function $e(e, t) {
    for (var r = 0; r < t.length; r++) {
        var n = t[r];
        n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, We(n.key), n)
    }
}
...
var ee = (function(e) {
    ...
    return Lt(t, e), Rt(t, [{
        ...
        value: function(n) {
            ...
            return ne(i) && typeof i == "number" ? d = Math.max(i, d) : i && Array.isArray(i) && i.length && (d = Math.max(ue(i.map(function(y) {
                return y.y || 0
        ...
        value: function(n) {
            ...
            return s === "vertical" ? this.renderVerticalRect(n) : this.renderHorizontalRect(n)
        }
    }, {
        ...
        value: function(n, s) {
            ...
            return P.createElement(Te, {
                ...
                return P.createElement(q, null, P.createElement("defs", null, P.createElement("clipPath", {
        ...
        value: function(n, s) {
            var i = this.props,
                ...
                d = f.prevBaseLine,
                y = f.totalLength;
            return x && u && u.length && (!l && y > 0 || !ge(l, u) || !ge(d, p)) ? this.renderAreaWithAnimation(n, s) : this.renderAreaStatically(u, p, n, s)
        }
    }, {
        key: "render",
        value: function() {
            ...
            return P.createElement(q, {
                ...
                width: h + L,
                height: A + L
            }))) : null, $ ? null : this.renderArea(w, g), (u || $) && this.renderDots(w, K, g), (!k || _) && Fe.renderCallByParent(this.props, p))
        }
    }], [{
...
G(ee, "getBaseValue", function(e, t, r, n) {
    ...
    if (x.type === "number") {
        var l = Math.max(f[0], f[1]),
            d = Math.min(f[0], f[1]);
        return p === "dataMin" ? d : p === "dataMax" || l < 0 ? l : Math.max(Math.min(f[0], f[1]), 0)
    }
...
function Ce(e, t) {
    for (var r = 0; r < t.length; r++) {
        var n = t[r];
        n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, Je(n.key), n)
    }
}
...
var ve = (function(e) {
    ...
    return ln(t, e), rn(t, [{
        ...
        value: function() {
            ...
            return i && s && s.length && (!u || !ge(u, s)) ? this.renderSymbolsWithAnimation() : this.renderSymbolsStatically(s)
        }
    }, {
        key: "renderErrorBar",
        value: function() {
        ...
        value: function() {
            ...
            return P.isValidElement(i) ? d = P.cloneElement(i, $) : fe(i) ? d = i($) : d = P.createElement(de, ce({}, $, {
                type: p
            })), P.createElement(q, {
        ...
        value: function() {
            ...
            return P.createElement(q, {
                ...
                width: $ ? y : y * 2,
                height: O ? h : h * 2
            }))) : null, u && this.renderLine(), this.renderErrorBar(), P.createElement(q, {
...
function dn({
    ...
    const [t, r] = R.useState("pct"), {
        ...
        queryFn: async () => {
            const [l, d, y, h, A] = await Promise.all([oe(e, "Buy Ratings"), oe(e, "Hold Ratings"), oe(e, "Sell Ratings"), oe(e, "Bull%"), oe(e, "Bear%")]);
            return {
                buy: l,
                hold: d,
                sell: y,
        ...
        const l = new Map(n.buy.map(c => [c.time, c.value])),
            ...
            S = [...new Set([...n.buy.map(c => c.time), ...n.hold.map(c => c.time), ...n.sell.map(c => c.time)])].sort(),
            _ = new Map;
        for (const c of S) {
            const b = l.get(c) ?? 0,
                w = d.get(c) ?? 0,
        ...
        if (_.size <= 12) {
            ...
            for (const [w, g] of c) {
                const B = g.buys.reduce((L, o) => L + o, 0) / g.buys.length,
                    ...
                    T = B + j + F;
                if (T <= 0) continue;
                const [C, M] = w.split("-"), K = `${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][parseInt(M)-1]} ${C.slice(2)}`;
                b.push({
                    date: K,
                    sortKey: w,
                    buy: Math.round(B),
                    ...
                    holdPct: j / T * 100,
                    sellPct: F / T * 100,
                    bull: g.bulls.length > 0 ? g.bulls.reduce((L, o) => L + o, 0) / g.bulls.length * 100 : null,
                    bear: g.bears.length > 0 ? g.bears.reduce((L, o) => L + o, 0) / g.bears.length * 100 : null,
                    total: Math.round(T)
                })
            }
        ...
        for (const [c, b] of _) {
            ...
            O.push({
                ...
                holdPct: g / j * 100,
                sellPct: B / j * 100,
                bull: b.bulls.length > 0 ? b.bulls.reduce((M, I) => M + I, 0) / b.bulls.length * 100 : null,
                bear: b.bears.length > 0 ? b.bears.reduce((M, I) => M + I, 0) / b.bears.length * 100 : null,
                total: Math.round(j)
            })
        }
...
function pn(e) {
    return e >= 70 ? "bg-emerald-600/70 text-white" : e >= 50 ? "bg-emerald-600/40 text-emerald-200" : e >= 30 ? "bg-yellow-600/40 text-yellow-200" : "bg-red-600/40 text-red-200"
}

function mn(e) {
    return e >= 20 ? "bg-red-600/70 text-white" : e >= 10 ? "bg-red-600/40 text-red-200" : e >= 5 ? "bg-yellow-600/30 text-yellow-200" : "bg-emerald-600/30 text-emerald-200"
}
...
function bn() {
    const {
        activeTickers: e
    } = mt(), [t, r] = R.useState("subsector"), [n, s] = R.useState("buyPct"), [i, u] = R.useState("desc"), [p, x] = R.useState(ft()), [f, l] = R.useState(""), [d, y] = R.useState(new Set), [h, A] = R.useState(new Set), [k, S] = R.useState(null), _ = R.useCallback(() => ({
        groupBy: t,
        sortKey: n,
        sortDir: i,
        classFilters: ht(p),
        ...
        o.groupBy !== void 0 && r(o.groupBy), o.sortKey !== void 0 && s(o.sortKey), o.sortDir !== void 0 && u(o.sortDir), o.classFilters !== void 0 && x(xt(o.classFilters)), o.search !== void 0 && l(o.search), o.manualTickers !== void 0 && y(new Set(o.manualTickers)), o.collapsed !== void 0 && A(new Set(o.collapsed))
    }, []);
    yt("ratings", _, $);
    const O = o => {
            r(o)
        ...
        c = o => {
            o === n ? u(i === "asc" ? "desc" : "asc") : (s(o), u(o === "ticker" || o === "name" ? "asc" : "desc"))
        },
        b = o => {
            x(o)
        },
        ...
        I = () => {
            const o = ["Ticker", "Name", "Subsector", "Industry", "Buy", "Hold", "Sell", "Total", "Buy%", "Hold%", "Sell%", "Bull%", "Bear%"].join(","),
                m = F.map(v => [v.ticker, `"${v.name}"`, `"${v.subsector}"`, `"${v.industry}"`, v.buyCount ?? "", v.holdCount ?? "", v.sellCount ?? "", v.totalCount, v.buyPct != null ? v.buyPct.toFixed(1) : "", v.holdPct != null ? v.holdPct.toFixed(1) : "", v.sellPct != null ? v.sellPct.toFixed(1) : "", v.bullPct != null ? v.bullPct.toFixed(1) : "", v.bearPct != null ? v.bearPct.toFixed(1) : ""].join(",")),
                N = new Blob([o + `
` + m.join(`
`)], {
                    type: "text/csv"
        ...
        L = ({
            ...
            return a.jsxs("div", {
                ...
                children: [te(m, "bg-emerald-600", "Buy", "text-white"), te(N, "bg-zinc-500", "Hold", "text-white"), te(E, "bg-red-600", "Sell", "text-white")]
            })
        };
    return B ? a.jsx("div", {
                    ...
                    children: T.map(o => a.jsxs(P.Fragment, {
                        children: [o.label && a.jsxs("tr", {
                            ...
                            children: [a.jsx("td", {
                                ...
                                children: (o.rows.reduce((m, N) => m + (N.buyPct ?? 0), 0) / o.rows.length).toFixed(0)
                            }), a.jsx("td", {
                                className: "px-2 py-1 text-right text-[10px] text-zinc-400 font-medium",
                                children: (o.rows.reduce((m, N) => m + (N.holdPct ?? 0), 0) / o.rows.length).toFixed(0)
                            }), a.jsx("td", {
                                className: "px-2 py-1 text-right text-[10px] text-red-400 font-medium",
                                children: (o.rows.reduce((m, N) => m + (N.sellPct ?? 0), 0) / o.rows.length).toFixed(0)
                            }), a.jsx("td", {
                                className: "px-2 py-1 text-right text-[10px] text-muted-foreground",
                                children: (o.rows.reduce((m, N) => m + N.totalCount, 0) / o.rows.length).toFixed(0)
                            }), a.jsx("td", {
                                className: "px-2 py-1 text-right text-[10px] text-muted-foreground"
                            }), a.jsx("td", {
                                className: "px-2 py-1 text-right text-[10px] text-muted-foreground"
                            })]
                        }), !h.has(o.label) && o.rows.map(m => a.jsxs(P.Fragment, {
                            children: [a.jsxs("tr", {
                                className: `border-b border-border/20 hover:bg-accent/30 transition-colors cursor-pointer ${k===m.ticker?"bg-accent/40":""}`,
                                onClick: () => S(k === m.ticker ? null : m.ticker),
                                children: [a.jsx("td", {
                                    className: "px-2 py-1 font-mono font-semibold text-foreground",
                                    children: a.jsxs("span", {
                                        className: "flex items-center gap-1",
                                        children: [k === m.ticker ? a.jsx(Nt, {
                                    ...
                                    children: a.jsxs("div", {
                                        ...
                                        children: [te(m.buyPct ?? 0, "bg-emerald-600", "Buy", "text-white"), te(m.holdPct ?? 0, "bg-zinc-500", "Hold", "text-white"), te(m.sellPct ?? 0, "bg-red-600", "Sell", "text-white")]
                                    })
                                }), a.jsx("td", {
                                    className: `px-2 py-1 text-right font-mono tabular-nums ${m.buyPct!=null?pn(m.buyPct):""}`,
                                    children: m.buyPct != null ? `${m.buyPct.toFixed(0)}` : "—"
                                }), a.jsx("td", {
                                    className: "px-2 py-1 text-right font-mono tabular-nums text-zinc-300",
                                    children: m.holdPct != null ? `${m.holdPct.toFixed(0)}` : "—"
                                }), a.jsx("td", {
                                    className: `px-2 py-1 text-right font-mono tabular-nums ${m.sellPct!=null?mn(m.sellPct):""}`,
                                    children: m.sellPct != null ? `${m.sellPct.toFixed(0)}` : "—"
                                }), a.jsx("td", {
                                    ...
                                    children: m.bullPct != null ? `${m.bullPct.toFixed(0)}` : "—"
                                }), a.jsx("td", {
                                    className: "px-2 py-1 text-right font-mono tabular-nums text-red-400/80",
                                    children: m.bearPct != null ? `${m.bearPct.toFixed(0)}` : "—"
                                })]
                            }), k === m.ticker && a.jsx("tr", {
                                children: a.jsx("td", {
                                    colSpan: t !== "none" ? 10 : 9,
