...
function st(z, Ee, d) {
    ...
    for (let x = Math.max(d.length, d.smo) + 1; x < z.length; x++)
        ...
        const r = j.bullPressure[x - 1],
            ...
            ee = j.b[x - 1],
            C = j.b[x];
        if (!Number.isFinite(r) || !Number.isFinite(I) || !Number.isFinite(M) || !Number.isFinite(Y)) continue;
        ...
        const r = j.bullPressure[x - 1],
            ...
            B = j.bearPressure[x - 1],
            Q = j.bearPressure[x];
        if (!Number.isFinite(r) || !Number.isFinite(I) || !Number.isFinite(B) || !Number.isFinite(Q)) continue;
        const M = r - B,
            Y = I - Q;
...
function Ys() {
    const [z, Ee] = o.useState([]), [d, j] = o.useState(""), [k, G] = o.useState(""), [y, x] = o.useState(""), [r, I] = o.useState("single"), [B, Q] = o.useState([]), [M, Y] = Pe("tva-basket-mode", "stocks"), {
        baskets: ee
    } = ns(), [C, K] = o.useState(!1), [ne, E] = o.useState({
        current: 0,
        total: 0
    }), [ae, ue] = Pe("tva-input-selection", Ns), [pe, rt] = Pe("tva:results", []), [me, _e] = o.useState([]), [$t, ot] = o.useState(null), [Ce, It] = o.useState("score"), [Oe, Mt] = o.useState("composite"), nt = o.useMemo(() => as(Oe), [Oe]), [ze, Et] = o.useState(""), [_t, Ot] = o.useState(new Set), zt = o.useCallback(e => {
        Ot(l => {
            const u = new Set(l);
            return u.has(e) ? u.delete(e) : u.add(e), u
        })
    }, []), [at, ie] = o.useState("10y"), [R, le] = o.useState(() => is()), [W, Ue] = o.useState(.05), [xe, it] = o.useState(!0), [ge, lt] = o.useState(!0), [fe, ct] = o.useState(!0), [we, dt] = o.useState("optimize"), [te, ut] = o.useState("long"), [Se, pt] = Pe("tva:evalResult", null), [Te, mt] = o.useState(null), [Ve, F] = o.useState(!1), [Z, Ut] = o.useState("regime"), [be, Vt] = o.useState(20), [he, Ht] = o.useState(5), [ke, Gt] = o.useState(5), [ve, Kt] = o.useState(.5), [He, qt] = o.useState(0), Be = o.useRef(!1), xt = o.useRef(!1), {
        universeTickers: Ge
    } = ls(), w = o.useMemo(() => Ge ? z.filter(e => Ge.has(e.ticker)) : z, [z, Ge]), Re = Ss(w, r === "universe", "tva-clf"), se = Ts(w.map(e => e.ticker), r === "pairCombo", "tva-pc"), Ke = Re.filteredTickers, {
        frequency: J,
        frequencyUI: Yt,
        setFrequency: qe
    ...
    o.useEffect(() => {
        cs().then(e => {
            Ee(e), e.length > 0 && !xt.current && j(e[0].ticker), e.length > 0 && (G(l => l || e[0].ticker), x(l => l || (e[1]?.ticker ?? e[0].ticker)))
        })
    }, []);
    const Zt = o.useCallback(() => ({
        ...
        Jt = o.useCallback(e => {
            if (!(!e || typeof e != "object") && (typeof e.selectedTicker == "string" && (j(e.selectedTicker), xt.current = !0), typeof e.pairTickerA == "string" && G(e.pairTickerA), typeof e.pairTickerB == "string" && x(e.pairTickerB), (e.mode === "single" || e.mode === "universe" || e.mode === "pair" || e.mode === "pairCombo" || e.mode === "basket") && I(e.mode), e.pairCombo && se.hydrate(e.pairCombo), Array.isArray(e.basketTickers) && Q(e.basketTickers.filter(l => typeof l == "string")), (e.basketMode === "stocks" || e.basketMode === "combined") && Y(e.basketMode), e.frequency === "daily" || e.frequency === "weekly" || e.frequency === "weekly_on_daily" ? qe(e.frequency) : e.timeframe === "weekly" && qe("weekly"), typeof e.targetReturn == "number" && Ue(e.targetReturn), typeof e.includeRegime == "boolean" && it(e.includeRegime), typeof e.includeThreshold == "boolean" && lt(e.includeThreshold), typeof e.includeDivergence == "boolean" && ct(e.includeDivergence), e.inputSelection && typeof e.inputSelection == "object")) {
    ...
    const Ye = o.useMemo(() => {
            const e = [];
            return xe && e.push("regime"), ge && e.push("threshold_cross"), fe && e.push("divergence"), e
        }, [xe, ge, fe]),
        Xt = o.useCallback(() => {
            Be.current = !0
        }, []),
            ...
            try {
                ...
                if (r === "pair") {
                    ...
                    if (M === "combined") {
                        ...
                        l = g.closes, u = g.volumes, f = g.volumes, s = g.highs, i = g.lows, p = g.priceDates;
                        const n = new Map;
        ...
        ft = o.useMemo(() => r === "pair" ? `${k||"A"}/${y||"B"}` : r === "single" ? d || "—" : w[0]?.ticker || "—", [r, k, y, d, w]),
                ...
                try {
                    ...
                    if (r === "pair" || r === "pairCombo") {
                        ...
                        if (S = h.volumes, J === "weekly_on_daily") {
                            ...
                            U = A.adjCloses, O = A.volumes, P = h.adjCloses, g = f === "weekly" ? A.dates : h.dates, n = []
                        }
                    }
                                    ...
                                    for (const Xe of q) {
                                        ...
                                        for (const H of ["long", "short"]) {
                                            ...
                                            const Qe = H === "long" ? "buy" : "sell",
                                                et = je.map(ye => {
                                                    let De;
                                                    return J === "weekly_on_daily" && T ? De = T.weekIndex[ye] ?? -1 : De = f === "weekly" && A ? ps(ye, A) : ye, De >= 0 ? ms(P, De, W, Qe) : null
                                                }).filter(ye => ye !== null);
                                        ...
                                        const ht = Fe.reduce((H, je) => H.composite.score >= je.composite.score ? H : je),
                                            rs = m === "threshold_cross" ? `${Ie.find(H=>H.key===m).label} · L=${h} smo=${N} m=${V} k=${Xe}` : `${Ie.find(H=>H.key===m).label} · L=${h} smo=${N} m=${V}`;
                                        a.push({
                                            ..._,
                                            configLabel: rs,
                                            directions: Fe,
                    ...
                    let Je = n;
                    if (r !== "pair" && r !== "pairCombo" && f === "weekly" && J !== "weekly_on_daily") try {
                        const m = c.length > 0 ? c : await Ae(),
                            h = new Map;
                        for (let N = 0; N < m.length; N++) h.set(m[N], N);
        ...
        Le = o.useMemo(() => {
            ...
            let l = bt;
            e && (l = l.filter(p => p.ticker.toUpperCase().includes(e) || p.name.toUpperCase().includes(e)));
            const u = [...l];
            return u.sort((p, c) => Ce === "ticker" ? p.ticker.localeCompare(c.ticker) : Ce === "signal" ? Me(p.currentOs).localeCompare(Me(c.currentOs)) : c.bestScore - p.bestScore), u
        }, [bt, Ce, ze]),
        ts = o.useCallback(() => {
            const e = [
                ["Ticker", "Name", "Current OS", "Current Bull P", "Current Bear P", "Current Signal", "Best Config", "Best Direction", "Best Score", ...re.flatMap(({
                    label: s
            ...
            for (const s of Le) {
                ...
                if (!f) continue;
                const D = f.summary;
                e.push([s.ticker, s.name, s.currentOs?.toFixed(4) ?? "", s.currentBullP?.toFixed(0) ?? "", s.currentBearP?.toFixed(0) ?? "", Me(s.currentOs), s.bestConfigLabel, s.bestDirection, s.bestScore.toFixed(1), ...re.flatMap(({
                    label: L
                }) => [(D.hitRate[L] * 100).toFixed(1) + "%", (D.avgReturn[L] * 100).toFixed(2) + "%", (D.profitFactor[L] || 0).toFixed(2)])])
            }
...
`),
            ...
            c.href = p, c.download = `tva-optimizer-${new Date().toISOString().slice(0,10)}.csv`, c.click(), URL.revokeObjectURL(p)
        }, [Le]);
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsx("h2", {
                ...
                children: we === "optimize" ? "Search parameter space by hit rate" : "Score one specific setup"
            })]
            ...
            children: [t.jsx("div", {
                ...
                children: t.jsxs("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsx("label", {
                            ...
                            children: [.02, .03, .05, .07, .1, .15].map(e => t.jsxs("option", {
                                value: e,
                ...
                children: [t.jsx(ws, {
                    ...
                    ticker: Te.mode === "pair" ? Te.pairLegA || "" : d || w[0]?.ticker || "",
                    priceContext: Te,
                    signals: Se.profiles,
            ...
            children: [t.jsx("div", {
                ...
                children: [t.jsxs("div", {
                    ...
                    children: [C ? t.jsx("button", {
                        ...
                        className: "text-xs font-mono font-bold px-4 py-1 rounded bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-50",
                        onClick: es,
                        disabled: r === "single" ? !d : r === "pair" ? !k || !y || k === y : Ke.length === 0,
                        "data-testid": "tva-run",
                    ...
                    return t.jsxs("div", {
                        ...
                        children: [t.jsxs("button", {
                            ...
                            children: [t.jsxs("div", {
                                ...
                                children: ["Top ", e.configs.length, " configs (best per signal type/length/smo/mult/threshold):"]
                            }), t.jsxs("table", {
                                ...
                                children: [t.jsx("thead", {
                                    ...
                                    children: t.jsxs("tr", {
                                        ...
                                        children: [t.jsx("th", {
                                            ...
                                            className: "p-1",
                                            children: [c.label, " Hit"]
                                        }, c.label)), re.map(c => t.jsxs("th", {
                                            className: "p-1",
                                            children: [c.label, " Ret"]
                                        }, c.label + "ret"))]
                                    })
                                }), t.jsx("tbody", {
                                    children: e.configs.flatMap(c => c.directions.map(s => {
                                        const i = `${e.ticker}::${c.configLabel}::${s.direction}`,
                                            f = _t.has(i),
                                            D = !!(s.profiles && s.profiles.length >= 10 && e.priceContext),
                                            L = s.direction === "long" ? "buy" : "sell",
                                            U = 5 + re.length * 2,
                                            O = c.configLabel + s.direction;
                                        return t.jsxs(vs.Fragment, {
                                            children: [t.jsxs("tr", {
                                                className: "border-b border-border/30",
                                                children: [t.jsx("td", {
                                                    className: "p-1 truncate max-w-[260px]",
                                                    children: c.configLabel
                                                }), t.jsx("td", {
                                                    className: `p-1 text-center ${s.direction==="long"?"text-green-500":"text-red-500"}`,
                                                    children: s.direction === "long" ? "L" : "S"
                                                }), t.jsx("td", {
                                                    className: "p-1 text-center",
                                                    children: s.summary.count
                                                }), t.jsx("td", {
                                                    className: "p-1 text-center",
                                                    style: {
                                                        color: Nt(s.composite.score),
                                                        backgroundColor: Ct(s.composite.score)
                                                    },
                                                    children: s.composite.score.toFixed(0)
                                                }), t.jsx("td", {
                                                    className: "p-1 text-center",
                                                    ...
                                                    className: "p-1 text-center",
                                                    style: {
                                                        color: js(s.summary.hitRate[P.label])
                                                    },
                                                    children: [(s.summary.hitRate[P.label] * 100).toFixed(0), "%"]
                                                }, P.label)), re.map(P => t.jsx("td", {
                                                    className: "p-1 text-center",
                                                    children: ys(s.summary.avgReturn[P.label])
                                                }, P.label + "ret"))]
                                            }), f && D && e.priceContext && s.profiles ? t.jsx("tr", {
                                                children: t.jsx("td", {
                                                    colSpan: U,
