...
function $e(u, M, B = .2) {
    ...
    let p = "Neutral",
        g = "";
    return h === 1 && m === 1 ? (p = "Attractive", g = "premium below fair-for-growth & growth above fair-for-premium") : h === -1 && m === -1 ? (p = "Expensive", g = "premium above fair-for-growth & growth below fair-for-premium") : h === 1 && m >= 0 ? (p = "Attractive", g = "premium below what history pays for this growth") : h === -1 && m <= 0 ? (p = "Expensive", g = "premium above what history pays for this growth") : m === 1 && h >= 0 ? (p = "Attractive", g = "growth above what history accompanies this premium") : m === -1 && h <= 0 ? (p = "Expensive", g = "growth below what history accompanies this premium") : h === 1 && m === -1 ? (p = "Neutral", g = "cheap-for-growth but growth lagging — mixed") : h === -1 && m === 1 ? (p = "Neutral", g = "rich-for-growth but growth ripping — mixed") : (p = "Neutral", g = "within historical range"), {
        premGivenGrowth: F,
        growthGivenPrem: C,
        impliedPrem: w,
        premGap: le,
...
function Ue() {
    const {
        ...
        baskets: $
    } = Ge(), [i, ae] = s.useState("workbook"), [H, X] = s.useState(""), [k, Z] = s.useState("subindustry"), [F, C] = s.useState(""), [w, le] = s.useState("subindustry"), [y, Q] = s.useState(M), [h, m] = s.useState(B), ee = s.useRef(!1), p = s.useRef(!1);
    s.useEffect(() => {
        u.size !== 0 && (!ee.current && !u.has(y) && Q(M), !p.current && !u.has(h) && m(B))
    }, [u, M, B, y, h]);
    const [g, r] = s.useState(.2), [c, ie] = s.useState("all"), [_, te] = s.useState(""), [N, se] = s.useState({
        key: "score",
        dir: -1
    ...
    async function be() {
        ...
        for (let a = 0; a < x.length && !A.current; a++) {
            ...
            try {
                const [K, oe] = await Promise.all([ue(l, w, b, y, "median", void 0, me), ue(l, w, b, h, "median", void 0, me)]), ve = pe(K.targetSeries, K.groupSeries, "pct"), ke = pe(oe.targetSeries, oe.groupSeries, "abs"), v = $e(ve, ke, g), Fe = v.premGivenGrowth?.n ?? 0, Pe = v.growthGivenPrem?.n ?? 0;
                e.push({
                    ticker: l,
                    name: d?.name || l,
                    peerClass: b,
    ...
    const ne = s.useMemo(() => {
            ...
            if (c !== "all" && (e = e.filter(a => a.verdict === c)), _) {
                ...
                e = e.filter(l => l.ticker.includes(a) || l.name.toUpperCase().includes(a) || l.peerClass.toUpperCase().includes(a))
            }
            const o = N.dir;
            return e = [...e].sort((a, l) => {
                const d = a[N.key],
                    b = l[N.key];
                return N.key === "verdict" ? o * (ge(a.verdict) - ge(l.verdict)) : d == null && b == null ? 0 : d == null || typeof d == "number" && !Number.isFinite(d) ? 1 : b == null || typeof b == "number" && !Number.isFinite(b) ? -1 : typeof d == "string" ? o * d.localeCompare(b) : o * (d - b)
            }), e
        }, [n, c, _, N]),
        V = s.useMemo(() => {
            let e = 0,
                ...
                a = 0,
                l = 0;
            for (const d of n) d.verdict === "Attractive" ? e++ : d.verdict === "Expensive" ? o++ : d.verdict === "Neutral" ? a++ : l++;
            return {
                a: e,
                e: o,
                n: a,
    ...
    function je(e) {
        const o = e === "Attractive" ? "bg-emerald-500/15 text-emerald-300 border-emerald-500/40" : e === "Expensive" ? "bg-rose-500/15 text-rose-300 border-rose-500/40" : e === "Neutral" ? "bg-amber-500/10 text-amber-300/90 border-amber-500/30" : "bg-white/5 text-muted-foreground border-white/10";
        return t.jsx("span", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsxs("div", {
                ...
                children: [t.jsxs("span", {
                    children: ["Universe: ", t.jsx("span", {
                        ...
                        children: i === "basket" ? "— pick a basket above" : i === "classification" ? `— pick a ${z[k]}` : "— workbook is empty"
                    })]
                }), T && t.jsxs("span", {
                ...
                children: [t.jsx("span", {
                    className: "text-muted-foreground",
                    children: "Verdict"
                }), ["all", "Attractive", "Neutral", "Expensive"].map(e => t.jsxs("button", {
                    onClick: () => ie(e),
                    ...
                    children: [e === "all" ? "All" : e, e !== "all" && t.jsxs("span", {
                        className: "ml-1 opacity-60",
                        children: ["(", e === "Attractive" ? V.a : e === "Expensive" ? V.e : V.n, ")"]
                    })]
                }, e)), t.jsx("div", {
            ...
            children: n.length === 0 && !T ? t.jsxs("div", {
                ...
                children: [t.jsx(ce, {
                    ...
                    children: ["Pick a universe and metrics above, then click ", t.jsx("span", {
                ...
                children: [t.jsx("thead", {
                    ...
                    children: ne.map(e => t.jsxs("tr", {
                        ...
                        children: [t.jsx("td", {
                            ...
                            children: Number.isFinite(e.lastP) ? `${e.lastP>0?"+":""}${e.lastP.toFixed(1)}%` : "—"
                        }), t.jsx("td", {
                            className: `px-2 py-1 text-right ${e.premGap<0?"text-emerald-300/80":e.premGap>0?"text-rose-300/80":""}`,
                            children: Number.isFinite(e.premGap) ? `${e.premGap>0?"+":""}${e.premGap.toFixed(1)}` : "—"
                        }), t.jsx("td", {
                            ...
                            children: e.premPctile != null ? `${e.premPctile.toFixed(0)}%` : "—"
                        }), t.jsx("td", {
                            className: "px-2 py-1 text-right",
                            children: Number.isFinite(e.lastG) ? `${e.lastG>0?"+":""}${e.lastG.toFixed(1)}pp` : "—"
                        }), t.jsx("td", {
                            className: `px-2 py-1 text-right ${e.growthGap>0?"text-emerald-300/80":e.growthGap<0?"text-rose-300/80":""}`,
                            children: Number.isFinite(e.growthGap) ? `${e.growthGap>0?"+":""}${e.growthGap.toFixed(1)}` : "—"
                        }), t.jsx("td", {
                            ...
                            children: e.growthPctile != null ? `${e.growthPctile.toFixed(0)}%` : "—"
                        }), t.jsx("td", {
