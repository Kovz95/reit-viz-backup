...
function T(s, l, c = "opt-clf") {
    const [r, b] = t.useState(x()), [a, g] = t.useState(""), [n, d] = t.useState(new Set), [e, v] = t.useState("workbook"), m = l && e === "global", {
        metas: i,
        loading: k,
        error: h
    } = E(), u = t.useMemo(() => e === "global" ? m ? i : [] : s, [e, m, i, s]), C = t.useMemo(() => l ? L(u, r, a, n) : s, [u, s, l, r, a, n]), y = Object.values(r).some(p => p.size > 0) || a !== "" || n.size > 0, F = t.useCallback(() => {
        b(x()), g(""), d(new Set)
    }, []), S = t.useCallback(p => {
        v(p), b(x()), g(""), d(new Set)
    }, []), j = s.length;
    e === "global" && (k || i.length);
    const w = l ? o.jsxs("div", {
            className: "flex items-center gap-2 text-xs",
            "data-testid": `${c}-universe-source`,
            children: [o.jsx("span", {
                ...
                "data-testid": `${c}-source-global`,
                title: "FactSet/RBICS GLOBAL universe (~9,000 tickers, Yahoo-priced)",
                children: ["Global", " ", e === "global" ? k ? "(loading…)" : `(${i.length.toLocaleString()})` : "(~9k)"]
            }), e === "global" && h && o.jsx("span", {
        ...
        f = l ? o.jsx($, {
            ...
            onSearchChange: g,
            manualTickers: n,
            onManualTickersChange: d,
            filteredCount: C.length,
            totalCount: u.length,
            testIdPrefix: c,
            tickerPoolOverride: e === "global" ? u : void 0
        }) : null;
    return {
        filteredTickers: C,
        classFilterUI: f,
        universeSourceUI: w,
        source: e,
        globalLoading: e === "global" && k,
        globalError: e === "global" ? h : null,
        hasActiveFilters: y,
        state: {
            classFilters: r,
            search: a,
