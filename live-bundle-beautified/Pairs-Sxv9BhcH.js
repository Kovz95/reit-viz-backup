...
function vt(s) {
    return s == null || !isFinite(s) ? "—" : s >= 100 ? s.toFixed(2) : s >= 1 ? s.toFixed(4) : s.toFixed(5)
}

function Es(s) {
    return s == null ? "text-muted-foreground" : s > .5 ? "text-emerald-400" : s < -.5 ? "text-rose-400" : "text-muted-foreground"
}

function Zs(s) {
    return s == null ? "text-muted-foreground" : s >= 65 ? "text-emerald-400 font-semibold" : s >= 55 ? "text-emerald-400/70" : s <= 35 ? "text-rose-400 font-semibold" : s <= 45 ? "text-rose-400/70" : "text-muted-foreground"
}
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx(At, {
                        ...
                        children: ["quality ", F.bucket.quality.toFixed(2), " · n=", F.bucket.n]
                    })]
                }), e.jsxs("div", {
                    ...
                    children: [e.jsx(be, {
                        ...
                        valueClass: F.expectedMove20dPct < 0 ? "text-rose-400" : "text-emerald-400"
                    }), e.jsx(be, {
                        label: "Ratio target",
                    ...
                    children: F.direction === "short_ratio" ? `Setup: short ${n} / long ${g} (sell the ratio)` : F.direction === "long_ratio" ? `Setup: long ${n} / short ${g} (buy the ratio)` : "No actionable bias — the bucket is statistically flat."
                })]
            }) : e.jsxs("div", {
                        ...
                        children: v.map((o, h) => {
                            ...
                            return e.jsxs("tr", {
                                ...
                                children: [e.jsxs("td", {
                                    ...
                                    children: [vt(o.ratioLevelLow), " – ", vt(o.ratioLevelHigh)]
                                }), e.jsx("td", {
                                    className: "px-2 py-1 text-right text-foreground/85",
                                    children: o.ratioLevelLow != null && o.ratioLevelHigh != null && d.currentB > 0 ? `$${((o.ratioLevelLow+o.ratioLevelHigh)/2*d.currentB).toFixed(2)}` : "—"
                                }), e.jsx("td", {
                                    className: "px-2 py-1 text-right text-foreground/85",
                                    children: o.ratioLevelLow != null && o.ratioLevelHigh != null && d.currentA > 0 ? `$${(d.currentA/((o.ratioLevelLow+o.ratioLevelHigh)/2)).toFixed(2)}` : "—"
                                }), e.jsx("td", {
                ...
                children: [e.jsx("span", {
                    className: "font-semibold",
                    children: "avg"
                }), " = mean forward % change in ", n, "/", g, " ratio. ", e.jsx("span", {
                    className: "font-semibold",
                    children: "hit"
                }), " = % of observations that reverted in the expected direction (", Bs(l).trim(), "). ", e.jsx("span", {
                    className: "font-semibold",
                    children: "Q"
                }), " = quality score on the 20-day horizon (size × edge × sample reliability).  Highlighted row = bucket the pair is currently sitting in.  Sample: ", d.firstDate, " → ", d.lastDate, " (", d.n.toLocaleString(), " days)."]
            })]
        })]
    })
}
...
const _s = [{
    ...
    St = {},
    Nt = new Set(["prices", "ratio", "zscore", "percentileRank", "correlation", "olsScatter", "signalAnalyzer"]),
    yt = [{
        id: "prices",
        label: "Prices",
        group: "Core"
    ...
    Zt = {
        ...
        Estimates: ["FFO FY1", "FFO FY2", "AFFO FY1", "AFFO FY2", "EPS FY1", "EPS FY2", "EBITDA FY1", "EBITDA FY2"],
...
function Us({
    ...
    const v = c.useMemo(() => {
        ...
        const i = [],
            x = [];
        for (let w = 1; w < s.length; w++) s[w].value > 0 && s[w - 1].value > 0 && p[w].value > 0 && p[w - 1].value > 0 && (i.push(Math.log(s[w].value / s[w - 1].value)), x.push(Math.log(p[w].value / p[w - 1].value)));
    ...
    return c.useEffect(() => {
        ...
        let q = 1 / 0,
            ...
            G = 1 / 0,
            le = -1 / 0;
        for (let m = 0; m < E; m++) T[m] < q && (q = T[m]), T[m] > w && (w = T[m]), C[m] < G && (G = C[m]), C[m] > le && (le = C[m]);
        const W = (w - q) * .05 || .01,
            D = (le - G) * .05 || .01;
        q -= W, w += W, G -= D, le += D;
        ...
        for (let m = 0; m < E; m++) r.beginPath(), r.arc(J(T[m]), re(C[m]), 2, 0, Math.PI * 2), r.fill();
        const ie = I + Y * q,
            b = I + Y * w;
        r.strokeStyle = "#ef4444", r.lineWidth = 1.5, r.beginPath(), r.moveTo(J(q), re(ie)), r.lineTo(J(w), re(b)), r.stroke(), r.fillStyle = "#7a8a9e", r.font = "10px 'JetBrains Mono', monospace", r.textAlign = "center", r.fillText(`${g} Log Returns`, z.left + O / 2, y - 5), r.save(), r.translate(12, z.top + U / 2), r.rotate(-Math.PI / 2), r.fillText(`${n} Log Returns`, 0, 0), r.restore(), r.textAlign = "center", r.textBaseline = "top";
        for (let m = 0; m <= 4; m++) {
            const S = q + (w - q) * (m / 4);
        ...
        r.fillStyle = "#e0e0e0", r.font = "bold 10px 'JetBrains Mono', monospace", r.textAlign = "left", r.textBaseline = "top", r.fillText(`OLS: β = ${Y.toFixed(4)}, α = ${I.toFixed(6)}, R² = ${_.toFixed(4)}, n = ${E}`, z.left + 5, z.top + 5)
    }, [v, n, g, d]), e.jsxs("div", {
        className: `flex flex-col ${j?"fixed inset-0 z-50 bg-background":"w-full h-full border border-border/30 min-h-0 overflow-hidden"}`,
...
function Gs(s) {
    const p = [];
    return typeof s.rsi == "number" && p.push("rsi"), s.macd && p.push("macd"), typeof s.roc == "number" && p.push("roc"), s.stochastic && p.push("stochastic"), typeof s.atr == "number" && p.push("atr"), s.obv && p.push("obv"), p
}
...
function Qs({
    ...
    c.useEffect(() => {
        ...
        if (g) {
            ...
            if (g.timeScale().subscribeVisibleLogicalRangeChange(h), x.timeScale().subscribeVisibleLogicalRangeChange(y), requestAnimationFrame(() => {
                    try {
                        const r = g.timeScale().getVisibleLogicalRange();
                        r && x.timeScale().setVisibleLogicalRange(r)
                    } catch {}
                ...
                const r = C => {
                    if (!f.current) {
                        f.current = !0;
                        try {
                            C.time && o ? x.setCrosshairPosition(NaN, C.time, o) : x.clearCrosshairPosition()
                        } catch {}
                        f.current = !1
                    }
                };
            ...
            j && x.subscribeCrosshairMove(r => {
                if (!f.current) {
                    f.current = !0;
                    try {
                        r.time && j ? g.setCrosshairPosition(NaN, r.time, j) : g.clearCrosshairPosition()
                    } catch {}
                    f.current = !1
                }
            })
    ...
    const F = s === "rsi" ? "RSI" : s === "macd" ? "MACD" : s === "ha" ? "Heikin-Ashi" : s === "atr" ? "ATR" : s === "roc" ? "ROC" : s === "stochastic" ? "Stochastic" : s === "obv" ? "OBV" : s;
    return e.jsxs("div", {
                ...
                if (b) {
                    ...
                    if (S.mean.length > 0) {
                        ...
                        for (const R of S.bands) D.addSeries(H, {
                            color: Math.abs(R.mult) === 1 ? "rgba(99,102,241,0.4)" : "rgba(99,102,241,0.25)",
                            lineWidth: 1,
...
function sa() {
    const [s, p] = c.useState("ESS"), [n, g] = c.useState("MAA"), [j, V] = c.useState("close"), [l, f] = c.useState("close"), [d, F] = c.useState(60), [v, i] = c.useState(52), [x, o] = c.useState(8), [h, y] = c.useState(52), [r, C] = c.useState([]), [T, I] = c.useState("static"), [Y, _] = c.useState("rolling"), [E, z] = c.useState(""), [O, U] = c.useState(null), [q, w] = c.useState(!1), [G, le] = c.useState({}), [W, D] = c.useState("prices"), [J, re] = c.useState("1x1"), [ie, b] = c.useState(() => new Set(Nt)), m = c.useCallback(() => ({
        tickerA: s,
        tickerB: n,
        metricA: j,
        metricB: l,
        ...
        a.tickerA !== void 0 && p(a.tickerA), a.tickerB !== void 0 && g(a.tickerB), a.metricA !== void 0 && V(a.metricA), a.metricB !== void 0 && f(a.metricB), a.zWindow !== void 0 && F(a.zWindow), a.betaLookback !== void 0 && i(a.betaLookback), a.spreadZWindow !== void 0 && o(a.spreadZWindow), a.olsResidWindow !== void 0 && y(a.olsResidWindow), a.pairsLayout !== void 0 && re(a.pairsLayout), a.visibleChartIds && b(new Set(a.visibleChartIds)), a.indicatorsMap !== void 0 && le(a.indicatorsMap), a.sigmaBandMode !== void 0 && I(a.sigmaBandMode), (a.betaAdjSpreadMode === "rolling" || a.betaAdjSpreadMode === "insample") && _(a.betaAdjSpreadMode), a.extraOlsZPlots !== void 0 && C(a.extraOlsZPlots)
    }, []), t = Ms();
    Qt("pairs", m, S, {
        universeSig: t,
    ...
    const R = c.useRef(null),
        ...
        at = c.useCallback((a, u) => {
            u ? me.current.set(a, u) : me.current.delete(a), Le.current && cancelAnimationFrame(Le.current), Le.current = requestAnimationFrame(() => {
        ...
        Wt = c.useCallback((a, u) => {
            const k = Z => {
                    ...
                    const ue = ee - L;
                    let ge = !1;
                    return ee > Q - 1 + X && (ee = Q - 1 + X, L = ee - ue, ge = !0), L < -X && (L = -X, ee = L + ue, ge = !0), ge ? {
                        from: L,
                        to: ee
                    } : null
                },
        ...
        qt = c.useCallback(() => {
            ...
            ne(a, "priceA"), ne(u, "priceB"), ne(k, "ratio"), ne(P, "logRatio"), ne(M, "zScore"), ne(Z, "spreadZ"), ne(Q, "olsResidZ"), ne(X, "correlation"), ne(L, "rollingBeta"), ne(ee, "betaAdjSpread"), ne(ue, "rollingR2"), ne(ge, "percentileRank");
            const ve = Array.from(ye.values()).sort((K, we) => K.date.localeCompare(we.date)),
                Me = `Date,${xe} ${j},${he} ${l},Ratio,Log Ratio,Z-Score (${d}d),Spread Z (${v}/${x}d),OLS Resid Z (${h}d),Pct Rank,Correlation (${d}d),Rolling Beta,Beta-Adj Spread,Rolling R2`,
                oe = (K, we) => K !== void 0 ? K.toFixed(we) : "",
                He = ve.map(K => `${K.date},${oe(K.priceA,4)},${oe(K.priceB,4)},${oe(K.ratio,6)},${oe(K.logRatio,6)},${oe(K.zScore,4)},${oe(K.spreadZ,4)},${oe(K.olsResidZ,4)},${oe(K.percentileRank,2)},${oe(K.correlation,4)},${oe(K.rollingBeta,4)},${oe(K.betaAdjSpread,6)},${oe(K.rollingR2,4)}`),
                Ie = [Me, ...He].join(`
`),
                qe = new Blob([Ie], {
                    type: "text/csv"
        ...
        _e = c.useMemo(() => {
            ...
            return [{
                ...
                id: "betaAdjSpread",
                data: Y === "rolling" && A.betaAdjSpreadRolling.length > 0 ? A.betaAdjSpreadRolling : A.betaAdjSpread,
                title: Y === "rolling" && A.betaAdjSpreadRolling.length > 0 ? "Beta-Adjusted Spread (EG Residual, rolling β)" : "Beta-Adjusted Spread (EG Residual, in-sample β)",
                color: "#06b6d4",
                height: $e,
                refLines: [{
                    value: 0,
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsx("span", {
                ...
                children: [e.jsx(Re, {
                    ...
                    children: [e.jsx("div", {
                        ...
                        children: je.map((a, u) => je.slice(u + 1).map(k => e.jsxs("button", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: [e.jsx(ae, {
                                ...
                                step: 1,
                                value: v,
                                onChange: a => i(Math.max(5, parseInt(a.target.value) || 52)),
                            ...
                            children: [e.jsx(ae, {
                                ...
                                step: 1,
                                value: x,
                                onChange: a => o(Math.max(2, parseInt(a.target.value) || 8)),
                                className: "h-6 text-[10px] w-[80px] font-mono",
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: [e.jsx(ae, {
                                ...
                                step: 1,
                                value: h,
                                onChange: a => y(Math.max(5, parseInt(a.target.value) || 52)),
                                className: "h-6 text-[10px] w-[80px] font-mono",
                        ...
                        children: [e.jsxs("div", {
                            ...
                            children: [e.jsx("div", {
                                ...
                                onClick: () => {
                                    const a = `${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`;
                                    C(u => [...u, {
                                        id: a,
                                        metricA: "P/FFO FY2",
                                        metricB: "P/FFO FY2"
                            ...
                            children: r.map((a, u) => e.jsxs("div", {
                                ...
                                children: [e.jsx("span", {
                                    ...
                                    value: a.metricA,
                                    onChange: k => C(P => P.map(M => M.id === a.id ? {
                                        ...M,
                                        metricA: k
                                    } : M)),
                                    ...
                                    onClick: () => C(k => k.filter(P => P.id !== a.id)),
                                    title: "Remove",
                        ...
                        className: "text-[9px] text-muted-foreground/70 leading-tight",
                        children: ["Spread Z: log(A) - ", "β", "*log(B), ", "β", " from rolling OLS, then z-scored.", e.jsx("br", {}), "OLS Resid Z: residual from rolling OLS with intercept, then z = resid / ", "σ", "."]
                    })]
                })]
            }), e.jsx("div", {
                className: "flex-1"
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("span", {
                            ...
                            children: [e.jsx(B, {
                                ...
                                onClick: () => b(new Set(yt.map(a => a.id))),
                            ...
                            children: [e.jsx("div", {
                                ...
                                children: [e.jsx(ss, {
                                    ...
                                    onCheckedChange: k => {
                                        b(P => {
                                            const M = new Set(P);
                                            return k ? M.add(u.id) : M.delete(u.id), M
                                        })
                                    },
            ...
            children: [e.jsx(se, {
                ...
                highlight: $.lastZScore !== void 0 ? Math.abs($.lastZScore) > 2 ? "red" : Math.abs($.lastZScore) > 1 ? "yellow" : "green" : void 0
            }), e.jsx(se, {
                label: "Spread Z",
                value: $.lastSpreadZ?.toFixed(3),
                highlight: $.lastSpreadZ !== void 0 ? Math.abs($.lastSpreadZ) > 2 ? "red" : Math.abs($.lastSpreadZ) > 1 ? "yellow" : "green" : void 0
            }), e.jsx(se, {
                label: "OLS Z",
                value: $.lastOlsResidZ?.toFixed(3),
                highlight: $.lastOlsResidZ !== void 0 ? Math.abs($.lastOlsResidZ) > 2 ? "red" : Math.abs($.lastOlsResidZ) > 1 ? "yellow" : "green" : void 0
            }), e.jsx(se, {
                label: "Pct Rank",
                value: $.lastPctRank !== void 0 ? `${$.lastPctRank.toFixed(1)}%` : void 0,
                highlight: $.lastPctRank !== void 0 ? $.lastPctRank > 90 || $.lastPctRank < 10 ? "red" : $.lastPctRank > 75 || $.lastPctRank < 25 ? "yellow" : "green" : void 0
            }), e.jsx(se, {
                label: `Corr (${d}d)`,
                ...
                children: [e.jsx("div", {
                    ...
                    label: "Coint p",
                    value: $.cointStats.pValue < .01 ? "<0.01" : $.cointStats.pValue.toFixed(3),
                    highlight: $.cointStats.pValue < .05 ? "green" : $.cointStats.pValue < .1 ? "yellow" : "red"
                }), e.jsx(se, {
                    label: "Hedge",
                    value: $.cointStats.hedgeRatio.toFixed(3)
                }), e.jsx(se, {
                    label: "Half-Life",
                    value: $.cointStats.halfLife > 0 && $.cointStats.halfLife < 9999 ? `${$.cointStats.halfLife.toFixed(1)}d` : "N/A"
                })]
            ...
            children: [(() => {
                ...
                return e.jsx("div", {
                    ref: R,
                    className: k ? "flex-1 min-h-0 overflow-hidden" : "flex-1 min-h-0 overflow-y-auto overflow-x-hidden",
                    style: X,
                    children: Ht ? e.jsx("div", {
                        ...
                        children: [u.map(L => e.jsx(Vt, {
                            ...
                            return e.jsx(Js, {
                                ...
                                onRegisterSeries: it,
                                onCrosshairMove: at,
                                onRemove: () => C(ue => ue.filter(ge => ge.id !== L.id)),
...
function Ct({
    ...
    const [V, l] = c.useState(!1), f = s.startsWith("BASKET:"), d = f ? s.slice(7) : null, F = d ? g.find(i => i.id === d) : null, v = F ? F.name : s || "Select...";
    return e.jsxs(Ce, {
        open: V,
        onOpenChange: l,
        children: [e.jsx(Re, {
                    ...
                    children: [e.jsx(ds, {
                        ...
                        children: g.map(i => e.jsxs(ht, {
                            ...
                            children: [e.jsx(Ge, {
                                ...
                                children: [i.tickers.slice(0, 4).join(", "), i.tickers.length > 4 ? "…" : ""]
                            })]
                        }, i.id))
                    }), e.jsx(xt, {
                        heading: "Tickers",
...
function se({
    ...
    const g = n === "red" ? "text-red-400" : n === "yellow" ? "text-amber-400" : n === "green" ? "text-emerald-400" : "text-foreground";
    return e.jsxs("div", {
