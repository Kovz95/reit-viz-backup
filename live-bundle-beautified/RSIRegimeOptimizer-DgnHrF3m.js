...
function rt(_, B, f) {
    const O = (B + f) / 2;
    return _ <= B ? "oversold" : _ >= f ? "overbought" : _ < O - 5 ? "neutral_low" : _ > O + 5 ? "neutral_high" : "neutral"
}

function Zr() {
    const [_, B] = p.useState([]), [f, O] = p.useState(""), [C, H] = p.useState("threshold"), [b, X] = p.useState(.05), [V, ye] = p.useState(.05), [Z, ze] = p.useState(.1), [xe, ot] = p.useState("zone"), [u, Re] = p.useState("single"), [z, st] = p.useState([]), [ee, nt] = Ae("rsi-basket-mode", "stocks"), {
        baskets: ke
    } = nr(), [R, Ie] = p.useState(""), [I, Te] = p.useState(""), [E, pe] = p.useState(!1), [ne, lt] = p.useState({
        current: 0,
        total: 0
    }), [F, ve] = Ae("rsi-regime-input-selection", kr), [me, _e] = Ae("rsi:results", []), [je, at] = p.useState(null), [Pt, Lt] = p.useState(new Set), Mt = p.useCallback(e => {
        Lt(o => {
            const n = new Set(o);
            return n.has(e) ? n.delete(e) : n.add(e), n
        })
    }, []), [le, it] = p.useState("score"), [Fe, At] = p.useState("composite"), [Dt, He] = p.useState("10y"), [$, Ue] = p.useState(() => lr()), ct = p.useMemo(() => ar(Fe), [Fe]), Ve = p.useRef(!1), dt = p.useRef(!1), [$e, ut] = p.useState("optimize"), [ae, xt] = p.useState("long"), [Be, pt] = Ae("rsi:evalResult", null), [Oe, mt] = p.useState(null), [Ze, q] = p.useState(!1), [U, zt] = p.useState("exit_oversold"), [ge, Ft] = p.useState(14), [W, Ht] = p.useState(30), [G, Ut] = p.useState(70), [qe, Vt] = p.useState(0), {
        universeTickers: Ke,
        isFiltered: Zt
    } = ir(), v = p.useMemo(() => Ke ? _.filter(e => Ke.has(e.ticker)) : _, [_, Ke]), Ee = Cr(v, u === "universe", "rsiregime-clf"), ie = wr(_, u === "pairCombo", "rsi-pc"), gt = Ee.filteredTickers, {
        frequency: Ne,
        setFrequency: We,
        frequencyUI: qt
    ...
    p.useEffect(() => {
        cr().then(e => {
            B(e), e.length > 0 && !dt.current && O(e[0].ticker), e.length > 0 && (Ie(o => o || e[0].ticker), Te(o => o || (e[1]?.ticker ?? e[0].ticker)))
        })
    }, []), p.useEffect(() => {
        v.length > 0 && f && _.some(e => e.ticker === f) && !v.find(e => e.ticker === f) && O(v[0].ticker)
    }, [v, f, _]);
    const Kt = p.useCallback(async () => {
                ...
                try {
                    ...
                    for (const g of Et) {
                        ...
                        if (d === "weekly_on_daily" && y) {
                            ...
                            m = Ot(j.map(A => A === null ? NaN : A), y.weekIndex, h.length).map(A => Number.isNaN(A) ? null : A)
                        } else m = we(P, g);
                        ...
                        if (xe === "zone")
                            for (const j of tt)
                                for (const k of De) {
                                    ...
                                    const L = ue.reduce((N, S) => N.composite.score > S.composite.score ? N : S, ue[0]);
                                    ce.push({
                                        config: {
                                            rsiPeriod: g,
                                            oversoldLevel: j,
                                        ...
                                        for (const k of De) {
                                            ...
                                            for (let L = de + 1; L < w; L++) {
                                                ...
                                                const N = m[L],
                                                    S = m[L - 1],
                                                    M = [];
                                                N <= j && S > j && M.push("enter_oversold"), N > j && S <= j && M.push("exit_oversold"), N >= k && S < k && M.push("enter_overbought"), N < k && S >= k && M.push("exit_overbought");
                                                const re = C === "band" ? {
                                                    minReturn: V,
                                                    maxReturn: Z
                                                } : null;
                                            ...
                                            const ue = fe.reduce((L, N) => L.composite.score > N.composite.score ? L : N, fe[0]);
                                            ce.push({
                                                config: {
                                                    rsiPeriod: g,
                                                    oversoldLevel: j,
                    ...
                    const Q = ce.reduce((g, m) => g.bestScore > m.bestScore ? g : m),
                        Le = d === "weekly_on_daily" && y ? (() => {
                            ...
                            return Ot(g.map(x => x === null ? NaN : x), y.weekIndex, h.length).map(x => Number.isNaN(x) ? null : x)
                    ...
                    if (te !== null) {
                        ...
                        if (m !== null) {
                            ...
                            te <= x && m > x ? be = "→ Oversold" : te > x && m <= x ? be = "← Oversold" : te >= w && m < w ? be = "→ Overbought" : te < w && m >= w && (be = "← Overbought")
                        }
                    }
                    const er = 6,
        ...
        Wt = p.useCallback(async () => {
            ...
            try {
                ...
                const T = n.map(d => e[d] || ""),
                    a = we(o, ge),
                    r = [],
                    i = U === "enter_oversold" || U === "exit_oversold" || U === "enter_overbought" || U === "exit_overbought",
                    h = ge + 126;
                if (i)
                    for (let d = h + 1; d < o.length; d++) {
                        ...
                        const s = a[d],
                            l = a[d - 1],
                            c = [];
                        s <= W && l > W && c.push("enter_oversold"), s > W && l <= W && c.push("exit_oversold"), s >= G && l < G && c.push("enter_overbought"), s < G && l >= G && c.push("exit_overbought"), c.includes(U) && r.push(d)
                    } else {
                        let d = null;
        ...
        ht = p.useMemo(() => u === "pair" ? `${R||"A"}/${I||"B"}` : u === "single" ? f || "—" : v[0]?.ticker || "—", [u, R, I, f, v]),
        Gt = p.useCallback(() => ({
            selectedTicker: f,
            pairTickerA: R,
            pairTickerB: I,
        ...
        Yt = p.useCallback(e => {
            if (e && (e.selectedTicker && (O(e.selectedTicker), dt.current = !0), e.pairTickerA && Ie(e.pairTickerA), e.pairTickerB && Te(e.pairTickerB), (e.mode === "single" || e.mode === "universe" || e.mode === "pair" || e.mode === "pairCombo" || e.mode === "basket") && Re(e.mode), e.pairCombo && ie.hydrate(e.pairCombo), Array.isArray(e.basketTickers) && st(e.basketTickers.filter(o => typeof o == "string")), (e.basketMode === "stocks" || e.basketMode === "combined") && nt(e.basketMode), typeof e.targetReturn == "number" && X(e.targetReturn), e.returnMode && H(e.returnMode), typeof e.bandMin == "number" && ye(e.bandMin), typeof e.bandMax == "number" && ze(e.bandMax), e.signalMode && ot(e.signalMode), Array.isArray(e.results) && _e(e.results), e.expandedTicker !== void 0 && at(e.expandedTicker), e.sortBy && it(e.sortBy), e.frequency === "daily" || e.frequency === "weekly" || e.frequency === "weekly_on_daily" ? We(e.frequency) : e.timeframe === "weekly" && We("weekly"), e.inputSelection && typeof e.inputSelection == "object")) {
    ...
    const Ge = p.useMemo(() => me.map(e => ({
        ...
        Pe = p.useMemo(() => {
            const e = [...Ge];
            return le === "score" ? e.sort((o, n) => n.bestScore - o.bestScore) : le === "ticker" ? e.sort((o, n) => o.ticker.localeCompare(n.ticker)) : le === "rsi" ? e.sort((o, n) => (n.currentRSI ?? 0) - (o.currentRSI ?? 0)) : e.sort((o, n) => o.currentSignal.localeCompare(n.currentSignal)), e
        }, [Ge, le]),
        Jt = () => {
            const e = se.filter((r, i) => i >= 2),
                o = Pe.map(r => {
                    const i = r.configs.reduce((s, l) => s.bestScore > l.bestScore ? s : l, r.configs[0]),
                        Y = (i?.categories.find(s => s.category === i.bestCategory) ?? i?.categories.reduce((s, l) => s.composite.score > l.composite.score ? s : l, i.categories[0]))?.summary,
                        d = {
                            ticker: r.ticker,
                            name: r.name,
                    ...
                    return e.forEach(s => {
                        d[`hitRate_${s.label}`] = Y?.hitRate[s.label] ?? null, d[`avgReturn_${s.label}`] = Y?.avgReturn[s.label] ?? null
                    }), d
                }),
                n = Object.keys(o[0] || {}),
                T = [n.join(","), ...o.map(r => n.map(i => `"${String(r[i]??"").replace(/"/g,'""')}"`).join(","))].join(`
`),
        ...
        Qt = e => e === null ? "text-muted-foreground" : e <= 30 ? "text-emerald-400" : e <= 40 ? "text-green-400" : e >= 70 ? "text-red-400" : e >= 60 ? "text-orange-400" : "text-yellow-400",
        yt = e => e.includes("Oversold") ? "bg-emerald-600/20 text-emerald-400 border-emerald-600/30" : e.includes("Neutral Low") ? "bg-green-600/20 text-green-400 border-green-600/30" : e.includes("Neutral High") ? "bg-orange-600/20 text-orange-400 border-orange-600/30" : e.includes("Overbought") ? "bg-red-600/20 text-red-400 border-red-600/30" : e.includes("Neutral") ? "bg-yellow-600/20 text-yellow-400 border-yellow-600/30" : e.includes("→") ? "bg-blue-600/20 text-blue-400 border-blue-600/30" : e.includes("←") ? "bg-purple-600/20 text-purple-400 border-purple-600/30" : "bg-muted text-muted-foreground border-border",
    ...
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsx("h2", {
                ...
                children: $e === "optimize" ? "Search RSI parameter space by hit rate" : "Score one specific RSI setup"
            }), t.jsxs("div", {
            ...
            children: [t.jsx("div", {
                ...
                children: t.jsxs("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsx("label", {
                            ...
                            onChange: e => X((parseFloat(e.target.value) || 5) / 100),
                ...
                children: [t.jsx(jr, {
                    ...
                    ticker: Oe.mode === "pair" ? Oe.pairLegA || "" : f || v[0]?.ticker || "",
                    priceContext: Oe,
                    signals: Be.profiles,
                ...
                children: t.jsxs("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsx("label", {
                            ...
                            className: "flex gap-px",
                            children: ["zone", "transition"].map(e => t.jsx("button", {
                                ...
                                onClick: () => ot(e),
                                disabled: E,
                                children: e === "zone" ? "Zone Entry" : "Transition"
                            }, e))
                        })]
                    }), t.jsxs("div", {
                        className: "flex flex-col gap-0.5",
                        ...
                        children: [t.jsxs("div", {
                            ...
                            children: [t.jsx("label", {
                                ...
                                value: `${V}-${Z}`,
                                onChange: e => {
                                    const [o, n] = e.target.value.split("-").map(Number);
                                    ye(o), ze(n)
                                },
                                disabled: E,
                            ...
                            children: [t.jsx("label", {
                                ...
                                onChange: e => ye(Number(e.target.value) / 100),
                                disabled: E
                            })]
                        }), t.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [t.jsx("label", {
                                ...
                                onChange: e => ze(Number(e.target.value) / 100),
                                disabled: E
                            })]
                        })]
                    }), t.jsxs("div", {
                ...
                children: [me.length === 0 && !E && t.jsx("div", {
                    ...
                    children: t.jsxs("div", {
                        ...
                        children: [t.jsx("div", {
                            ...
                            children: [ne.current, "/", ne.total, " tickers × ", Xt, " configs"]
                        }), t.jsx("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("h3", {
                            ...
                            children: [Pe.length, " tickers — RSI ", xe, " — ", C === "band" ? `band ${he(V)}–${he(Z)}` : `target ${he(b)}`]
                        }), t.jsxs("div", {
                            className: "flex items-center gap-1",
                            children: [
                                ["score", "rsi", "signal", "ticker"].map(e => t.jsx("button", {
                                    ...
                                    onClick: () => it(e),
                                    children: e === "score" ? "Score" : e === "rsi" ? "RSI" : e === "signal" ? "Signal" : "Ticker"
                                }, e)), t.jsxs("div", {
                                    className: "flex items-center gap-1",
                                    children: [t.jsx("label", {
                                        className: "text-[10px] font-mono text-muted-foreground",
                        ...
                        children: t.jsxs("table", {
                            ...
                            children: [t.jsx("thead", {
                                children: t.jsxs("tr", {
                                    ...
                                    }), se.filter((e, o) => o >= 2).map(e => t.jsxs("th", {
                                        className: "text-center px-2 py-1 font-bold",
                                        children: [C === "band" ? "Band" : "Hit", " ", e.label]
                                    }, e.label)), se.filter((e, o) => o >= 2).map(e => t.jsxs("th", {
                                        className: "text-center px-2 py-1 font-bold",
                                        children: ["Avg ", e.label]
                                    }, `avg-${e.label}`)), se.filter((e, o) => o >= 2).map(e => t.jsxs("th", {
                                        className: "text-center px-2 py-1 font-bold",
                                        children: ["PF ", e.label]
                                    }, `pf-${e.label}`)), t.jsx("th", {
                                        className: "text-center px-2 py-1 font-bold",
                                ...
                                children: Pe.map(e => {
                                    const o = je === e.ticker,
                                        n = e.configs.reduce((r, i) => r.bestScore > i.bestScore ? r : i, e.configs[0]),
                                        a = (n?.categories.find(r => r.category === n.bestCategory) ?? n?.categories.reduce((r, i) => r.composite.score > i.composite.score ? r : i, n.categories[0]))?.summary;
                                    return t.jsxs("tr", {
                                        className: `${o?"bg-primary/10":"hover:bg-white/5"} cursor-pointer`,
                                        onClick: () => at(o ? null : e.ticker),
                                        children: [t.jsx("td", {
                                            ...
                                            children: e.currentRSI !== null ? e.currentRSI.toFixed(1) : "–"
                                        }), t.jsx("td", {
                                        ...
                                        }), se.filter((r, i) => i >= 2).map(r => {
                                            const i = a ? C === "band" ? a.bandHitRate?.[r.label] ?? a.hitRate[r.label] : a.hitRate[r.label] : 0;
                                            return t.jsx("td", {
                                                className: `text-center px-2 py-1 ${a?Xe(i):""}`,
                                                children: a ? he(i) : "–"
                                            }, r.label)
                                        }), se.filter((r, i) => i >= 2).map(r => t.jsx("td", {
                                            className: `text-center px-2 py-1 ${a?a.avgReturn[r.label]>=0?"text-green-400":"text-red-400":""}`,
                                            children: a ? Se(a.avgReturn[r.label]) : "–"
                                        }, `avg-${r.label}`)), se.filter((r, i) => i >= 2).map(r => t.jsx("td", {
                                            className: `text-center px-2 py-1 ${a?Rt(a.profitFactor[r.label]):""}`,
                                            children: a ? a.profitFactor[r.label] >= 99 ? "∞" : a.profitFactor[r.label].toFixed(2) : "–"
                                        }, `pf-${r.label}`)), t.jsx("td", {
                                            className: "text-center px-2 py-1",
                                            children: t.jsx("span", {
                                                className: "inline-block px-1.5 py-0.5 rounded font-bold",
                                                style: {
                                                    backgroundColor: Tt(e.bestScore),
                                                    color: It(e.bestScore)
                                                },
                        ...
                        if (!e) return null;
                        const o = [...e.configs].sort((n, T) => T.bestScore - n.bestScore);
                        return t.jsxs("div", {
                            className: "border border-border rounded p-3 bg-card/50 mb-4",
                            children: [t.jsxs("h4", {
                                className: "text-xs font-bold text-foreground mb-1",
                                children: [e.ticker, " — ", e.name, " — RSI ", e.currentRSI !== null ? e.currentRSI.toFixed(1) : "N/A"]
                            }), t.jsxs("p", {
                                className: "text-[9px] text-muted-foreground mb-3",
                                children: [o.length, " configurations tested — showing top results"]
                            }), t.jsx("div", {
                                className: "grid grid-cols-1 lg:grid-cols-2 gap-3",
                                children: o.slice(0, 6).map((n, T) => {
                                    const a = n.categories.find(r => r.category === n.bestCategory) ?? n.categories.reduce((r, i) => r.composite.score > i.composite.score ? r : i, n.categories[0]);
                                    return t.jsxs("div", {
                                        ...
                                        children: [t.jsxs("div", {
                                            ...
                                            children: [t.jsx("span", {
                                                ...
                                                style: {
                                                    backgroundColor: Tt(n.bestScore),
                                                    color: It(n.bestScore)
                                                },
                                                children: n.bestScore
                                            })]
                                        }), n.categories.filter(r => r.summary.count > 0).sort((r, i) => i.composite.score - r.composite.score).map(r => {
                                            const i = `${e.ticker}::${n.configLabel}::${r.category}`,
                                                h = Pt.has(i),
                                                Y = !!(r.profiles && r.profiles.length >= 10 && e.priceContext),
                                                d = D[r.category]?.direction === "sell" ? "sell" : "buy";
                                            return t.jsxs("div", {
                                                className: "mt-1",
                                                children: [t.jsxs("div", {
