...
function Ls(r, o) {
    ...
    for (let u = o; u < i; u++) {
        const x = r[u],
            c = r[u - o];
        x === null || c === null || !Number.isFinite(x) || !Number.isFinite(c) || c === 0 || (a[u] = x / c - 1)
    }
    return a
}
...
function ir(r, o) {
    ...
    for (let c = 0; c < r.length; c++) {
        ...
        u = 0, Number.isFinite(a) && (o === "up" && a <= 0 && E > 0 || o === "down" && a >= 0 && E < 0) && i.push(c), a = E
    }
    return i
}
...
function cr(r, o, i, a, u) {
    ...
    if (c || E) {
        ...
        for (let G = u; G < r.length; G++) {
            ...
            b !== null && K !== b && (K && c ? x.price_above.push(G) : !K && E && x.price_below.push(G)), b = K
        }
    }
...
function Es(r, o) {
    ...
    for (let c = o + 1; c < i; c++) {
        ...
        const X = E > 0 ? E : 0,
            Y = E < 0 ? -E : 0;
        u = (u * (o - 1) + X) / o, x = (x * (o - 1) + Y) / o, a[c] = x === 0 ? 100 : u === 0 ? 0 : 100 - 100 / (1 + u / x)
    }
    return a
}
...
function It(r, o) {
    ...
    const i = o.period ?? 14;
    return o.kind === "roc" ? Ds(r, i) : o.kind === "rsi" ? Es(r, i) : o.kind === "momentum" ? Us(r, i) : r.slice()
}

function To(r) {
    if (r.kind === "price") return "Price";
    const o = r.period ?? 14;
    return r.kind === "roc" ? `ROC(${o})` : r.kind === "rsi" ? `RSI(${o})` : r.kind === "momentum" ? `Momentum(${o})` : "Price"
}

function Os(r) {
    if (r.kind === "price") return "Px";
    const o = r.period ?? 14;
    return r.kind === "roc" ? `ROC${o}` : r.kind === "rsi" ? `RSI${o}` : r.kind === "momentum" ? `MOM${o}` : "Px"
}
...
function Gs(r, o) {
    ...
    let a = 0;
    for (let u = 0; u < r.length; u++) a += r[u], u >= o && (a -= r[u - o]), u >= o - 1 && (i[u] = a / o);
    return i
}
...
function Ys(r, o, i, a = 1, u = 198) {
    ...
    for (let K = 0; K < r.length; K++) {
        ...
        if (K >= c + E - 1) {
            let xe = -1 / 0,
                Ke = 1 / 0;
            for (let se = K - E + 1; se <= K; se++) r[se] > xe && (xe = r[se]), o[se] < Ke && (Ke = o[se]);
            let re = -1 / 0,
                at = 1 / 0;
            for (let se = K - E - c + 1; se <= K - E; se++) r[se] > re && (re = r[se]), o[se] < at && (at = o[se]);
            let pe = -1 / 0,
                rt = 1 / 0;
            for (let se = K - c + 1; se <= K; se++) r[se] > pe && (pe = r[se]), o[se] < rt && (rt = o[se]);
            const Ne = (xe - Ke) / E,
                Ut = (re - at) / E,
                F = (pe - rt) / c;
            let ft;
            Ne > 0 && Ut > 0 && F > 0 ? (ft = (Math.log(Ne + Ut) - Math.log(F)) / Math.log(2), z = ft) : ft = z ?? 0, Ge = ft
        }
        if (Ge !== null) {
...
function lt(r) {
    ...
    return r.kind === "price_cross" ? `Px ${o} ${r.maType}${r.fastPeriod}` : `${r.maType}${r.fastPeriod} ${o} ${At(r)}${r.slowPeriod}`
}
...
function Do(r, o, i) {
    ...
    return a.sort((u, x) => {
        const c = Io(u, o, i.col),
            E = Io(x, o, i.col);
        let X = 0;
        return typeof c == "string" || typeof E == "string" ? X = String(c).localeCompare(String(E)) : X = c - E, i.dir === "asc" ? X : -X
    }), a
}
...
function dr(r, o, i) {
    ...
    for (let b = 0; b < r.length; b++) {
        const G = Y(i[b]);
        G !== x && (X && (a.push(c), u.push(E)), x = G, c = -1 / 0, E = 1 / 0, X = !0), r[b] > c && (c = r[b]), o[b] < E && (E = o[b])
    }
...
function xn() {
    const [r, o] = $.useState([]), [i, a] = $.useState(""), [u, x] = Wt("macross-input-selection", Eo), [c, E] = $.useState(null), [X, Y] = $.useState(!1), [b, G] = $.useState("threshold"), [z, K] = $.useState(.05), [ae, Ge] = $.useState(.05), [xe, Ke] = $.useState(.1), [re, at] = $.useState(0), [pe, rt] = $.useState("absolute"), [Ne, Ut] = $.useState("subsector"), [F, ft] = $.useState("crossover"), [se, mr] = $.useState("slope"), [me, fr] = $.useState(5), [qe, xr] = $.useState("roc"), [ot, gr] = $.useState(12), [je, Qr] = $.useState("SMA"), [Re, br] = $.useState(1), [Pe, hr] = $.useState(198), [Be, yr] = $.useState(.7), [Le, kr] = $.useState(.85), [Ie, vr] = $.useState(6), [ut, Jr] = $.useState("all"), [Ee, Zt] = $.useState({
        kind: "price_cross",
        maType: "SMA",
        fastPeriod: 50,
        slowPeriod: 200,
        ...
        slowPeriod: 200,
        polarity: "above"
    }), [O, Ot] = $.useState("single"), [eo, Tt] = $.useState("10y"), [Ae, _t] = $.useState(() => ds()), [we, wr] = $.useState(""), [Me, Nr] = $.useState(""), [Te, jr] = $.useState([]), [Ze, Mr] = Wt("macross-basket-mode", "stocks"), {
        baskets: xt
    } = us(), [ne, Xe] = $.useState(!1), {
        frequency: fe,
        setFrequency: Sr,
        ...
        current: 0,
        total: 0
    }), [gt, Qt] = Wt("ma:results", []), [Ht, ro] = $.useState(null), [Oo, Ho] = $.useState(new Set), Vo = $.useCallback(t => {
        Ho(l => {
            const s = new Set(l);
            return s.has(t) ? s.delete(t) : s.add(t), s
        })
    }, []), [oo, Go] = $.useState("score"), [Cr, zo] = $.useState("composite"), so = $.useMemo(() => ps(Cr), [Cr]), [Vt, no] = $.useState(""), [Nt, lo] = $.useState({
        col: "score",
        dir: "desc"
    }), [$t, ao] = $.useState({
        col: "score",
        ...
        col: "score",
        dir: "desc"
    }), [bt, Jt] = Wt("ma:gridResults", []), [Ar, co] = $.useState(null), [er, uo] = $.useState("optimize"), [Qe, po] = $.useState("long"), [tr, mo] = Wt("ma:evalResult", null), [rr, fo] = $.useState(null), [Rt, Je] = $.useState(!1), [Oe, qo] = $.useState(50), [jt, Wo] = $.useState(200), [pt, Yo] = $.useState("SMA"), Pt = $.useRef(!1), xo = $.useRef(!1), {
        universeTickers: Tr,
        isFiltered: Ko
    } = ms(), ge = $.useMemo(() => Tr ? r.filter(t => Tr.has(t.ticker)) : r, [r, Tr]), or = As(ge, O === "universe", "ma-clf"), ht = Ts(ge.map(t => t.ticker), O === "pairCombo", "ma-pc"), sr = or.filteredTickers;
    $.useEffect(() => {
        fs().then(t => {
            o(t), t.length > 0 && !xo.current && a(t[0].ticker), t.length > 0 && (wr(l => l || t[0].ticker), Nr(l => l || (t[1]?.ticker ?? t[0].ticker)))
        })
    }, []), $.useEffect(() => {
        ge.length > 0 && i && r.some(t => t.ticker === i) && !ge.find(t => t.ticker === i) && a(ge[0].ticker)
    }, [ge, i, r]);
    const Zo = $.useCallback(async () => {
            ...
            for (let d = 0; d < s.length && !Pt.current; d++) {
                ...
                try {
                    ...
                    if (to === "weekly" && O !== "pair") {
                        ...
                        f = ve.closes, p = ve.dates, v = ve.highs, n = ve.lows, Q = ve.dailyIndexMap.map(R => Q[R] ?? -1)
                    }
                    const Se = ve ? et : f,
                        _e = m => ve ? wo(m, ve) : m;
                    let ke, ie, $e, I = null,
                    ...
                    if (fe === "weekly") {
                        const m = ur(f, p),
                            R = dr(v, n, p);
                        if (ke = m.prices, ie = R.highs, $e = R.lows, P = m.weekIndex.map(_ => p[_] ?? ""), H = m.weekIndex.map(_ => Q[_] ?? -1), T) {
                        ...
                        if (ke = f, ie = v, $e = n, I = T, P = p, H = Q, y = ur(f, p), q = dr(v, n, p), y.prices.length < 60) continue
                        ...
                        if (m && m.trim() !== "") try {
                            ...
                            if (fe === "weekly") {
                                ...
                                const A = le => {
                                    ...
                                    const U = new Date(Date.UTC(B.getUTCFullYear(), B.getUTCMonth(), B.getUTCDate()));
                                ...
                                for (let le = 0; le < _.length; le++) {
                                    const B = A(p[le]);
                                    B !== N && (C && h.push(k), N = B, C = !0), Number.isFinite(_[le]) && (k = _[le])
                                }
                                C && h.push(k), L = h
                            } else L = _;
                            if (L) {
                    ...
                    const ee = [],
                        ...
                        oe = m => fe === "weekly_on_daily" ? Math.max(m * 5, 21) + 126 : fe === "weekly" ? m + Math.ceil(126 / Z) : m + 126;
                    if (F === "crossover") {
                        const m = new Map,
                            R = (_, h) => {
                                const N = `${_}-${h}`;
                            ...
                            for (const h of t)
                                for (const N of Ro)
                                    for (const k of Po) {
                                        ...
                                        for (let J = D; J < g.length; J++) {
                                            ...
                                            if (B !== null && ue !== B && J >= U) {
                                                const Ye = ue ? "golden_cross" : "death_cross",
                                                    ...
                                                    He = _e(J);
                                                He >= 0 && le[Ye].push(Mt(Se, He, z, st, ze, re, L)), re > 0 && (U = J + re)
                                            }
                                            B = ue
                                        }
                                        const V = [];
                                        ...
                                        const W = V.reduce((J, ue) => J.composite.score > ue.composite.score ? J : ue, V[0]),
                                            de = _ === h;
                                        ee.push({
                                            config: {
                        ...
                        for (const _ of t)
                            for (const h of Dt) {
                                ...
                                const U = B.reduce((D, V) => D.composite.score > V.composite.score ? D : V, B[0]);
                                ee.push({
                                    config: {
                        ...
                        for (const N of t)
                            for (const k of h) {
                                ...
                                if (D < 3) continue;
                                const V = U.reduce((W, de) => W.composite.score > de.composite.score ? W : de, U[0]);
                                ee.push({
                                    config: {
                        ...
                        for (const U of t)
                            for (const D of le) {
                                ...
                                if (Ye < 3) continue;
                                const st = ue.reduce((ze, He) => ze.composite.score > He.composite.score ? ze : He, ue[0]);
                                ee.push({
                                    config: {
                        ...
                        if (F === "crossover") {
                            ...
                            if (k[j] !== null && A[j] !== null) {
                                for (let C = j; C > Math.max(0, j - 63); C--) {
                                    if (k[C] === null || A[C] === null || k[C - 1] === null || A[C - 1] === null) continue;
                                    const le = k[C] > A[C],
                                        B = k[C - 1] > A[C - 1];
                                    if (le !== B) {
                                ...
                                R === "None" && (R = k[j] > A[j] ? "Above (Bullish)" : "Below (Bearish)"), A[j] !== 0 && (_ = k[j] / A[j] - 1), tt[m.configLabel] = {
                                    price: g[j],
                                    fastMA: k[j],
                                    slowMA: A[j],
                                    fastType: h,
                            ...
                            if (h[j] !== null) {
                                ...
                                R === "None" && (R = g[j] > h[j] ? "Above MA" : "Below MA"), h[j] !== 0 && (_ = g[j] / h[j] - 1), tt[m.configLabel] = {
                                    price: g[j],
                                    ma: h[j],
                            ...
                            if (h[j] !== null) {
                                ...
                                if (tt[m.configLabel] = {
                                        ...
                                        fastPeriod: m.config.fastPeriod,
                                        freq: fe
                                    }, N === "price_cross") R = g[j] > h[j] ? "Above MA" : "Below MA", h[j] !== 0 && (_ = g[j] / h[j] - 1);
                                else if (N === "slope" && j > me) {
                                    const k = h[j] !== null && h[j - me] !== null && h[j - me] !== 0 ? h[j] / h[j - me] - 1 : NaN;
                                    R = Number.isFinite(k) ? k > 0 ? "Slope Up" : "Slope Down" : "None", Number.isFinite(k) && (_ = k)
                                } else if (N === "curvature" && j > me + 1) {
                                    const k = h[j] !== null && h[j - me] !== null && h[j - me] !== 0 ? h[j] / h[j - me] - 1 : NaN,
                                        A = h[j - 1] !== null && h[j - 1 - me] !== null && h[j - 1 - me] !== 0 ? h[j - 1] / h[j - 1 - me] - 1 : NaN,
                                        C = Number.isFinite(k) && Number.isFinite(A) ? k - A : NaN;
                                    R = Number.isFinite(C) ? C > 0 ? "Curvature Up" : "Curvature Down" : "None", Number.isFinite(C) && (_ = C)
                                }
                            }
                        } else {
                            const h = {
                            ...
                            if (Number.isFinite(le) && C[j] !== null) {
                                ...
                                if (tt[m.configLabel] = {
                                        ...
                                        fastPeriod: m.config.fastPeriod,
                                        freq: fe
                                    }, B === "price_cross") R = le > C[j] ? `${U} Above MA` : `${U} Below MA`, _ = le - C[j];
                                else if (B === "slope" && j > me) {
                                    const D = C[j] !== null && C[j - me] !== null ? C[j] - C[j - me] : NaN;
                                    R = Number.isFinite(D) ? D > 0 ? "Slope Up" : "Slope Down" : "None", Number.isFinite(D) && (_ = D)
                                } else if (B === "curvature" && j > me + 1) {
                                    const D = C[j] !== null && C[j - me] !== null ? C[j] - C[j - me] : NaN,
                                        V = C[j - 1] !== null && C[j - 1 - me] !== null ? C[j - 1] - C[j - 1 - me] : NaN,
                                        W = Number.isFinite(D) && Number.isFinite(V) ? D - V : NaN;
                                    R = Number.isFinite(W) ? W > 0 ? "Curvature Up" : "Curvature Down" : "None", Number.isFinite(W) && (_ = W)
                                }
                            }
                        }
            ...
            Qt(w), Xe(!1)
        }, [ge, i, we, Me, O, F, je, z, b, ae, xe, re, Ee, Ue, fe, se, me, pe, Ne, Re, Pe, Be, Le, Ie, ut, Ae, qe, ot, sr, Te, Ze, xt, ht.pairs, u]),
        Xo = $.useCallback(async () => {
            ...
            try {
                ...
                if (fe === "weekly") {
                    ...
                    if (p = I.prices, v = P.highs, n = P.lows, Q = I.weekIndex.map(H => d[H] ?? ""), he = I.weekIndex.map(H => f[H] ?? -1), w) {
                    ...
                    if (P && P.trim() !== "") try {
                        ...
                        if (fe === "weekly") {
                            ...
                            const ee = oe => {
                                ...
                                const te = new Date(Date.UTC(be.getUTCFullYear(), be.getUTCMonth(), be.getUTCDate()));
                            ...
                            for (let oe = 0; oe < y.length; oe++) {
                                const be = ee(d[oe]);
                                be !== g && (ce && Z.push(L), g = be, ce = !0), Number.isFinite(y[oe]) && (L = y[oe])
                            }
                            ce && Z.push(L), ie = Z
                        } else ie = y
                    } catch {
        ...
        }, [O, we, Me, i, ge, F, je, pt, Oe, jt, Ee, Ue, se, me, z, re, Qe, Re, Pe, Be, Le, Ie, fe, pe, Ne, Ae, qe, ot, Te, Ze, xt, u]),
        go = $.useMemo(() => F === "crossover" ? `${je===pt?`${je} ${Oe}/${jt}`:`${je}${Oe}/${pt}${jt}`} crossover [${Qe}]` : F === "price_cross" ? `Price × ${je}${Oe} [${Qe}]` : F === "combo" ? `${lt(Ee)} ∧ ${lt(Ue)} [${Qe}]` : F === "indicator_cross" ? `${To({kind:qe,period:ot})} × ${je}${Oe} ${Kt[se]} [${Qe}]` : `${je}(${Oe}) ${Kt[se]} [${Qe}]`, [F, je, pt, Oe, jt, Ee, Ue, se, Qe, qe, ot]),
        bo = $.useMemo(() => O === "pair" ? `${we||"A"}/${Me||"B"}` : O === "single" ? i || "—" : ge[0]?.ticker || "—", [O, we, Me, i, ge]),
        Qo = $.useCallback(async () => {
            ...
            for (let f = 0; f < l.length && !Pt.current; f++) {
                ...
                try {
                    ...
                    if (O === "pair" || O === "pairCombo") {
                        ...
                        v = be.map(te => L.get(te)), n = v.slice(), T = v.slice(), Q = be.map(te => t[te] ?? ""), he = be
                    } else {
                    ...
                    if (to === "weekly" && O !== "pair") {
                        ...
                        v = Se.closes, n = Se.highs, T = Se.lows, he = Se.dailyIndexMap.map(L => he[L] ?? -1)
                    }
                    const _e = Se ? ve : v,
                        ke = g => Se ? wo(g, Se) : g;
                    let ie = null;
                    if (pe === "relative") {
                        ...
                        if (g && g.trim() !== "") try {
                            ...
                            let ce = NaN;
                            for (let oe = 0; oe < ee.length; oe++) Number.isFinite(ee[oe]) ? ce = ee[oe] : ee[oe] = ce;
                            ie = ee
                        } catch {
                            ie = null
                        }
                    ...
                    for (let g = 0; g < M.length && !Pt.current; g++) {
                        const L = M[g],
                            ...
                            ce = (() => {
                                ...
                                for (let R = 0; R < v.length; R++) De[R] === null || dt[R] === null || (m[R] = De[R] > dt[R]);
                                return m
                            })(),
                        ...
                        for (let De = oe; De < v.length; De++) {
                            ...
                            if (We !== null && R !== We && De >= tt) {
                                const _ = ke(De);
                                _ >= 0 && (R ? be.push(Mt(_e, _, z, "buy", y, re, ie)) : te.push(Mt(_e, _, z, "sell", y, re, ie))), re > 0 && (tt = De + re)
                            }
                            We = R
                        }
            ...
            Jt(S), Xe(!1)
        }, [ge, i, we, Me, O, z, b, ae, xe, re, pe, Ne, Re, Pe, Be, Le, Ie, ut, fe, Ae, sr, Te, Ze, xt, ht.pairs, u]),
        _r = $.useCallback(() => ({
            selectedTicker: i,
            targetReturn: z,
            signalType: F,
            ...
            inputSelection: u
        }), [i, z, F, je, O, gt, Ht, oo, Nt, $t, Ft, b, ae, xe, re, Ee, Ue, bt, Ar, fe, se, me, pe, Ne, Re, Pe, Be, Le, Ie, ut, we, Me, Te, Ze, qe, ot, u]),
        $r = $.useCallback(t => {
            if (t && (t.selectedTicker && (a(t.selectedTicker), xo.current = !0), typeof t.targetReturn == "number" && K(t.targetReturn), t.returnMode && G(t.returnMode), typeof t.bandMin == "number" && Ge(t.bandMin), typeof t.bandMax == "number" && Ke(t.bandMax), typeof t.minHold == "number" && at(t.minHold), t.signalType && ft(t.signalType), t.frequency === "daily" || t.frequency === "weekly" || t.frequency === "weekly_on_daily" ? Sr(t.frequency) : t.timeframe === "weekly" && t.frequency === void 0 && Sr("weekly"), (t.signalFamily === "slope" || t.signalFamily === "curvature" || t.signalFamily === "all" || t.signalFamily === "price_cross") && mr(t.signalFamily), typeof t.slopeLookback == "number" && fr(t.slopeLookback), t.legA && Zt(t.legA), t.legB && Xt(t.legB), t.maType && Qr(t.maType), (t.mode === "single" || t.mode === "universe" || t.mode === "pair" || t.mode === "pairCombo" || t.mode === "basket") && Ot(t.mode), t.pairCombo && ht.hydrate(t.pairCombo), Array.isArray(t.results) && Qt(t.results), t.expandedTicker !== void 0 && ro(t.expandedTicker), t.sortBy && Go(t.sortBy), t.runSort && t.runSort.col && t.runSort.dir && lo(t.runSort), t.gridLongSort && t.gridLongSort.col && t.gridLongSort.dir && ao(t.gridLongSort), t.gridShortSort && t.gridShortSort.col && t.gridShortSort.dir && io(t.gridShortSort), Array.isArray(t.gridResults) && Jt(t.gridResults), t.expandedGridTicker !== void 0 && co(t.expandedGridTicker), (t.returnBasis === "absolute" || t.returnBasis === "relative") && rt(t.returnBasis), typeof t.peerLevel == "string" && xs.includes(t.peerLevel) && Ut(t.peerLevel), typeof t.framaFC == "number" && t.framaFC >= 1 && br(t.framaFC), typeof t.framaSC == "number" && t.framaSC > 1 && hr(t.framaSC), typeof t.t3Vf == "number" && t.t3Vf >= 0 && t.t3Vf <= 1 && yr(t.t3Vf), typeof t.almaOffset == "number" && t.almaOffset >= 0 && t.almaOffset <= 1 && kr(t.almaOffset), typeof t.almaSigma == "number" && t.almaSigma > 0 && vr(t.almaSigma), (t.optimizerMaScope === "all" || Fe.includes(t.optimizerMaScope)) && Jr(t.optimizerMaScope), Array.isArray(t.basketTickers) && jr(t.basketTickers.filter(l => typeof l == "string")), (t.basketMode === "stocks" || t.basketMode === "combined") && Mr(t.basketMode), (t.indicatorSource === "price" || t.indicatorSource === "roc" || t.indicatorSource === "rsi" || t.indicatorSource === "momentum") && xr(t.indicatorSource), typeof t.indicatorSourcePeriod == "number" && t.indicatorSourcePeriod >= 1 && gr(t.indicatorSourcePeriod), t.inputSelection && typeof t.inputSelection == "object")) {
        ...
        Fr = $.useMemo(() => gt.map(t => ({
            ...
            configs: t.configs.map(l => {
                ...
                for (const w of l.categories) {
                    const d = w.category === "golden_cross" || w.category === "price_above" || w.category === "combo_bull" || w.category === "slope_up" || w.category === "accel_up" ? "buy" : "sell",
        ...
        ho = (t, l) => {
            ...
            switch (l) {
                ...
                default: {
                    ...
                    if (!f || !S) return -1 / 0;
                    const [, p, v] = f, n = v;
                    return p === "hit" ? b === "band" ? S.bandHitRate?.[n] ?? S.hitRate[n] : S.hitRate[n] : p === "avg" ? S.avgReturn[n] : p === "pf" ? S.profitFactor[n] : -1 / 0
                }
            }
        },
        Pr = $.useMemo(() => {
            const t = Vt.trim().toLowerCase(),
                l = t ? Rr.filter(w => w.tr.ticker.toLowerCase().includes(t) || w.tr.name && w.tr.name.toLowerCase().includes(t)) : [...Rr],
                {
                    col: s,
                    dir: M
                } = Nt;
            return l.sort((w, d) => {
                const S = ho(w, s),
                    f = ho(d, s);
                let p = 0;
                return typeof S == "string" || typeof f == "string" ? p = String(S).localeCompare(String(f)) : p = S - f, M === "asc" ? p : -p
            }), l
        }, [Rr, Nt, b, Vt]),
        ct = t => {
            lo(l => l.col === t ? {
            ...
            for (const d of Pr) {
                ...
                for (const f of ["long", "short"]) {
                    ...
                    for (const he of S.configs) {
                        const ye = Fo(he, f);
                        !ye || ye.summary.count === 0 || ye.composite.score > n && (n = ye.composite.score, p = he, v = ye)
                    }
                    const T = v?.summary,
                        Q = {
                            ticker: S.ticker,
                    ...
                    t.forEach(he => {
                        Q[`hitRate_${he.label}`] = T?.hitRate[he.label] ?? null, Q[`avgReturn_${he.label}`] = T?.avgReturn[he.label] ?? null, Q[`pf_${he.label}`] = T?.profitFactor[he.label] ?? null
                    }), l.push(Q)
                }
            }
            const s = Object.keys(l[0] || {}),
                M = [s.join(","), ...l.map(d => s.map(S => `"${String(d[S]??"").replace(/"/g,'""')}"`).join(","))].join(`
`),
        ...
        yo = t => t.includes("Combo Bull") || t.includes("Combo On") ? "bg-emerald-600/20 text-emerald-400 border-emerald-600/30" : t.includes("Combo Bear") || t.includes("Combo Off") ? "bg-red-600/20 text-red-400 border-red-600/30" : t.includes("Golden") || t.includes("Above") || t.includes("Slope Up") || t.includes("Curvature Up") ? "bg-emerald-600/20 text-emerald-400 border-emerald-600/30" : t.includes("Death") || t.includes("Below") || t.includes("Slope Down") || t.includes("Curvature Down") ? "bg-red-600/20 text-red-400 border-red-600/30" : t.includes("Bullish") ? "bg-blue-600/20 text-blue-400 border-blue-600/30" : t.includes("Bearish") ? "bg-orange-600/20 text-orange-400 border-orange-600/30" : "bg-muted text-muted-foreground border-border",
        rs = t => !t || t === "None" ? "neutral" : t.includes("Combo Bull") || t.includes("Combo On") ? "buy" : t.includes("Combo Bear") || t.includes("Combo Off") ? "short" : t.includes("Golden") || t.includes("Above") || t.includes("Bullish") || t.includes("Slope Up") || t.includes("Curvature Up") ? "buy" : t.includes("Death") || t.includes("Below") || t.includes("Bearish") || t.includes("Slope Down") || t.includes("Curvature Down") ? "short" : "neutral",
        os = (t, l) => {
            if (!l) return "None";
        ...
        ns = (t, l) => {
            ...
            if (!s) return null;
            const M = d => d === void 0 || !Number.isFinite(d) ? "–" : d >= 1e3 ? `$${d.toFixed(0)}` : d >= 10 ? `$${d.toFixed(2)}` : `$${d.toFixed(3)}`,
                w = s.freq === "weekly" ? "weekly" : s.freq === "weekly_on_daily" ? "weekly→daily" : "daily";
            return s.ma !== void 0 && s.maType && s.fastPeriod !== void 0 ? `${M(s.price)} vs ${s.maType}${s.fastPeriod} ${M(s.ma)} · ${w}` : s.fastMA !== void 0 && s.slowMA !== void 0 && s.fastType && s.slowType ? `${s.fastType}${s.fastPeriod} ${M(s.fastMA)} vs ${s.slowType}${s.slowPeriod} ${M(s.slowMA)} · ${w}` : s.price !== void 0 ? `${M(s.price)} · ${w}` : null
        },
        ls = (() => {
            let t = 0;
            for (const l of Ro)
        ...
        as = F === "crossover" ? Fe.length * Fe.length * ls : F === "price_cross" || F === "slope_curvature" || F === "indicator_cross" ? Fe.length * Dt.length : 1;
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsx("h2", {
                ...
                children: er === "optimize" ? "Search MA parameter space by hit rate" : "Score one specific MA setup"
            })]
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            className: nr(i) ? "opacity-40 pointer-events-none" : "",
                            children: e.jsx(Lt, {
                                tickers: ge,
                                value: nr(i) ? "" : i,
                                onChange: a,
                        ...
                        children: [e.jsx("label", {
                            ...
                            className: "flex gap-px",
                            children: ["daily", "weekly", "weekly_on_daily"].map(t => e.jsx("button", {
                        ...
                        children: [e.jsx("label", {
                            className: "text-[9px] font-mono text-muted-foreground uppercase tracking-wider",
                            children: F === "crossover" ? "Fast Type" : "MA Type"
                        }), e.jsx("select", {
                            className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground",
                            value: je,
                    ...
                    }), (je === "FRAMA" || F === "crossover" && pt === "FRAMA" || F === "combo" || F === "slope_curvature" || F === "indicator_cross") && e.jsxs(e.Fragment, {
                        children: [e.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            ...
                            children: [e.jsx("label", {
                                ...
                                max: 200,
                                value: Re,
                                onChange: t => br(Math.max(1, parseInt(t.target.value) || 1)),
                            ...
                            children: [e.jsx("label", {
                                ...
                                max: 500,
                                value: Pe,
                                onChange: t => hr(Math.max(2, parseInt(t.target.value) || 198)),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        })]
                    }), (je === "T3" || F === "crossover" && pt === "T3" || F === "combo" || F === "slope_curvature" || F === "indicator_cross") && e.jsxs("div", {
                        className: "flex flex-col gap-0.5",
                        ...
                        children: [e.jsx("label", {
                            ...
                            step: .01,
                            value: Be,
                            onChange: t => yr(Math.max(0, Math.min(1, parseFloat(t.target.value) || .7))),
                            className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                        })]
                    }), (je === "ALMA" || F === "crossover" && pt === "ALMA" || F === "combo" || F === "slope_curvature" || F === "indicator_cross") && e.jsxs(e.Fragment, {
                        children: [e.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            ...
                            children: [e.jsx("label", {
                                ...
                                step: .01,
                                value: Le,
                                onChange: t => kr(Math.max(0, Math.min(1, parseFloat(t.target.value) || .85))),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        }), e.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            ...
                            children: [e.jsx("label", {
                                ...
                                step: .5,
                                value: Ie,
                                onChange: t => vr(Math.max(.5, parseFloat(t.target.value) || 6)),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        })]
                    }), F !== "combo" && e.jsxs("div", {
                        ...
                        children: [e.jsx("label", {
                            className: "text-[9px] font-mono text-muted-foreground uppercase tracking-wider",
                            children: F === "crossover" ? "Fast Period" : "Period"
                        }), e.jsx("input", {
                            type: "number",
                            min: 2,
                            max: 400,
                    ...
                    }), (F === "slope_curvature" || F === "indicator_cross") && e.jsxs(e.Fragment, {
                        children: [F === "indicator_cross" && e.jsxs(e.Fragment, {
                            children: [e.jsxs("div", {
                                ...
                                children: [e.jsx("label", {
                                    ...
                                    max: 200,
                                    value: ot,
                                    onChange: t => gr(Math.max(1, Math.min(200, parseInt(t.target.value) || 12))),
                                    className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[70px]"
                                })]
                            })]
                        }), e.jsxs("div", {
                            ...
                            children: [e.jsx("label", {
                                ...
                                children: [e.jsx("option", {
                                    value: "price_cross",
                                    children: F === "indicator_cross" ? "Ind × MA" : "Price Cross"
                                }), e.jsx("option", {
                                    value: "slope",
                                    children: "Slope"
                                }), e.jsx("option", {
                            ...
                            children: [e.jsx("label", {
                                ...
                                max: 50,
                                value: me,
                                onChange: t => fr(parseInt(t.target.value) || 5),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[70px]"
                            })]
                        })]
                    }), e.jsxs("div", {
                        ...
                        children: [e.jsx("label", {
                            ...
                            onChange: t => K((parseFloat(t.target.value) || 5) / 100),
                    ...
                    children: ["Using Combo legs from Optimize tab: ", lt(Ee), " ∧ ", lt(Ue)]
                })]
            }), e.jsxs("div", {
                ...
                children: [e.jsx(Bs, {
                    ...
                    ticker: rr.mode === "pair" ? rr.pairLegA || "" : i || ge[0]?.ticker || "",
                    priceContext: rr,
                    signals: tr.profiles,
            ...
            children: [e.jsx(Rs, {
                ...
                children: e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        children: [e.jsxs("div", {
                            ...
                            children: [e.jsx("h2", {
                                ...
                                children: [Math.round((Date.now() - c) / 6e4), "m ago"]
                            }), e.jsx("button", {
                                onClick: async () => {
                                    const t = i;
                                    if (t) {
                        ...
                        children: [e.jsx("label", {
                            ...
                            className: "flex gap-px",
                            children: ["crossover", "price_cross", "combo", "slope_curvature", "indicator_cross"].map(t => e.jsx("button", {
                                ...
                                onClick: () => ft(t),
                                disabled: ne,
                                title: t === "indicator_cross" ? "Apply an MA to an indicator (ROC, RSI, Momentum) instead of price. Detects indicator-vs-MA crossings plus slope/curvature of the MA-of-indicator." : void 0,
                                children: t === "crossover" ? "MA Crossover" : t === "price_cross" ? "Price × MA" : t === "combo" ? "Combo" : t === "slope_curvature" ? "Slope/Curv" : "Indicator × MA"
                            }, t))
                        })]
                    }), e.jsxs("div", {
                        className: "flex flex-col gap-0.5",
                        ...
                        children: [e.jsxs("div", {
                            ...
                            children: [e.jsx("label", {
                                ...
                                value: ot,
                                onChange: t => gr(Math.max(1, Math.min(200, Number(t.target.value) || 1))),
                                disabled: ne
                            })]
                        })]
                    }), (F === "slope_curvature" || F === "indicator_cross") && e.jsxs(e.Fragment, {
                        children: [e.jsxs("div", {
                            ...
                            children: [e.jsx("label", {
                                ...
                                className: "flex gap-px",
                                children: ["price_cross", "slope", "curvature", "all"].map(t => e.jsx("button", {
                                    ...
                                    onClick: () => mr(t),
                                    disabled: ne,
                                    title: t === "price_cross" && F === "indicator_cross" ? "Indicator vs MA-of-indicator crossings" : $o[t],
                                    children: t === "price_cross" ? F === "indicator_cross" ? "Ind × MA" : "Px × MA" : Kt[t]
                                }, t))
                            })]
                        }), e.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [e.jsx("label", {
                                ...
                                value: me,
                                onChange: t => fr(Math.max(1, Math.min(100, Number(t.target.value) || 1))),
                                disabled: ne,
                            ...
                            return e.jsxs("div", {
                                ...
                                children: [e.jsxs("label", {
                                    ...
                                    children: [e.jsxs("select", {
                                        ...
                                        disabled: ne,
                                        title: l.kind === "ma_cross" ? "Fast MA type" : "MA type",
                                        children: Fe.map(w => e.jsx("option", {
                                            value: w,
                                            children: w
                                        }, w))
                                    }), e.jsx("input", {
                                        ...
                                        onChange: w => s({
                                            ...l,
                                            fastPeriod: Math.max(2, Math.min(400, Math.floor(Number(w.target.value) || 0)))
                                        }),
                                        disabled: ne,
                                        title: "Fast period (or single MA period for Px vs MA)"
                                    }), l.kind === "ma_cross" && e.jsxs(e.Fragment, {
                                        children: [e.jsx("span", {
                                            className: "text-[10px] font-mono text-muted-foreground px-0.5",
                                            children: "vs"
                                        }), e.jsx("select", {
                                            "data-testid": M("slow-ma-type"),
                                            className: "text-[10px] font-mono bg-background border border-border rounded px-1 py-0.5",
                                            value: At(l),
                                            onChange: w => s({
                                                ...l,
                                                slowMaType: w.target.value
                                            }),
                                            disabled: ne,
                                            ...
                                            onChange: w => s({
                                                ...l,
                                                slowPeriod: Math.max(2, Math.min(400, Math.floor(Number(w.target.value) || 0)))
                                            }),
                                            disabled: ne,
                                            title: "Slow period"
                                        })]
                    ...
                    }), O !== "pair" && O !== "pairCombo" && Uo, O === "pairCombo" && e.jsxs("div", {
                        ...
                        children: [e.jsxs("div", {
                            ...
                            children: [e.jsx("label", {
                                ...
                                value: `${ae}-${xe}`,
                                onChange: t => {
                                    const [l, s] = t.target.value.split("-").map(Number);
                                    Ge(l), Ke(s)
                                },
                                disabled: ne,
                            ...
                            children: [e.jsx("label", {
                                ...
                                onChange: t => Ge(Number(t.target.value) / 100),
                                disabled: ne
                            })]
                        }), e.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [e.jsx("label", {
                                ...
                                onChange: t => Ke(Number(t.target.value) / 100),
                                disabled: ne
                            })]
                        })]
                    }), e.jsxs("div", {
                        ...
                        children: [e.jsx("label", {
                            ...
                            className: "text-xs font-mono bg-background border border-border rounded px-2 py-1 w-14",
                            value: re,
                            onChange: t => at(Math.max(0, Math.min(126, Math.floor(Number(t.target.value) || 0)))),
                            disabled: ne,
                        ...
                        children: [e.jsx("label", {
                            ...
                            onClick: Zo,
                            title: F === "combo" ? "Test the specific Leg A + Leg B combo configured in the header against every ticker. Output: per-ticker hit rate for THIS one combo." : "Sweep the full MA-type × period parameter space and rank results by hit rate.",
                            children: F === "combo" ? "Test Combo" : "Run Optimizer"
                        })]
                ...
                children: [gt.length === 0 && bt.length === 0 && !ne && e.jsx("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsxs("h3", {
                            ...
                            children: ["Find Best Combo — ", bt.length, " ticker", bt.length !== 1 ? "s" : "", " — ", b === "band" ? `band ${Ve(ae)}–${Ve(xe)}` : `target ${Ve(z)}`, re > 0 ? ` — min hold ${re}d` : ""]
                        }), e.jsx("span", {
                            className: "text-[10px] font-mono text-muted-foreground",
                        ...
                        const l = Ar === t.ticker,
                            s = [...t.topCombos].filter(p => p.bullSignals > 0).sort((p, v) => v.bullScore - p.bullScore).slice(0, 25),
                            M = [...t.topCombos].filter(p => p.bearSignals > 0).sort((p, v) => v.bearScore - p.bearScore).slice(0, 25),
                            w = Do(s, "long", $t),
                            d = Do(M, "short", Ft),
                            S = s[0],
                            f = M[0];
                                ...
                                children: [e.jsxs("div", {
                                    ...
                                    children: [e.jsxs("div", {
                                        ...
                                        children: [e.jsx("span", {
                                            ...
                                            children: [S.legAlabel, " ∧ ", S.legBlabel]
                                        }), e.jsxs("span", {
                                            className: `text-[10px] font-mono font-bold ${Bt(S.bullScore)}`,
                                            children: ["score ", S.bullScore.toFixed(0)]
                                        })]
                                    }), f && e.jsxs("div", {
                                        className: "flex items-center gap-2 ml-16",
                                        children: [e.jsx("span", {
                                    ...
                                    children: [e.jsx("div", {
                                        ...
                                        children: [e.jsx("thead", {
                                            ...
                                            children: e.jsx("tr", {
                                                ...
                                                children: (() => {
                                                    const p = (T, Q) => `${Q} cursor-pointer select-none hover:text-foreground ${$t.col===T?"text-foreground":""}`,
                                                        v = T => $t.col === T ? $t.dir === "desc" ? " ▼" : " ▲" : "",
                                                        n = T => ao(Q => Q.col === T ? {
                                                            col: T,
                                                            dir: Q.dir === "desc" ? "asc" : "desc"
                                                        } : {
                                                            col: T,
                                                            dir: T === "legA" || T === "legB" || T === "side" ? "asc" : "desc"
                                                        });
                                                    return e.jsxs(e.Fragment, {
                                                        children: [e.jsx("th", {
                                                            ...
                                                            className: p("side", "text-left px-2 py-1 font-medium"),
                                                            onClick: () => n("side"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-side`,
                                                            children: ["Side", v("side")]
                                                        }), e.jsxs("th", {
                                                            className: p("legA", "text-left px-2 py-1 font-medium"),
                                                            onClick: () => n("legA"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-legA`,
                                                            children: ["Leg A (Px vs MA)", v("legA")]
                                                        }), e.jsxs("th", {
                                                            className: p("legB", "text-left px-2 py-1 font-medium"),
                                                            onClick: () => n("legB"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-legB`,
                                                            children: ["Leg B (MA vs MA)", v("legB")]
                                                        }), e.jsxs("th", {
                                                            className: p("signals", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("signals"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-signals`,
                                                            children: ["Signals", v("signals")]
                                                        }), e.jsxs("th", {
                                                            className: p("hit-1M", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("hit-1M"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-hit-1M`,
                                                            children: ["Hit 1M", v("hit-1M")]
                                                        }), e.jsxs("th", {
                                                            className: p("hit-3M", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("hit-3M"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-hit-3M`,
                                                            children: ["Hit 3M", v("hit-3M")]
                                                        }), e.jsxs("th", {
                                                            className: p("hit-6M", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("hit-6M"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-hit-6M`,
                                                            children: ["Hit 6M", v("hit-6M")]
                                                        }), e.jsxs("th", {
                                                            className: p("avg-3M", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("avg-3M"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-avg-3M`,
                                                            children: ["Avg 3M", v("avg-3M")]
                                                        }), e.jsxs("th", {
                                                            className: p("pf-3M", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("pf-3M"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-pf-3M`,
                                                            children: ["PF 3M", v("pf-3M")]
                                                        }), e.jsxs("th", {
                                                            className: p("score", "text-right px-2 py-1 font-medium"),
                                                            onClick: () => n("score"),
                                                            "data-testid": `sort-grid-long-${t.ticker}-score`,
                                                            children: ["Score", v("score")]
                                                        })]
                                                    })
                                                })()
                                            })
                                            ...
                                            children: w.map((p, v) => {
                                                ...
                                                return e.jsxs("tr", {
                                                    ...
                                                    children: [e.jsx("td", {
                                                        ...
                                                        className: "px-2 py-1",
                                                        children: p.legAlabel
                                                    }), e.jsx("td", {
                                                        className: "px-2 py-1",
                                                        children: p.legBlabel
                                                    }), e.jsx("td", {
                                                        ...
                                                        children: n?.hitRate["1M"] !== null && n?.hitRate["1M"] !== void 0 ? Ve(n.hitRate["1M"]) : "—"
                                                    }), e.jsx("td", {
                                                        className: `px-2 py-1 text-right ${n?.hitRate["3M"]!==null&&n?.hitRate["3M"]!==void 0?mt(n.hitRate["3M"]):"text-muted-foreground/40"}`,
                                                        children: n?.hitRate["3M"] !== null && n?.hitRate["3M"] !== void 0 ? Ve(n.hitRate["3M"]) : "—"
                                                    }), e.jsx("td", {
                                                        className: `px-2 py-1 text-right ${n?.hitRate["6M"]!==null&&n?.hitRate["6M"]!==void 0?mt(n.hitRate["6M"]):"text-muted-foreground/40"}`,
                                                        children: n?.hitRate["6M"] !== null && n?.hitRate["6M"] !== void 0 ? Ve(n.hitRate["6M"]) : "—"
                                                    }), e.jsx("td", {
                                                        className: "px-2 py-1 text-right",
                                                        children: n?.avgReturn["3M"] !== null && n?.avgReturn["3M"] !== void 0 ? kt(n.avgReturn["3M"]) : "—"
                                                    }), e.jsx("td", {
                                                        ...
                                                        children: n?.profitFactor["3M"] !== null && n?.profitFactor["3M"] !== void 0 ? n.profitFactor["3M"].toFixed(2) : "—"
                                                    }), e.jsx("td", {
                                                        className: `px-2 py-1 text-right font-bold ${Bt(p.bullScore)}`,
                                                        children: p.bullScore.toFixed(0)
                                                    })]
                                                }, `l-${v}`)
                                            })
                                        })]
                                    ...
                                    children: [e.jsx("div", {
                                        ...
                                        children: [e.jsx("thead", {
                                            ...
                                            children: e.jsx("tr", {
                                                className: "text-muted-foreground",
                                                children: (() => {
                                                    const p = (T, Q) => `${Q} cursor-pointer select-none hover:text-foreground ${Ft.col===T?"text-foreground":""}`,
                                                        v = T => Ft.col === T ? Ft.dir === "desc" ? " ▼" : " ▲" : "",
                                                        n = T => io(Q => Q.col === T ? {
                                                            col: T,
                                                            dir: Q.dir === "desc" ? "asc" : "desc"
                                                        } : {
                                            ...
                                            children: d.map((p, v) => {
                                                ...
                                                return e.jsxs("tr", {
                                                    ...
                                                    children: [e.jsx("td", {
                                                        ...
                                                        children: p.bearScore.toFixed(0)
                                                    })]
                                                }, `s-${v}`)
                                            })
                                        })]
                    ...
                    children: e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: [wt.current, "/", wt.total, " ", F === "combo" ? "combos" : "tickers × " + as + " configs"]
                        }), e.jsx("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsxs("h3", {
                            className: "text-xs font-bold text-foreground uppercase tracking-wider",
                            children: [Pr.length, Vt ? ` of ${gt.length}` : "", " tickers — ", F === "combo" ? `combo: ${lt(Ee)} ∧ ${lt(Ue)}` : `${je} ${F==="crossover"?"crossover":"price cross"}`, " — ", b === "band" ? `band ${Ve(ae)}–${Ve(xe)}` : `target ${Ve(z)}`, pe === "relative" ? ` — vs ${Ne} median` : ""]
                        }), e.jsxs("div", {
                            className: "flex items-center gap-1",
                            children: [e.jsx("input", {
                                ...
                                children: [e.jsx("label", {
                                    ...
                                    children: ws.map(t => e.jsx("option", {
                                        value: t.value,
                                        children: t.label
                                    }, t.value))
                                })]
                        ...
                        children: e.jsxs("table", {
                            ...
                            children: [e.jsx("thead", {
                                ...
                                children: e.jsx("tr", {
                                    ...
                                    children: (() => {
                                        const t = (s, M) => `${M} cursor-pointer select-none hover:text-foreground ${Nt.col===s?"text-foreground":""}`,
                                            l = s => Nt.col === s ? Nt.dir === "desc" ? " ▼" : " ▲" : "";
                                        return e.jsxs(e.Fragment, {
                                            children: [e.jsxs("th", {
                                                ...
                                                children: ["Ticker", l("ticker")]
                                            }), e.jsxs("th", {
                                                className: t("currentSignal", "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct("currentSignal"),
                                                "data-testid": "sort-header-currentSignal",
                                                children: ["Current Signal", l("currentSignal")]
                                            }), e.jsxs("th", {
                                                className: t("side", "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct("side"),
                                                "data-testid": "sort-header-side",
                                                children: ["Side", l("side")]
                                            }), e.jsxs("th", {
                                                className: t("bestConfig", "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct("bestConfig"),
                                                "data-testid": "sort-header-bestConfig",
                                                children: ["Best Config", l("bestConfig")]
                                            }), e.jsxs("th", {
                                                className: t("bestSignal", "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct("bestSignal"),
                                                "data-testid": "sort-header-bestSignal",
                                                children: ["Best Signal", l("bestSignal")]
                                            }), e.jsxs("th", {
                                                className: t("signals", "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct("signals"),
                                                "data-testid": "sort-header-signals",
                                                children: ["N", l("signals")]
                                            }), vt.filter((s, M) => M >= 2).map(s => e.jsxs("th", {
                                                className: t(`hit-${s.label}`, "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct(`hit-${s.label}`),
                                                "data-testid": `sort-header-hit-${s.label}`,
                                                children: [b === "band" ? "Band" : "Hit", " ", s.label, l(`hit-${s.label}`)]
                                            }, s.label)), vt.filter((s, M) => M >= 2).map(s => e.jsxs("th", {
                                                className: t(`avg-${s.label}`, "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct(`avg-${s.label}`),
                                                "data-testid": `sort-header-avg-${s.label}`,
                                                children: ["Avg ", s.label, l(`avg-${s.label}`)]
                                            }, `avg-${s.label}`)), vt.filter((s, M) => M >= 2).map(s => e.jsxs("th", {
                                                className: t(`pf-${s.label}`, "text-center px-2 py-1 font-bold bg-card"),
                                                onClick: () => ct(`pf-${s.label}`),
                                                "data-testid": `sort-header-pf-${s.label}`,
                                                children: ["PF ", s.label, l(`pf-${s.label}`)]
                                            }, `pf-${s.label}`)), e.jsxs("th", {
                                ...
                                children: Pr.flatMap(t => {
                                    ...
                                    return [{
                                        ...
                                        const v = S === "long" ? "Long" : "Short",
                                            n = S === "long" ? "bg-emerald-600/20 text-emerald-400 border-emerald-600/30" : "bg-red-600/20 text-red-400 border-red-600/30",
                                            T = f?.cat.summary ?? null,
                                            Q = f?.score ?? 0,
                                            he = p === 0,
                                            ye = os(l, f?.cfg.configLabel),
                                            et = ss(l, f?.cfg.configLabel),
                                            ve = f ? l.currentValueByConfig?.[f.cfg.configLabel] : void 0,
                                            Se = ns(l, f?.cfg.configLabel),
                                            _e = rs(ye),
                                            ke = s ? "bg-primary/10" : _e === "buy" ? "bg-emerald-600/10 hover:bg-emerald-600/15" : _e === "short" ? "bg-red-600/10 hover:bg-red-600/15" : "hover:bg-white/5";
                                        return e.jsxs("tr", {
                                            className: `${ke} cursor-pointer ${he?"border-t border-border":"border-t border-border/30"}`,
                                            onClick: () => ro(s ? null : l.ticker),
                                            ...
                                            children: [e.jsx("td", {
                                                ...
                                                children: f ? f.cfg.configLabel : "–"
                                            }), e.jsx("td", {
                                                className: "text-center px-2 py-1 text-foreground",
                                                children: f ? f.cat.label : "–"
                                            }), e.jsx("td", {
                                                className: "text-center px-2 py-1 text-muted-foreground tabular-nums",
                                                children: T ? T.count : "–"
                                            }), vt.filter((ie, $e) => $e >= 2).map(ie => {
                                                const $e = T ? b === "band" ? T.bandHitRate?.[ie.label] ?? T.hitRate[ie.label] : T.hitRate[ie.label] : 0;
                                                return e.jsx("td", {
                                                    className: `text-center px-2 py-1 ${T?mt($e):""}`,
                                                    children: T ? Ve($e) : "–"
                                                }, ie.label)
                                            }), vt.filter((ie, $e) => $e >= 2).map(ie => e.jsx("td", {
                                                className: `text-center px-2 py-1 ${T?T.avgReturn[ie.label]>=0?"text-green-400":"text-red-400":""}`,
                                                children: T ? kt(T.avgReturn[ie.label]) : "–"
                                            }, `avg-${ie.label}`)), vt.filter((ie, $e) => $e >= 2).map(ie => e.jsx("td", {
                                                className: `text-center px-2 py-1 ${T?lr(T.profitFactor[ie.label]):""}`,
                                                children: T ? T.profitFactor[ie.label] >= 99 ? "∞" : T.profitFactor[ie.label].toFixed(2) : "–"
                                            }, `pf-${ie.label}`)), e.jsx("td", {
                                                className: "text-center px-2 py-1",
                                                children: f ? e.jsx("span", {
                                                    className: "inline-block px-1.5 py-0.5 rounded font-bold",
                                                    style: {
                                                        backgroundColor: Mo(Q),
                                                        color: Bt(Q)
                                                    },
                        ...
                        if (!t) return null;
                        const l = [...t.configs].sort((s, M) => M.bestScore - s.bestScore);
                        return e.jsxs("div", {
                            ...
                            children: [e.jsxs("h4", {
                                ...
                                children: [l.length, " configurations tested — showing top results"]
                            }), e.jsx("div", {
                                className: "grid grid-cols-1 lg:grid-cols-2 gap-3",
                                children: l.slice(0, 6).map((s, M) => {
                                    const w = s._bestCategoryResult ?? s.categories.reduce((d, S) => d.composite.score > S.composite.score ? d : S, s.categories[0]);
                                    return e.jsxs("div", {
                                        ...
                                        children: [e.jsxs("div", {
                                            ...
                                            children: [e.jsx("span", {
                                                ...
                                                style: {
                                                    backgroundColor: Mo(s.bestScore),
                                                    color: Bt(s.bestScore)
                                                },
                                                children: s.bestScore
                                            })]
                                        }), s.categories.filter(d => d.summary.count > 0).map(d => {
                                            const S = `${t.ticker}::${s.configLabel}::${d.category}`,
                                                f = Oo.has(S),
                                                p = !!(d.profiles && d.profiles.length >= 10 && t.priceContext),
                                                v = d.category === "golden_cross" || d.category === "price_above" || d.category === "combo_bull" || d.category === "slope_up" || d.category === "accel_up" ? "buy" : "sell";
                                            return e.jsxs("div", {
                                                className: "mt-1",
                                                children: [e.jsxs("div", {
                                                    ...
                                                    children: [e.jsx("span", {
                                                        ...
                                                        children: [d.summary.count, " signals"]
                                                    }), p ? e.jsxs("button", {
                                                        type: "button",
                                                        onClick: () => Vo(S),
