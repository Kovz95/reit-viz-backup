...
const $t = [{
    ...
    Ze = ["broad", "style", "sector", "reit", "sub_industry", "intl", "rates_bonds", "commodities", "vol_crypto"],
    Lt = [{
        ticker: "SPY",
        label: "SPY",
        name: "S&P 500 (SPY)",
...
function Tt(s) {
    ...
    for (let d = 1; d < s.length; d++) {
        const b = s[d - 1],
            p = s[d];
        b != null && p != null && Number.isFinite(b) && Number.isFinite(p) && b > 0 && p > 0 && u.push(Math.log(p / b))
    }
    return u
}
...
function se(s) {
    return s == null || !Number.isFinite(s) ? "text-muted-foreground" : s > 0 ? "text-emerald-400" : s < 0 ? "text-red-400" : "text-muted-foreground"
}

function Y(s) {
    if (s == null || !Number.isFinite(s)) return "text-muted-foreground";
    const u = Math.abs(s);
    return u < 1 ? s > 0 ? "text-emerald-300/70" : "text-red-300/70" : u < 2 ? s > 0 ? "text-emerald-400" : "text-red-400" : u < 3 ? s > 0 ? "text-emerald-500 font-bold" : "text-orange-400 font-bold" : s > 0 ? "text-emerald-300 font-bold bg-emerald-500/10 px-1 rounded" : "text-red-300 font-bold bg-red-500/15 px-1 rounded"
}
...
function Le(s) {
    return s == null || !Number.isFinite(s) ? "—" : s < 1 || s > 99 ? s.toFixed(2) + "%" : s.toFixed(1) + "%"
}
...
function Ie(s) {
    ...
    const u = s,
        ...
        b = Math.min(u, d),
        p = s >= 50;
    return b < 1 ? p ? "text-emerald-300 font-bold bg-emerald-500/10 px-1 rounded" : "text-red-300 font-bold bg-red-500/15 px-1 rounded" : b < 5 ? p ? "text-emerald-500 font-bold" : "text-orange-400 font-bold" : b < 10 ? p ? "text-emerald-400" : "text-red-400" : "text-muted-foreground"
}
...
function Ot() {
    ...
    } = Nt(), [d, b] = g.useState([]), [p, C] = g.useState(!1), [A, _] = g.useState(!1), [pe, G] = g.useState(null), [J, st] = g.useState(null), [ce, lt] = g.useState(null), [N, rt] = g.useState({
        key: "absSigmaMove",
        dir: "desc"
    }), [k, ot] = g.useState(() => {
        try {
    ...
    const [y, _e] = g.useState(!1), [T, ct] = g.useState([]), [de, Te] = g.useState(!1), [W, dt] = g.useState(5), [I, ut] = g.useState({
        key: "absSigmaMove",
        dir: "desc"
    }), [Ne, je] = g.useState(null), [Me, mt] = g.useState([]), [gt, Fe] = g.useState(!1), ue = g.useRef(new Map), [be, ht] = g.useState([]), [Z, ze] = g.useState(() => {
        try {
            ...
            try {
                ...
                b(m => m.map(o => {
                    ...
                    const z = M != null ? Math.exp(M) - 1 : null,
                        L = M != null && o.sigmaDaily != null && o.sigmaDaily > 0 ? M / (o.sigmaDaily * i) : null,
                        Q = M != null && o.sigmaEwmaDaily != null && o.sigmaEwmaDaily > 0 ? M / (o.sigmaEwmaDaily * i) : null;
                    let S = null,
                        $ = 0;
        ...
        try {
            ...
            await Promise.all(n.map(async l => {
                if (!ue.current.has(l)) try {
                    ...
                    console.warn("[Sigma] failed to load history for index", l, i?.message ?? i)
                }
            }));
            let a = new Map;
            try {
            ...
            for (let c = 0; c < s.length; c += t) {
                const f = s.slice(c, c + t),
                    D = await Promise.all(f.map(async R => {
                        try {
                            const [w, j] = await Promise.all([Mt(R.ticker, "close"), St(R.ticker)]), x = (j.earnings || []).filter(v => typeof v == "string" && v.length === 10).filter(v => W >= 999 || v >= a).sort(), M = Math.max(k + h + 5, 90);
    ...
    const Ee = g.useMemo(() => {
            ...
            return n.sort((r, t) => {
                let l = null,
                    i = null;
                const m = I.key;
                return m === "earningsDate" ? (l = r.earningsDate, i = t.earningsDate) : m === "ticker" ? (l = r.ticker, i = t.ticker) : m === "closeOnDate" ? (l = r.closeOnDate, i = t.closeOnDate) : m === "dollarChange" ? (l = r.dollarChange, i = t.dollarChange) : m === "pctChange" ? (l = r.pctChange, i = t.pctChange) : m === "sigmaAnnualized" ? (l = r.sigmaAnnualized, i = t.sigmaAnnualized) : m === "sigmaEwmaAnnualized" ? (l = r.sigmaEwmaAnnualized, i = t.sigmaEwmaAnnualized) : m === "sigmaMove" ? (l = r.sigmaMove, i = t.sigmaMove) : m === "sigmaMoveEwma" ? (l = r.sigmaMoveEwma, i = t.sigmaMoveEwma) : m === "percentile" ? (l = r.percentile, i = t.percentile) : m === "absSigmaMove" && (l = r.sigmaMove == null ? null : Math.abs(r.sigmaMove), i = t.sigmaMove == null ? null : Math.abs(t.sigmaMove)), l == null && i == null ? 0 : l == null ? 1 : i == null ? -1 : typeof l == "string" && typeof i == "string" ? l.localeCompare(i) * a : (l - i) * a
            }), n
        }, [T, I]),
        F = g.useMemo(() => {
        ...
        Ce = g.useMemo(() => {
            ...
            return n.sort((r, t) => {
                let l = null,
                    i = null;
                return N.key === "ticker" ? (l = r.ticker, i = t.ticker) : N.key === "last" ? (l = r.last, i = t.last) : N.key === "dollarChange" ? (l = r.dollarChange, i = t.dollarChange) : N.key === "pctChange" ? (l = r.pctChange, i = t.pctChange) : N.key === "sigmaAnnualized" ? (l = r.sigmaAnnualized, i = t.sigmaAnnualized) : N.key === "sigmaEwmaAnnualized" ? (l = r.sigmaEwmaAnnualized, i = t.sigmaEwmaAnnualized) : N.key === "sigmaMove" ? (l = r.sigmaMove, i = t.sigmaMove) : N.key === "sigmaMoveEwma" ? (l = r.sigmaMoveEwma, i = t.sigmaMoveEwma) : N.key === "percentile" ? (l = r.percentile, i = t.percentile) : N.key === "absSigmaMove" && (l = r.sigmaMove == null ? null : Math.abs(r.sigmaMove), i = t.sigmaMove == null ? null : Math.abs(t.sigmaMove)), l == null && i == null ? 0 : l == null ? 1 : i == null ? -1 : typeof l == "string" && typeof i == "string" ? l.localeCompare(i) * a : (l - i) * a
            }), n
        }, [d, N]),
        O = g.useMemo(() => {
        ...
        bt = g.useCallback(() => {
            if (y) {
                const o = ["ticker", "name", "earnings_date", "reaction_date", "prior_date", "close_on_date", "prior_close", "dollar_change", "pct_change", "sigma_daily", "sigma_annualized", "sigma_move", "sigma_ewma_daily", "sigma_ewma_annualized", "sigma_move_ewma", "percentile", "percentile_n", "hv_window"],
                    c = Ee.map(x => [x.ticker, `"${x.name.replace(/"/g,'""')}"`, x.earningsDate, x.reactionDate, x.priorDate, x.closeOnDate ?? "", x.priorClose ?? "", x.dollarChange ?? "", x.pctChange ?? "", x.sigmaDaily ?? "", x.sigmaAnnualized ?? "", x.sigmaMove ?? "", x.sigmaEwmaDaily ?? "", x.sigmaEwmaAnnualized ?? "", x.sigmaMoveEwma ?? "", x.percentile ?? "", x.percentileN ?? 0, x.hvWindow]),
                    D = [...["# Sigma Move — Earnings days", `# Lookback (years of prints): ${W>=999?"all":W+"Y"}`, `# Vol lookback: ${k}d  |  Horizon: ${h}d`, `# Universe: ${s.length} tickers / ${T.length} prints`], o.join(","), ...c.map(x => x.join(","))].join(`
`),
                    R = new Blob([D], {
                        type: "text/csv"
                    }),
                ...
                j.href = w, j.download = `sigma-move-earnings-${new Date().toISOString().slice(0,10)}.csv`, j.click(), URL.revokeObjectURL(w);
                return
            }
            const n = ["ticker", "name", "last", "previous_close", "dollar_change", "pct_change", "log_return_today", "log_return_n", "pct_change_n", "sigma_daily", "sigma_annualized", "sigma_move", "sigma_ewma_daily", "sigma_ewma_annualized", "sigma_move_ewma", "percentile", "percentile_n", "hv_window"],
                a = Ce.map(o => [o.ticker, `"${o.name.replace(/"/g,'""')}"`, o.last ?? "", o.previousClose ?? "", o.dollarChange ?? "", o.pctChange ?? "", o.logReturnToday ?? "", o.logReturnN ?? "", o.pctChangeN ?? "", o.sigmaDaily ?? "", o.sigmaAnnualized ?? "", o.sigmaMove ?? "", o.sigmaEwmaDaily ?? "", o.sigmaEwmaAnnualized ?? "", o.sigmaMoveEwma ?? "", o.percentile ?? "", o.percentileN ?? 0, o.hvWindow]),
                t = [...["# Sigma Move snapshot", `# Fetched: ${J||"n/a"}`, `# Market state: ${ce||"unknown"}`, `# Vol lookback: ${k}d  |  Horizon: ${h}d`, `# Universe: ${d.length} tickers`], n.join(","), ...a.map(o => o.join(","))].join(`
`),
                l = new Blob([t], {
                    type: "text/csv"
                }),
            ...
            m.href = i, m.download = `sigma-move-${new Date().toISOString().slice(0,10)}.csv`, m.click(), URL.revokeObjectURL(i)
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h1", {
                        ...
                        children: y ? `Sigma move on each earnings print. ${h}-day log return scaled by σ (RV / EWMA) over a ${k}-day window ending the trading day before the print.` : `${h===1?"Today's move":`${h}-day move`} scaled by ${k}-day log-return vol (RV / EWMA λ=${xe}) + empirical percentile rank. Live quotes via Yahoo Finance (~15-min delayed).`
                    })]
                }), e.jsxs("div", {
                    ...
                    children: [!y && ce && e.jsxs("span", {
                        ...
                        title: J,
                        children: ["Quotes: ", new Date(J).toLocaleTimeString("en-US", {
                            hour: "numeric",
                            minute: "2-digit",
                            second: "2-digit"
                        })]
                    }), y ? e.jsxs("span", {
                        children: [T.length.toLocaleString(), " prints · ", s.length, " tickers"]
                    }) : e.jsxs("span", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsxs("span", {
                        ...
                        children: [e.jsx(Ge, {
                            className: "w-3 h-3"
                        }), y ? "Index avg |σ| on these dates" : "Index σ today", ":"]
                    }), Ze.map(n => {
                    ...
                    return a.length === 0 && r.length === 0 ? null : e.jsxs("div", {
                        ...
                        children: [e.jsxs("span", {
                            ...
                            children: [e.jsx("span", {
                                ...
                                className: "text-foreground",
                                children: t.avgAbsSigma != null ? `${t.avgAbsSigma.toFixed(2)}σ` : "—"
                            }), e.jsxs("span", {
                                className: "text-muted-foreground",
                                children: ["|σ|≥1: ", t.pctAbsGte1 != null ? `${(t.pctAbsGte1*100).toFixed(0)}%` : "—"]
                            })]
                        }, t.ticker))]
                    }, n)
                })]
            ...
            children: [pe && e.jsx("div", {
                ...
                children: [e.jsx(ke, {
                    ...
                    children: ["Loading ", k, "-day vol (RV + EWMA) + percentile distribution…"]
                })]
            }), y && de && e.jsxs("div", {
                className: "flex items-center justify-center h-32",
                children: [e.jsx(ke, {
                    ...
                    className: "ml-2 text-sm text-muted-foreground",
                    children: ["Computing sigma move per earnings print", Ne ? ` · ${Ne.done}/${Ne.total} tickers` : "", "…"]
                })]
                        ...
                        children: (() => {
                            ...
                            return n.map((t, l) => {
                                const i = we(t.sigmaMove),
                                    m = t.reactionDate === t.earningsDate ? t.earningsDate : `${t.earningsDate} → ${t.reactionDate}`,
                                    o = a?.get(t.reactionDate) ?? null,
                                    c = r?.get(t.reactionDate) ?? null,
                                    f = t.sigmaMove != null && o != null ? t.sigmaMove - o : null;
                                return e.jsxs("tr", {
                                    ...
                                    children: [e.jsx("td", {
                                        ...
                                        className: "px-3 py-1.5 text-right text-muted-foreground",
                                        title: t.sigmaDaily != null ? `daily: ${(t.sigmaDaily*100).toFixed(2)}% · window: ${t.hvWindow} returns ending ${t.priorDate}` : void 0,
                                        children: t.sigmaAnnualized != null ? `${(t.sigmaAnnualized*100).toFixed(1)}%` : "—"
                                    }), e.jsx("td", {
                                        className: "px-3 py-1.5 text-right text-muted-foreground",
                                        title: t.sigmaEwmaDaily != null ? `EWMA daily (λ=${xe}): ${(t.sigmaEwmaDaily*100).toFixed(2)}% · ending ${t.priorDate}` : void 0,
                                        children: t.sigmaEwmaAnnualized != null ? `${(t.sigmaEwmaAnnualized*100).toFixed(1)}%` : "—"
                                    }), e.jsx("td", {
                                        className: `px-3 py-1.5 text-right ${Y(t.sigmaMove)}`,
                                        children: U(t.sigmaMove)
                                    }), e.jsx("td", {
                                        className: `px-3 py-1.5 text-right ${Y(t.sigmaMoveEwma)}`,
                                        title: t.sigmaMoveEwma != null ? `Log return / (σ_EWMA · √${h})` : void 0,
                                        ...
                                        title: t.percentile != null ? `Rank of ${h}-day log return in trailing ${t.percentileN} obs (${k}d window)` : void 0,
                        ...
                        children: [Z && Me.map(a => {
                            ...
                            return e.jsxs("tr", {
                                ...
                                children: [e.jsx("td", {
                                    ...
                                    className: "px-3 py-1.5 text-right text-muted-foreground",
                                    title: a.sigmaDaily != null ? `daily: ${(a.sigmaDaily*100).toFixed(2)}% · window: ${a.hvWindow} returns` : void 0,
                                    children: a.sigmaAnnualized != null ? `${(a.sigmaAnnualized*100).toFixed(1)}%` : "—"
                                }), e.jsx("td", {
                                    className: "px-3 py-1.5 text-right text-muted-foreground",
                                    title: a.sigmaEwmaDaily != null ? `EWMA daily (λ=${xe}): ${(a.sigmaEwmaDaily*100).toFixed(2)}%` : void 0,
                                    children: a.sigmaEwmaAnnualized != null ? `${(a.sigmaEwmaAnnualized*100).toFixed(1)}%` : "—"
                                }), e.jsx("td", {
                                    ...
                                    title: a.percentile != null ? `Rank of ${h}-day log return in trailing ${a.percentileN} obs (${k}d window)` : void 0,
                            ...
                            return e.jsxs("tr", {
                                ...
                                children: [e.jsx("td", {
                                    ...
                                    className: `px-3 py-1.5 text-right ${Y(a.sigmaMoveEwma)}`,
                                    title: a.sigmaMoveEwma != null ? `Log return / (σ_EWMA · √${h})` : void 0,
                                    children: U(a.sigmaMoveEwma)
                                }), e.jsx("td", {
                                    className: `px-3 py-1.5 text-right text-[10px] uppercase tracking-wider ${r.color}`,
                                    children: r.label
...
export {
    It as DEFAULT_INDEX_GROUPS, Ke as INDEX_GROUP_LABELS, Ze as INDEX_GROUP_ORDER, Je as INDEX_GROUP_SHORT, Ot as
    default
};