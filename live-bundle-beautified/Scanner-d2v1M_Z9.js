...
function Oe(s, l) {
    const o = new Array(s.length).fill(null);
    let a = 0;
    for (let r = 0; r < s.length; r++) a += s[r], r >= l && (a -= s[r - l]), r >= l - 1 && (o[r] = a / l);
    return o
}
...
function Ue(s, l = 14) {
    ...
    for (let t = l + 1; t < s.length; t++) {
        const d = s[t] - s[t - 1],
            n = d > 0 ? d : 0,
            h = d < 0 ? -d : 0;
        a = (a * (l - 1) + n) / l, r = (r * (l - 1) + h) / l, o[t] = r === 0 ? 100 : 100 - 100 / (1 + a / r)
    }
    return o
}
...
function te(s, l, o, a) {
    ...
    for (const [d, n, h] of a) {
        ...
        m.avg_20d != null && m.hit_20d != null && m.n >= 20 && (m.quality = Math.abs(m.avg_20d) * (m.hit_20d - 50) * Math.log10(m.n + 1) / 100), r.push(m)
    }
    return r
}
    ...
    for (const u of L) {
        ...
        if (b && !(b.n < 20 || b.avg_20d == null) && Math.abs(b.quality) > z) {
            ...
            const j = b.avg_20d,
                ...
                R = b.hit_20d ?? 50,
                K = R >= 55 ? "actionable edge" : R >= 50 ? "marginal edge" : "NO edge (coin-flip or worse — do not trade)";
            q = {
                signal: u.signal,
                bucket: b,
...
function ie(s, l) {
    return s === "rsi14" ? l.toFixed(1) : s === "pct" ? l.toFixed(0) : s === "dist_200ma" ? `${l>=0?"+":""}${l.toFixed(1)}%` : `${l>=0?"+":""}${l.toFixed(2)}`
}
...
function nt({
    ...
    const [r, t] = g.useState("price_z"), [d, n] = g.useState(null), [h, p] = g.useState(!1), [c, N] = g.useState(null);
    g.useEffect(() => {
        let f = !1;
        if (l && l.length >= 250) {
            n(l);
    ...
    const m = g.useMemo(() => {
        ...
        F = o ? "fixed top-16 right-4 z-40 w-[640px] max-w-[95vw] max-h-[80vh] flex flex-col bg-card border border-border rounded-lg shadow-2xl overflow-hidden" : "w-full h-full flex flex-col border border-border/30 min-h-0 overflow-hidden";
    return e.jsxs("div", {
        className: F,
        children: [e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx(Z, {
                    ...
                    children: ["quality ", a.bucket.quality.toFixed(2), " · n=", a.bucket.n]
                })]
            }), e.jsxs("div", {
                ...
                children: [e.jsx(V, {
                    ...
                    valueClass: a.expectedMove20dPct < 0 ? "text-rose-400" : "text-emerald-400"
                }), e.jsx(V, {
                ...
                children: a.direction === "short" ? `Setup: SHORT ${s.ticker} — price expected to fall toward $${a.expectedPrice20d.toFixed(2)}` : a.direction === "long" ? `Setup: LONG ${s.ticker} — price expected to rise toward $${a.expectedPrice20d.toFixed(2)}` : "No actionable bias — bucket is statistically flat."
            })]
        }) : e.jsx("div", {
                    ...
                    children: r.map((n, h) => {
                        ...
                        return e.jsxs("tr", {
                            ...
                            children: [e.jsxs("td", {
                                ...
                                children: [fe(n.priceLevelLow), " – ", fe(n.priceLevelHigh)]
                            }), e.jsx("td", {
            ...
            children: [e.jsx("span", {
                ...
                className: "font-semibold",
                children: "hit"
            }), " = % of observations that reverted in the expected direction (", we(l).trim(), ").", " ", e.jsx("span", {
                className: "font-semibold",
                children: "Q"
            }), " = quality score on the 20-day horizon.", " ", e.jsx("span", {
                className: "font-semibold",
                children: "Price range"
            }), ` = $ levels for this bucket given today's μ/σ (RSI buckets show "—" since RSI doesn't translate to a single price).`, " ", "Sample: ", s.firstDate, " → ", s.lastDate, "."]
        })]
    })
}
...
function gt() {
    const {
        ...
        queryFn: qe,
        staleTime: 1 / 0
    }), [o, a] = g.useState("workbook"), [r, t] = g.useState(""), [d, n] = g.useState("industry"), [h, p] = g.useState(""), [c, N] = g.useState("singles"), [m, F] = g.useState(!1), [f, L] = g.useState({
        done: 0,
        total: 0,
        currentTask: ""
    }), [q, z] = g.useState([]), [B, u] = g.useState([]), [$, b] = g.useState(null), j = g.useRef(!1), [P, C] = g.useState(null), [R, K] = g.useState(null), [U, Se] = g.useState({
        key: "quality",
        dir: -1
    }), [G, $e] = g.useState({
        key: "quality",
        dir: -1
    }), [H, Pe] = g.useState(20), [D, Fe] = g.useState(""), [Q, Le] = g.useState(!1), Be = g.useMemo(() => {
        if (!l) return [];
        const i = new Set;
        return l.forEach(S => {
            const x = S[d];
        ...
        return o === "classification" ? h ? l.filter(i => i[d] === h).map(i => i.ticker) : [] : l.map(i => i.ticker)
    }, [l, o, r, s, d, h]), Me = c === "singles" ? A.length : Math.max(0, A.length * (A.length - 1) / 2), E = g.useMemo(() => {
        const i = new Map;
        if (l)
    ...
    const ue = g.useMemo(() => {
            let i = q.filter(x => Q ? x.bestSignal != null && x.n >= H : x.bestSignal == null || x.n >= H);
            if (D) {
            ...
            return i.sort((x, v) => {
                const y = x[U.key],
                    k = v[U.key];
                return y == null && k == null ? 0 : y == null ? 1 : k == null ? -1 : typeof y == "string" ? S * y.localeCompare(k) : S * (y - k)
            }), i
        }, [q, U, H, D, Q]),
        he = g.useMemo(() => {
            let i = B.filter(x => Q ? x.bestSignal != null && x.n >= H : x.bestSignal == null || x.n >= H);
            if (D) {
                const x = D.toUpperCase();
                i = i.filter(v => v.tickerA.includes(x) || v.tickerB.includes(x) || v.classA.toUpperCase().includes(x) || v.classB.toUpperCase().includes(x))
            }
            const S = G.dir;
            return i.sort((x, v) => {
                const y = x[G.key],
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx(He, {
                    ...
                    children: ["Universe: ", e.jsx("span", {
                        ...
                        children: o === "basket" ? "— pick a basket above" : o === "classification" ? `— pick a ${se[d]}` : "— workbook is empty"
            ...
            children: [c === "singles" ? e.jsx(it, {
                ...
                children: [e.jsx(Te, {
                    ...
                    children: c === "singles" ? "Singles scan analyzes each ticker for mean-reversion setups across price-z, % from 200MA, RSI(14), and percentile." : "Pairs scan analyzes every (N choose 2) combination for ratio mean-reversion across raw z, OLS-residual z, β-adj spread z, and percentile."
                })]
            })]
        }), P && e.jsx(nt, {
            ticker: P,
        ...
        children: [e.jsx("thead", {
            ...
            children: s.map(t => e.jsxs("tr", {
                ...
                children: [e.jsx("td", {
                    ...
                    children: [t.bestSignal ? re(t.bestSignal) : "—", t.bestSignalValue != null && t.bestSignal && e.jsxs("span", {
                    ...
                    children: t.expectedMove20dPct != null ? `${t.expectedMove20dPct>=0?"+":""}${t.expectedMove20dPct.toFixed(2)}%` : "—"
                }), e.jsx("td", {
                    className: "px-2 py-1 text-right font-semibold",
                    children: t.expectedPrice20d != null ? `$${t.expectedPrice20d.toFixed(2)}` : "—"
                }), e.jsx("td", {
        ...
        children: [e.jsx("thead", {
            ...
            children: s.map(t => e.jsxs("tr", {
                ...
                children: [e.jsx("td", {
                    ...
                    className: "px-2 py-1 text-foreground/80",
                    children: [t.bestSignal ? ve(t.bestSignal) : "—", t.bestSignalValue != null && t.bestSignal && e.jsxs("span", {
                        className: "ml-1 text-muted-foreground",
                    ...
                    className: "px-2 py-1 text-right",
                    children: t.expectedRatio20d != null ? t.expectedRatio20d.toFixed(4) : "—"
                }), e.jsx("td", {
                    className: "px-2 py-1 text-right font-semibold",
                    children: t.expectedAIfBFlat != null ? `$${t.expectedAIfBFlat.toFixed(2)}` : "—"
                }), e.jsx("td", {
                    className: "px-2 py-1 text-right font-semibold",
                    children: t.expectedBIfAFlat != null ? `$${t.expectedBIfAFlat.toFixed(2)}` : "—"
                }), e.jsx("td", {
                    className: `px-2 py-1 text-right ${(t.hit20d??0)>=65?"text-emerald-400 font-semibold":(t.hit20d??0)<=35?"text-rose-400 font-semibold":""}`,
                    children: t.hit20d != null ? `${t.hit20d.toFixed(0)}%` : "—"
                }), e.jsx("td", {
...
function ot({
    ...
    const n = g.useMemo(() => !a || !t || a.length < 200 || t.length < 200 ? null : Ne(a, t, s, l), [a, t, s, l]);
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [!n && e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx(Z, {
                        className: "w-3.5 h-3.5"
                    }), "Best signal — quality ", n.bestNow.bucket.quality.toFixed(2), " · n=", n.bestNow.bucket.n]
                }), e.jsxs("div", {
                    className: "text-[12px] text-foreground/90",
                    children: [n.bestNow.bucket.label, " on ", e.jsx("span", {
                        className: "font-semibold",
                        children: ve(n.bestNow.signal)
                    }), " ", "(", ye(n.bestNow.signal, n.bestNow.currentSignalValue), ")"]
                }), e.jsx("div", {
                    className: "text-[11px] text-muted-foreground leading-snug",
                    ...
                    children: n.bestNow.direction === "short_ratio" ? `Setup: short ${s} / long ${l} (sell the ratio)` : n.bestNow.direction === "long_ratio" ? `Setup: long ${s} / short ${l} (buy the ratio)` : "No actionable bias."
                })]
