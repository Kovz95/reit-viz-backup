...
const rt = ["#0ea5e9", "#a855f7", "#22c55e", "#f59e0b", "#ef4444", "#06b6d4", "#f97316", "#ec4899", "#14b8a6", "#8b5cf6", "#eab308", "#6366f1", "#84cc16", "#e11d48", "#0891b2", "#7c3aed", "#64748b", "#d946ef", "#fb923c", "#4ade80"];
...
const Jt = [{
    ...
    at = ["rgba(239, 68, 68, 0.7)", "rgba(34, 197, 94, 0.7)", "rgba(59, 130, 246, 0.7)", "rgba(168, 85, 247, 0.7)", "rgba(245, 158, 11, 0.7)", "rgba(6, 182, 212, 0.7)", "rgba(236, 72, 153, 0.7)", "rgba(132, 204, 22, 0.7)", "rgba(99, 102, 241, 0.7)", "rgba(249, 115, 22, 0.7)", "rgba(20, 184, 166, 0.7)", "rgba(139, 92, 246, 0.7)", "rgba(234, 179, 8, 0.7)", "rgba(225, 29, 72, 0.7)", "rgba(100, 116, 139, 0.7)"];
...
function Qt() {
    const {
        universeTickers: T
    } = Yt(), [g, R] = a.useState("P/FFO FY2"), [v, Y] = a.useState("Dividend Yield"), [m, k] = a.useState("none"), [_, A] = a.useState(""), [F, E] = a.useState(null), [N, ne] = a.useState(jt), [ie, ke] = a.useState(new Set), [w, Ve] = a.useState("subindustry"), [L, Ge] = a.useState("category"), [W, _e] = a.useState("Dividend Yield"), [Ne, We] = a.useState(""), oe = a.useRef(null), Te = a.useRef(null), [I, He] = a.useState(!0), [H, qe] = a.useState(!0), [re, Je] = a.useState(!1), [fe, Pe] = a.useState(""), [me, Ee] = a.useState(""), [U, Ue] = a.useState(!1), [Z, Ze] = a.useState(!1), [ae, Qe] = a.useState("none"), it = a.useCallback(() => ({
        metricX: g,
        metricY: v,
        metricZ: m,
        classFilters: St(N),
        ...
        e.metricX !== void 0 && R(e.metricX), e.metricY !== void 0 && Y(e.metricY), e.metricZ !== void 0 && k(e.metricZ), e.classFilters !== void 0 && ne(Ct(e.classFilters)), e.manualTickers !== void 0 && ke(new Set(e.manualTickers)), e.colorBy !== void 0 && Ve(e.colorBy), e.colorMode !== void 0 && Ge(e.colorMode), e.colorMetric !== void 0 && _e(e.colorMetric), e.showRegression !== void 0 && He(e.showRegression), e.showOutliers !== void 0 && qe(e.showOutliers), e.showQuadrants !== void 0 && Je(e.showQuadrants), e.refLineX !== void 0 && Pe(e.refLineX), e.refLineY !== void 0 && Ee(e.refLineY), e.logX !== void 0 && Ue(e.logX), e.logY !== void 0 && Ze(e.logY), e.regressionLevel !== void 0 && Qe(e.regressionLevel)
    }, []);
    kt("scatter", it, dt);
    ...
    a.useEffect(() => {
        ...
        t.fillStyle = "rgba(0,0,0,0)", t.fillRect(0, 0, l, u), t.strokeStyle = "rgba(255,255,255,0.06)", t.lineWidth = .5;
        const q = 6,
            de = 6,
            Re = S - X || 1,
            be = C - V || 1;
        for (let o = 0; o <= q; o++) {
            const d = X + Re * o / q,
                p = h(d);
            t.beginPath(), t.moveTo(p, c.top), t.lineTo(p, c.top + M), t.stroke(), t.fillStyle = "#7a8a9e", t.font = "10px 'JetBrains Mono', monospace", t.textAlign = "center";
        ...
        for (let o = 0; o <= de; o++) {
            const d = V + be * o / de,
                p = f(d);
            t.beginPath(), t.moveTo(c.left, p), t.lineTo(c.left + y, p), t.stroke(), t.fillStyle = "#7a8a9e", t.font = "10px 'JetBrains Mono', monospace", t.textAlign = "right";
            const b = Z ? Math.pow(10, d).toFixed(2) : d.toFixed(2);
            t.fillText(b + (he(v) ? "%" : ""), c.left - 6, p + 3)
        }
        if (t.fillStyle = "#94a3b8", t.font = "11px 'JetBrains Mono', monospace", t.textAlign = "center", t.fillText(g + (U ? " (log)" : ""), c.left + y / 2, u - 8), t.save(), t.translate(14, c.top + M / 2), t.rotate(-Math.PI / 2), t.textAlign = "center", t.fillText(v + (Z ? " (log)" : ""), 0, 0), t.restore(), t.strokeStyle = "rgba(255,255,255,0.1)", t.lineWidth = 1, t.strokeRect(c.left, c.top, y, M), t.save(), t.beginPath(), t.rect(c.left, c.top, y, M), t.clip(), re) {
            if (t.setLineDash([6, 4]), t.lineWidth = 1, ye !== null) {
                const o = h(ye);
                t.strokeStyle = "rgba(251, 191, 36, 0.5)", t.beginPath(), t.moveTo(o, c.top), t.lineTo(o, c.top + M), t.stroke()
            }
            if (Me !== null) {
                const o = f(Me);
                t.strokeStyle = "rgba(251, 191, 36, 0.5)", t.beginPath(), t.moveTo(c.left, o), t.lineTo(c.left + y, o), t.stroke()
            }
            if (ye !== null && Me !== null) {
                t.setLineDash([]), t.font = "bold 10px 'JetBrains Mono', monospace", t.fillStyle = "rgba(251, 191, 36, 0.35)";
                const o = h(ye),
                    d = f(Me);
                t.textAlign = "center", t.fillText("Low X · High Y", (c.left + o) / 2, (c.top + d) / 2), t.fillText("High X · High Y", (o + c.left + y) / 2, (c.top + d) / 2), t.fillText("Low X · Low Y", (c.left + o) / 2, (d + c.top + M) / 2), t.fillText("High X · Low Y", (o + c.left + y) / 2, (d + c.top + M) / 2)
            }
            t.setLineDash([])
        }
        if (I && $) {
            ...
            const b = X,
                ...
                P = o * b + d,
                O = o * D + d;
            t.beginPath(), t.moveTo(h(b), f(P)), t.lineTo(h(D), f(O)), t.stroke(), t.setLineDash([]), t.fillStyle = "rgba(239, 68, 68, 0.85)", t.font = "bold 10px 'JetBrains Mono', monospace", t.textAlign = "left";
            const G = `R²=${p.toFixed(3)}  β=${o.toFixed(3)}  α=${d.toFixed(2)}`;
            t.fillText(G, c.left + 6, c.top + 14), t.font = "9px 'JetBrains Mono', monospace", t.fillStyle = "rgba(239, 68, 68, 0.45)";
            const J = x.map(te => te.x),
                xe = (Math.min(...J) + Math.max(...J)) / 2,
                ue = o * xe + d;
            t.textAlign = "left", t.fillText("Above = expensive", c.left + 6, f(ue) - 8), t.fillText("Below = cheap", c.left + 6, f(ue) + 14)
        }
        if (I && Ae.length > 0) {
            let o = c.top + 14;
            Ae.forEach((d, p) => {
                ...
                const G = d.points.map(wt => wt.x),
                    ...
                    ue = D * J + P,
                    te = D * xe + P;
                t.beginPath(), t.moveTo(h(J), f(ue)), t.lineTo(h(xe), f(te)), t.stroke(), t.setLineDash([]), t.fillStyle = b, t.font = "bold 9px 'JetBrains Mono', monospace", t.textAlign = "left";
        ...
        for (const o of vt) {
            ...
            let O = 4;
            Q && o.z !== null && (O = 3 + (Q.max === Q.min ? .5 : (o.z - Q.min) / (Q.max - Q.min)) * 18), b && (O = Math.max(O, 7)), P && H && (O = Math.max(O, 6)), t.beginPath(), t.arc(d, p, O, 0, Math.PI * 2), Q ? (t.fillStyle = D + "88", t.fill(), t.strokeStyle = D, t.lineWidth = 1.5, t.stroke()) : (t.fillStyle = b ? D : D + "cc", t.fill()), P && H && (t.strokeStyle = nt(o.ticker) ? "#ef4444" : "#22c55e", t.lineWidth = 2, t.beginPath(), t.arc(d, p, O + 3, 0, Math.PI * 2), t.stroke()), b && (t.strokeStyle = "#fff", t.lineWidth = 2, t.stroke()), (b || P && H || !P) && (t.fillStyle = b || P ? "#fff" : "rgba(255,255,255,0.7)", t.font = b || P ? "bold 11px 'JetBrains Mono', monospace" : "10px 'JetBrains Mono', monospace", t.textAlign = "center", t.fillText(o.ticker, d, p - O - 4))
        }
        if (t.restore(), F) {
            ...
            if (o) {
                ...
                const J = t.measureText(G).width,
                    ...
                    ue = p - (Q ? 26 : 22);
                t.fillStyle = "rgba(0,0,0,0.85)", t.fillRect(xe - 4, ue - 12, J + 8, 16), t.fillStyle = "#fff", t.textAlign = "left", t.fillText(G, xe, ue)
            }
        }
        if (B && B.type === "select") {
            ...
            t.strokeStyle = "rgba(14, 165, 233, 0.8)", t.lineWidth = 1.5, t.setLineDash([4, 3]), t.strokeRect(o, d, p, b), t.setLineDash([]), t.fillStyle = "rgba(14, 165, 233, 0.1)", t.fillRect(o, d, p, b)
        }
        z && (t.fillStyle = "rgba(14, 165, 233, 0.7)", t.font = "bold 9px 'JetBrains Mono', monospace", t.textAlign = "right", t.fillText("ZOOMED — scroll to zoom, drag to select, dbl-click to reset", l - c.right, c.top - 6))
    ...
    const ut = a.useCallback(e => {
        ...
        ft = a.useCallback(e => {
            ...
            const {
                fromCanvasX: f,
                fromCanvasY: y
            } = ee(l, u), M = f(Math.min(n.startX, n.currentX)), X = f(Math.max(n.startX, n.currentX)), S = y(Math.max(n.startY, n.currentY)), V = y(Math.min(n.startY, n.currentY));
    ...
    const bt = () => {
        const e = L === "metric" ? "," + W : "",
            ...
            r = x.map(h => {
                let f = `${h.ticker},"${h.name}","${h.subindustry}",${h.x},${h.y}${m!=="none"?","+(h.z??""):""}`;
...
`),
        ...
        t.href = u, t.download = `scatter_${g}_vs_${v}.csv`.replace(/[^a-zA-Z0-9._-]/g, "_"), t.click(), URL.revokeObjectURL(u)
    };
    return s.jsxs("div", {
        ...
        children: [s.jsxs("div", {
            ...
            children: [xt ? s.jsx("div", {
                ...
                style: {
                    cursor: j.current ? j.current.type === "pan" ? "grabbing" : "crosshair" : F ? "pointer" : "crosshair"
                },
                onMouseDown: ut,
                onMouseMove: ht,
                onMouseUp: ft,
