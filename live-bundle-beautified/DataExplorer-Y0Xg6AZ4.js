...
function Pe() {
    const [p, X] = n.useState([]), [d, S] = n.useState("ESS"), [y, D] = n.useState(""), [C, J] = n.useState([]), [k, K] = n.useState({}), [Q, L] = n.useState(!1), [b, E] = n.useState(!1), [u, R] = n.useState(new Set(["close"])), [N, V] = n.useState(""), [Z, ee] = n.useState(!1), [x, M] = n.useState(null), O = n.useRef(null), w = 20, I = 12, [H, te] = n.useState(0), [se, re] = n.useState(600), P = n.useRef(null);
    n.useEffect(() => {
        const e = O.current;
        if (!e) return;
    ...
    const ae = n.useCallback(() => {
        ...
        le = n.useCallback(e => {
            e.activeTicker && S(e.activeTicker), typeof e.sortAsc == "boolean" && E(e.sortAsc), Array.isArray(e.pinnedMetrics) && R(new Set(e.pinnedMetrics)), e.visibleMetrics === null ? M(null) : Array.isArray(e.visibleMetrics) && M(new Set(e.visibleMetrics))
        }, []);
    ...
    const j = p.findIndex(e => e.ticker === d),
        oe = n.useMemo(() => {
            ...
            return p.filter(a => a.ticker.toLowerCase().includes(e) || a.name.toLowerCase().includes(e) || a.subindustry?.toLowerCase().includes(e))
        }, [p, y]),
        ...
        z = n.useMemo(() => {
            const e = {
                    ...
                    Performance: ["52wk High", "52wk Low", "% off 52wk High", "% off 52wk Low", "1Y Price Chg%", "6M Price Chg%", "3M Price Chg%", "1M Price Chg%"],
                    "Short Interest": ["Short Interest%", "SI Δ 1W", "SI Δ 1M", "SI Δ 3M", "SI Δ 6M"],
                    Volatility: ["HV 30D", "HV 60D", "HV 90D", "HV 180D", "HVOL 30D", "HVOL 60D", "HVOL 90D", "HVOL 180D"],
                    Other: ["Dividend", "Enterprise Value", "Buy Ratings", "Hold Ratings", "Sell Ratings", "Bull%", "Bear%"]
                },
                a = new Set,
                r = [],
                            ...
                            children: [t.jsx("th", {
                                ...
                                children: t.jsxs("div", {
                                    ...
                                    children: [t.jsx("button", {
                                        ...
                                        onClick: () => he(o),
                                        title: u.has(o) ? "Unpin" : "Pin to left",
