...
function fr() {
    const [u, p] = r.useState([]), [a, S] = r.useState(""), [y, c] = r.useState(null), [x, l] = r.useState(!1), [s, i] = r.useState("single"), [o, j] = r.useState(""), [m, I] = r.useState(""), [g, f] = r.useState([]), [B, K] = r.useState("stocks"), {
        baskets: z
    } = fs(), [H, ot] = r.useState("rsi_threshold"), [U, nt] = r.useState("deep"), [Wt, Me] = r.useState("10y"), [_, _e] = r.useState(() => bs()), [te, at] = r.useState(!0), [he, lt] = r.useState(1), [se, it] = r.useState(80), [Y, ct] = r.useState("threshold"), [Z, Ee] = r.useState(.05), [ge, dt] = r.useState(.03), [fe, ut] = r.useState(.07), [Q, Fe] = r.useState(1), [q, J] = r.useState(!1), {
        frequency: re,
        setFrequency: Oe,
        frequencyUI: Vt
        ...
        current: 0,
        total: 0
    }), [Ne, ve] = r.useState(null), [we, ke] = Xe("harsi-input-selection", Ms), [X, Ce] = Xe("harsi:results", []), [Yt, Pe] = r.useState(new Map), [He, mt] = r.useState(null), [Zt, pt] = r.useState(new Set), Qt = r.useCallback(e => {
        pt(h => {
            const k = new Set(h);
        ...
        col: "score",
        dir: "desc"
    }), [ze, Xt] = r.useState("composite"), gt = r.useMemo(() => ks(ze), [ze]), [Re, ft] = r.useState("optimize"), [P, bt] = r.useState("long"), [Le, kt] = Xe("harsi:evalResult", null), [Te, yt] = r.useState(null), [Ue, oe] = r.useState(!1), [A, es] = r.useState("rsi_threshold"), [ie, ts] = r.useState(14), [ne, ss] = r.useState(14), [ae, rs] = r.useState(14), [ce, os] = r.useState(3), [de, ns] = r.useState(3), [G, as] = r.useState(20), [W, ls] = r.useState(-20), [ye, is] = r.useState(0), [je, cs] = r.useState(1), [Se, ds] = r.useState(5), Ie = r.useRef(!1), jt = r.useRef(!1), ue = r.useRef(null), {
        universeTickers: qe
    } = ys(), R = r.useMemo(() => qe ? u.filter(e => qe.has(e.ticker)) : u, [u, qe]), Be = Hs(R, s === "universe", "harsi-clf"), xe = Ks(R.map(e => e.ticker), s === "pairCombo", "harsi-pc"), St = Be.filteredTickers;
    r.useEffect(() => {
        js().then(e => {
            p(e), e.length > 0 && !jt.current && S(e[0].ticker), e.length > 0 && (j(h => h || e[0].ticker), I(h => h || (e[1]?.ticker ?? e[0].ticker)))
        })
    }, []), r.useEffect(() => {
    ...
    const us = async () => {
        ...
        const N = await Bt(),
            E = e.map(async n => {
                if (!Ie.current) try {
                    ...
                    } else b = s === "pair" ? await rt(o, m, N, _) : s === "pairCombo" ? await rt(n.pairA, n.pairB, N, _) : await Ae(n.ticker, le, N, _);
                    ...
                    if (s === "single" || s === "pair") {
                        ...
                        await new Promise((v, O) => {
                            const T = w => {
                                ...
                                }) : D.type === "result" ? (D.result && (C.push(D.result), L.set(D.result.ticker, F)), d.removeEventListener("message", T), d.terminate(), v()) : D.type === "error" && (d.removeEventListener("message", T), d.terminate(), O(new Error(D.error)))
                            };
        ...
        await Promise.all(E), Ce([...C]), Pe(new Map(L)), k?.terminate(), ue.current = null, ve(null), J(!1)
    ...
    }, [s, le, a, o, m, R, A, ie, je, ne, ae, ce, de, G, W, ye, Se, te, se, Z, Q, P, _, g, B, z]), vt = r.useMemo(() => {
        const e = pe[A];
        return A === "rsi_threshold" ? `HARSI ${e} RSI(${ne}) OB${G}/OS${W} [${P}]` : A === "stoch_kd_cross" ? `HARSI ${e} Stoch(${ae},${ce},${de}) OB${G}/OS${W} [${P}]` : A === "ha_flip" ? `HARSI ${e} len=${ie} sm=${je} conf=${ye} [${P}]` : `HARSI ${e} RSI(${ne}) Stoch(${ae},${ce},${de}) lb=${Se} OB${G}/OS${W} [${P}]`
    }, [A, ie, je, ne, ae, ce, de, G, W, ye, Se, P]), wt = r.useMemo(() => s === "pair" ? `${o||"A"}/${m||"B"}` : s === "single" ? a || "—" : R[0]?.ticker || "—", [s, o, m, a, R]), Ge = r.useCallback(() => ({
        selectedTicker: a,
        pairTickerA: o,
        pairTickerB: m,
        basketTickers: g,
        ...
        inputSelection: we
    }), [a, o, m, g, B, s, re, H, U, te, he, se, Y, Z, ge, fe, Q, X, He, ee, we]), We = r.useCallback(e => {
        if (e && (e.selectedTicker && (S(e.selectedTicker), jt.current = !0), (e.mode === "single" || e.mode === "universe" || e.mode === "pair" || e.mode === "pairCombo" || e.mode === "basket") && i(e.mode), e.pairCombo && xe.hydrate(e.pairCombo), e.pairTickerA && j(e.pairTickerA), e.pairTickerB && I(e.pairTickerB), Array.isArray(e.basketTickers) && f(e.basketTickers.filter(h => typeof h == "string")), (e.basketMode === "stocks" || e.basketMode === "combined") && K(e.basketMode), e.frequency === "daily" || e.frequency === "weekly" || e.frequency === "weekly_on_daily" ? Oe(e.frequency) : (e.timeframe === "weekly" && e.frequency === void 0 || e.barInterval === "weekly" && e.frequency === void 0) && Oe("weekly"), st.includes(e.signalKind) && ot(e.signalKind), Ht.includes(e.gridSize) && nt(e.gridSize), typeof e.rsiSmoothed == "boolean" && at(e.rsiSmoothed), typeof e.candleSmoothing == "number" && lt(e.candleSmoothing), typeof e.stochFit == "number" && it(e.stochFit), (e.returnMode === "threshold" || e.returnMode === "band") && ct(e.returnMode), typeof e.targetReturn == "number" && Ee(e.targetReturn), typeof e.bandMin == "number" && dt(e.bandMin), typeof e.bandMax == "number" && ut(e.bandMax), typeof e.minHold == "number" && Fe(e.minHold), Array.isArray(e.results) && Ce(e.results), e.expandedTicker !== void 0 && mt(e.expandedTicker), e.runSort && e.runSort.col && e.runSort.dir && ht(e.runSort), e.inputSelection && typeof e.inputSelection == "object")) {
    ...
    const Ct = r.useCallback(() => {
        ...
        Ye = r.useMemo(() => {
            const e = Ke.trim().toLowerCase(),
                h = e ? Ve.filter(C => C.tr.ticker.toLowerCase().includes(e) || C.tr.name && C.tr.name.toLowerCase().includes(e)) : [...Ve],
                {
                    col: k,
                    dir: M
                } = ee;
            return h.sort((C, L) => {
                ...
                let E = 0;
                return k === "ticker" ? E = C.tr.ticker.localeCompare(L.tr.ticker) : k === "currentSignal" ? E = C.tr.currentSignal.localeCompare(L.tr.currentSignal) : E = $ - N, M === "asc" ? E : -E
            }), h
        }, [Ve, ee, Ke]),
        Ze = e => ht(h => h.col === e ? {
            col: e,
        ...
        hs = () => {
            const e = Mt,
                h = ["ticker", "name", "side", "currentSignal", "currentRsi", "currentStochK", "currentStochD", "currentHaClose", "kind", "bestConfig", "score", "signals"];
            ...
            for (const N of Ye)
                for (const E of ["long", "short"]) {
                    ...
                    if (!n) continue;
                    const b = [N.tr.ticker, N.tr.name ?? "", E, N.tr.currentSignal, N.tr.currentRsi, N.tr.currentStochK, N.tr.currentStochD, N.tr.currentHaClose, n.cfg.kind, n.cfg.configLabel, n.score, n.summary.count];
                    for (const d of e) {
                        const v = Y === "band" ? n.summary.bandHitRate?.[d.label] ?? n.summary.hitRate[d.label] : n.summary.hitRate[d.label];
                        b.push((v * 100).toFixed(1) + "%", (n.summary.avgReturn[d.label] * 100).toFixed(2) + "%", n.summary.profitFactor[d.label].toFixed(2))
                    }
                    const F = b.map(d => {
                        if (d == null) return "";
                        const v = String(d);
...
`),
            ...
            $.href = L, $.download = `harsi-opt-${H}-${U}-${Date.now()}.csv`, document.body.appendChild($), $.click(), document.body.removeChild($), URL.revokeObjectURL(L)
        },
        Qe = Mt,
        gs = Y === "band";
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsx("h2", {
                ...
                children: Re === "optimize" ? "Search parameter space by hit rate" : "Score one specific setup"
            }), t.jsxs("div", {
            ...
            children: [t.jsx("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("div", {
                            ...
                            children: [t.jsx("label", {
                                ...
                                max: 50,
                                value: G,
                                onChange: e => as(parseInt(e.target.value) || 20),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        }), t.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [t.jsx("label", {
                                ...
                                max: -1,
                                value: W,
                                onChange: e => ls(parseInt(e.target.value) || -20),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        })]
                    }), (A === "stoch_kd_cross" || A === "composite") && t.jsxs(t.Fragment, {
                        children: [t.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [t.jsx("label", {
                                className: "text-[9px] font-mono text-muted-foreground uppercase tracking-wider",
                                ...
                                max: 50,
                                value: ae,
                                onChange: e => rs(parseInt(e.target.value) || 14),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        }), t.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [t.jsx("label", {
                                ...
                                max: 20,
                                value: ce,
                                onChange: e => os(parseInt(e.target.value) || 3),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        }), t.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [t.jsx("label", {
                                ...
                                max: 20,
                                value: de,
                                onChange: e => ns(parseInt(e.target.value) || 3),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        })]
                    }), A === "ha_flip" && t.jsxs(t.Fragment, {
                        children: [t.jsxs("div", {
                            ...
                            children: [t.jsx("label", {
                                ...
                                max: 20,
                                value: je,
                                onChange: e => cs(parseInt(e.target.value) || 1),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        }), t.jsxs("div", {
                            className: "flex flex-col gap-0.5",
                            children: [t.jsx("label", {
                                ...
                                max: 10,
                                value: ye,
                                onChange: e => is(parseInt(e.target.value) || 0),
                                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
                            })]
                        })]
                        ...
                        children: [t.jsx("label", {
                            ...
                            onChange: e => Ee((parseFloat(e.target.value) || 5) / 100),
                ...
                children: [t.jsx(Fs, {
                    ...
                    ticker: Te.mode === "pair" ? Te.pairLegA || "" : a || R[0]?.ticker || "",
                    priceContext: Te,
                    signals: Le.profiles,
                ...
                children: [t.jsxs("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsx("span", {
                            ...
                            onChange: e => {
                                const h = e.target.value,
                                    k = At.find(M => `${M.band.minReturn}-${M.band.maxReturn}` === h);
                        ...
                        children: [t.jsx("span", {
                            ...
                            max: 60,
                            value: Q,
                            onChange: e => Fe(Math.max(0, Math.min(60, parseInt(e.target.value) || 0))),
                        ...
                        children: [t.jsx("span", {
                            ...
                            step: 1,
                            value: se,
                            onChange: e => it(Math.max(5, Math.min(200, parseInt(e.target.value) || 80))),
                        ...
                        children: [t.jsx("span", {
                            ...
                            step: 1,
                            value: he,
                            onChange: e => lt(Math.max(1, Math.min(20, parseInt(e.target.value) || 1))),
                            className: "h-7 w-12 rounded-md bg-card border border-border px-1.5 text-xs"
                        })]
                    }), t.jsxs("div", {
                        className: "ml-auto flex items-center gap-2",
                        children: [q ? t.jsx(De, {
                            ...
                            onClick: xs,
                            size: "sm",
                            disabled: s === "single" ? !a : s === "pair" ? !o || !m || o === m : R.length === 0,
                            className: "h-7 px-3 text-xs",
                    ...
                    children: [t.jsxs("span", {
                        ...
                        className: "text-muted-foreground",
                        children: [Ne.ticker, ": ", Ne.done.toLocaleString(), "/", Ne.total.toLocaleString(), " configs"]
                    }), t.jsx("div", {
                    ...
                    children: X.length === 0 ? t.jsx("div", {
                        ...
                        children: q ? "Running optimizer…" : `Configure parameters and click Run Optimizer. Estimated ${Nt.toLocaleString()} combos for ${pe[H]} (${U}).`
                    }) : t.jsxs("table", {
                        ...
                        children: [t.jsx("thead", {
                            ...
                            children: t.jsxs("tr", {
                                children: [t.jsxs("th", {
                                    ...
                                    onClick: () => Ze("ticker"),
                                    children: ["Ticker ", ee.col === "ticker" && (ee.dir === "asc" ? "▲" : "▼")]
                                }), t.jsx("th", {
                                    ...
                                    onClick: () => Ze("score"),
                                    children: ["Score ", ee.col === "score" && (ee.dir === "asc" ? "▲" : "▼")]
                                }), t.jsx("th", {
                            ...
                            children: Ye.map(e => {
                                const h = e.longBest && e.shortBest ? e.longBest.score >= e.shortBest.score ? {
                                    side: "Long",
                                    ...e.longBest
                                } : {
                                    side: "Short",
    ...
    return t.jsxs(t.Fragment, {
        children: [t.jsxs("tr", {
            ...
            children: [t.jsx("td", {
                ...
                children: t.jsx("span", {
                    className: i.currentSignal.startsWith("→ Buy") ? "text-emerald-400 font-semibold" : i.currentSignal.startsWith("→ Sell") ? "text-rose-400 font-semibold" : "text-muted-foreground",
                ...
                const j = c ? p.summary.bandHitRate?.[o.label] ?? p.summary.hitRate[o.label] : p.summary.hitRate[o.label];
                return t.jsxs("td", {
...
function Xs({
    ...
    const x = r.useMemo(() => [...u.configs].sort((l, s) => s.bestScore - l.bestScore).slice(0, 8), [u.configs]);
    return t.jsxs("div", {
        className: "space-y-2",
        children: [t.jsxs("div", {
            ...
            children: [t.jsx("thead", {
                ...
                children: x.map(l => {
                    for (const g of l.categories) g.summary.count !== 0 && p.reduce((f, B) => f + (g.summary.avgReturn[B.label] ?? 0), 0) / p.length;
                    const s = l.categories.reduce((g, f) => g.composite.score > f.composite.score ? g : f),
                        i = s.summary,
                    ...
                    return t.jsxs(Ds.Fragment, {
                        children: [t.jsxs("tr", {
                            ...
                            children: [t.jsx("td", {
                                ...
                                const f = a ? i.bandHitRate?.[g.label] ?? i.hitRate[g.label] : i.hitRate[g.label];
                                return t.jsxs("td", {
                            ...
                            children: t.jsx("td", {
                                ...
                                className: "px-2 py-2",
                                children: t.jsx(Gt, {
                                    ticker: S.mode === "pair" && S.pairLegA || u.ticker,
                                    priceContext: S,
                                    signals: s.profiles,
