...
function Be({
    ...
    const [a, c] = d.useState(30), [u, b] = d.useState(!1), [p, T] = d.useState("all"), y = d.useMemo(() => {
        ...
        return s.sort((i, l) => i.isActive && !l.isActive ? -1 : !i.isActive && l.isActive ? 1 : i.daysUntilStart - l.daysUntilStart), p !== "all" ? s.filter(i => i.direction === p) : s
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx("div", {
                    ...
                    children: ["all", "bullish", "bearish"].map(s => e.jsx("button", {
                        ...
                        onClick: () => T(s),
                        children: s === "all" ? "All" : s === "bullish" ? "Bullish" : "Bearish"
                    }, s))
                }), e.jsxs("span", {
                    ...
                    children: [e.jsx("thead", {
                        ...
                        children: N.map((s, i) => e.jsxs("tr", {
                            ...
                            children: [e.jsx("td", {
                                ...
                                className: "px-2 py-1",
                                children: s.direction === "bullish" ? e.jsx(ve, {
                                ...
                                children: [e.jsx("span", {
                                    className: s.direction === "bullish" ? "text-emerald-400 font-medium" : "text-red-400 font-medium",
                                ...
                                children: s.isActive ? e.jsxs("span", {
                                    ...
                                    children: ["Ended ", Math.abs(s.daysUntilEnd), "d ago"]
                                }) : e.jsxs("span", {
                                ...
                                children: e.jsxs("span", {
                                    ...
                                    children: [s.window.avgReturn > 0 ? "+" : "", s.window.avgReturn.toFixed(2), "%"]
                                })
                            }), e.jsxs("td", {
...
function ze() {
    const {
        universeTickers: o
    } = we(), [a, c] = d.useState("periods"), [u, b] = d.useState(Se), [p, T] = d.useState(""), [y, N] = d.useState(new Set), [f, E] = d.useState(""), [s, i] = d.useState(""), [l, j] = d.useState("12M"), [k, A] = d.useState(!1), [v, z] = d.useState("earnings"), [D, se] = d.useState("avg"), [P, ae] = d.useState(30), [_, ne] = d.useState(180), de = d.useCallback(() => ({
        viewMode: a,
        filters: ke(u),
        manualTickers: [...y],
        customStart: f,
        ...
        t.viewMode !== void 0 && c(t.viewMode), t.filters !== void 0 && b(Ce(t.filters)), t.manualTickers !== void 0 && N(new Set(t.manualTickers)), t.customStart !== void 0 && E(t.customStart), t.customEnd !== void 0 && i(t.customEnd), t.sortKey !== void 0 && j(t.sortKey), t.sortAsc !== void 0 && A(t.sortAsc), t.eventType !== void 0 && z(t.eventType), t.eventStat !== void 0 && se(t.eventStat), t.seasonalMinDays !== void 0 && ae(t.seasonalMinDays), t.seasonalMaxDays !== void 0 && ne(t.seasonalMaxDays)
    }, []);
    ...
    const {
    ...
    }), J = a === "periods" || a === "seasonality" ? xe : a === "monthly" ? ce : a === "seasonal-patterns" ? ue : me, F = d.useMemo(() => {
        let t = [];
        return a === "periods" || a === "seasonality" ? t = H || [] : a === "monthly" ? t = Q || [] : a === "seasonal-patterns" ? t = G || [] : t = q || [], o && (t = t.filter(n => o.has(n.ticker))), [...Fe(t, u, p, y)].sort((n, C) => {
            let x, r;
            if (a === "events" && l.startsWith("w_")) {
                const m = parseInt(l.replace("w_", ""));
                x = n[D]?.[m] ?? null, r = C[D]?.[m] ?? null
            } else x = n[l], r = C[l];
            return x === null && r === null ? 0 : x === null ? 1 : r === null ? -1 : typeof x == "string" ? k ? x.localeCompare(r) : r.localeCompare(x) : k ? x - r : r - x
        })
        ...
        if (!F.length) return;
        let t, S;
        if (a === "periods") t = ["ticker", "name", "lastClose", ...ee, ...f && s ? ["custom"] : []], S = t.map(m => m === "lastClose" ? "Last Close" : m === "custom" ? `Custom (${f} to ${s})` : m);
        else if (a === "seasonality") t = ["ticker", "name", "lastClose", ...te], S = t.map(m => m === "lastClose" ? "Last Close" : `Avg ${m}`);
            ...
            for (const be of F) {
                const R = be;
                for (const h of R.bullish) g.push([R.ticker, `"${R.name}"`, R.yearsOfData, "Bullish", h.startLabel, h.endLabel, h.calendarDays ?? "", h.avgReturn.toFixed(4), h.medianReturn.toFixed(4), h.winRate.toFixed(1), h.years, h.tStat.toFixed(2)].join(","));
                for (const h of R.bearish) g.push([R.ticker, `"${R.name}"`, R.yearsOfData, "Bearish", h.startLabel, h.endLabel, h.calendarDays ?? "", h.avgReturn.toFixed(4), h.medianReturn.toFixed(4), h.winRate.toFixed(1), h.years, h.tStat.toFixed(2)].join(","))
            }
...
`)], {
            ...
            X.href = L, X.download = `seasonal_patterns_${new Date().toISOString().slice(0,10)}.csv`, X.click(), URL.revokeObjectURL(L);
            return
        } else {
            const m = Y(v) ? [...I, ...W] : [...W];
            t = ["ticker", "name", "eventCount", ...m.map(g => `${B[g]} Avg`), ...m.map(g => `${B[g]} WinRate`)], S = t
        }
        const n = [S.join(",")];
        for (const m of F)
            if (a === "events") {
                const g = m,
                    M = Y(v) ? [...I, ...W] : [...W];
                n.push([g.ticker, `"${g.name}"`, g.eventCount, ...M.map(L => g.avg[L]?.toFixed(4) ?? ""), ...M.map(L => g.winRate[L]?.toFixed(1) ?? "")].join(","))
            } else n.push(t.map(g => {
                const M = m[g];
                return M == null ? "" : typeof M == "number" ? M.toFixed(4) : `"${String(M).replace(/"/g,'""')}"`
            }).join(","));
...
`)], {
        ...
        r.href = x, r.download = `performance_${a}_${new Date().toISOString().slice(0,10)}.csv`, r.click(), URL.revokeObjectURL(x)
    }, [F, a, f, s, v]), fe = ({
        col: t
    }) => l !== t ? e.jsx(Oe, {
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx("div", {
                    ...
                    children: ge.map(t => e.jsx("button", {
                        ...
                        onClick: () => {
                            c(t.key), j(t.key === "monthly" ? "Jan" : t.key === "events" ? "w_21" : t.key === "seasonality" ? "Q1" : t.key === "seasonal-patterns" ? "ticker" : "12M")
                        },
                    ...
                    children: [e.jsx("span", {
                        ...
                        max: 365,
                        value: P,
                        onChange: t => ae(Math.max(5, parseInt(t.target.value) || 5)),
                        ...
                        max: 365,
                        value: _,
                        onChange: t => ne(Math.max(5, parseInt(t.target.value) || 180)),
                        className: "h-6 w-16 text-[11px] text-center",
                    ...
                    children: [e.jsx("div", {
                        ...
                        className: "flex items-center bg-muted rounded p-0.5",
                        children: ["avg", "median", "winRate"].map(t => e.jsx("button", {
                            ...
                            children: t === "avg" ? "Avg Return" : t === "median" ? "Median" : "Win Rate"
                        }, t))
                    })]
                }), e.jsx("div", {
                    className: "ml-auto",
                ...
                totalCount: (a === "periods" || a === "seasonality" ? H : a === "monthly" ? Q : a === "seasonal-patterns" ? G : q)?.length ?? 0,
                testIdPrefix: "perf"
            })]
        }), e.jsx("div", {
            ...
            children: J ? e.jsx("div", {
                ...
                children: a === "seasonal-patterns" ? "Detecting seasonal patterns (this may take a moment)..." : "Loading..."
            }) : a === "seasonal-patterns" ? e.jsxs(e.Fragment, {
                children: [e.jsx(Be, {
                    data: F
                }), "/* ── Seasonal Patterns View ─────────────────────── */", e.jsxs("table", {
                    className: "w-full text-xs",
                    ...
                    children: [e.jsxs("thead", {
                        ...
                        children: [F.map((t, S) => {
                            ...
                            return Array.from({
                                ...
                                "data-testid": r === 0 ? `perf-row-${n.ticker}` : void 0,
                                children: [r === 0 ? e.jsxs(e.Fragment, {
                                    ...
                                    children: [e.jsxs("td", {
                                        ...
                                        children: [e.jsx("span", {
                                            ...
                                            children: n.bearish[r].startLabel
                                        }), e.jsx("span", {
                                            className: "text-muted-foreground mx-0.5",
                                            children: "→"
                                        }), e.jsx("span", {
                                            className: "text-red-400 font-medium",
                                            children: n.bearish[r].endLabel
                                        })]
                                    }), e.jsx("td", {
                                        className: "px-1.5 py-1 text-right font-mono text-xs tabular-nums text-muted-foreground",
                                        children: n.bearish[r].calendarDays ?? "—"
                                    }), e.jsx("td", {
                                        className: "px-1.5 py-1 text-right",
                                        children: e.jsx($, {
                                            value: n.bearish[r].avgReturn
                                        })
                                    }), e.jsx("td", {
                                        className: "px-1.5 py-1 text-right",
                                        children: e.jsx($, {
                                            value: n.bearish[r].medianReturn
                                        })
                                    }), e.jsxs("td", {
                                        className: "px-1.5 py-1 text-right font-mono text-xs tabular-nums text-foreground",
                                        children: [n.bearish[r].winRate.toFixed(0), "%"]
                                    }), e.jsx("td", {
                                        className: "px-1.5 py-1 text-right font-mono text-xs tabular-nums text-muted-foreground",
                                        children: n.bearish[r].years
                                    }), e.jsx("td", {
                                        className: "px-1.5 py-1 text-right font-mono text-xs tabular-nums text-muted-foreground",
                                        children: n.bearish[r].tStat.toFixed(2)
                                    })]
                                }) : e.jsx(e.Fragment, {
                                    children: e.jsx("td", {
                                        colSpan: 7
                    ...
                    children: [F.map((t, S) => e.jsxs("tr", {
                        ...
                        children: [e.jsx("td", {
                            ...
                            children: [e.jsx("td", {
                                ...
                                children: t.lastClose !== null ? `$${t.lastClose.toFixed(2)}` : "-"
                            }), ee.map(n => e.jsx("td", {
