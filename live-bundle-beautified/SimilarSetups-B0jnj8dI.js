...
const Tt = ["Trend", "MA Distance", "MA Spread", "Momentum", "Oscillator", "Volatility", "Range / Channel", "Distribution", "Volume", "Cross-Sectional", "App-Specific", "Time"];
...
function Kt() {
    ...
    })(), [p, F] = x.useState(v), [l, g] = x.useState(""), [f, b] = x.useState(() => Nt()), [d, s] = x.useState(""), [N, j] = x.useState(() => new Set), [Y, R] = x.useState("workbook"), {
        metas: y
    } = yt(), [L, a] = x.useState(""), [w, D] = x.useState(""), re = x.useMemo(() => o.map(t => t.ticker), [o]), H = vt(re, n === "pairCombo", "ss-pc");
    x.useEffect(() => {
    ...
    const [ne, ie] = x.useState(20), [c, U] = x.useState(252), [X, le] = x.useState(0), [q, Z] = x.useState(() => new Set(Ze)), [I, rt] = x.useState("knn"), [me, nt] = x.useState(60), [ue, ot] = x.useState(0), [he, at] = x.useState(5), [J, it] = x.useState(!1), [xe, Ye] = x.useState(() => new Set(Object.keys(oe).filter(t => t !== "Classic (6)"))), [G, Ae] = x.useState(!1), [Pe, pe] = x.useState(null), [Re, Oe] = x.useState(!1), [Ee, Ie] = x.useState({
        done: 0,
        total: 0
        ...
        cancelled: !1,
        runToken: 0
    }))[0], W = x.useMemo(() => n !== "industry" ? [] : f.economy.size + f.sector.size + f.subsector.size + f.industryGroup.size + f.industry.size + f.subindustry.size + N.size + (d.trim().length > 0 ? 1 : 0) === 0 ? [] : Mt(Y === "global" ? y : o, f, d, N).map(S => S.ticker), [n, o, y, Y, f, d, N]), De = x.useMemo(() => {
        ...
        return d.trim() && t.push(`q="${d.trim()}"`), N.size > 0 && t.push(`+${N.size} manual`), t.length > 0 ? t.join(" · ") : "All filtered"
    }, [n, f, d, N]), Q = x.useMemo(() => {
        ...
        if (n === "basket") {
            const t = l ? Ge(l) : null;
            return t ? (i.find(u => u.id === t)?.tickers ?? []).filter(u => u && !u.startsWith("BASKET:")).map(u => ({
                kind: "single",
                ticker: u
            })) : []
        }
    ...
    const [B, de] = x.useState(null), [ge, Ue] = x.useState(!1), [Be, Ve] = x.useState(null), we = x.useMemo(() => {
    ...
    const ke = !!B?.hasVolume,
        ...
        mt = async () => {
            ...
            const t = Q;
            if (t.length === 0) {
                ze(n === "pairCombo" ? "No pairs in the leg set. Add tickers to the leg set first." : "No constituent tickers to run."), pe(null);
                return
            }
            te.cancelled = !1;
            const r = ++te.runToken;
            ...
            const u = {
                ...
                }, C = $ => $.kind === "single" ? $.ticker : `${$.a}/${$.b}`, O = [], V = 8, E = () => te.runToken !== r;
    ...
    const ut = x.useMemo(() => {
        ...
        be = x.useMemo(() => {
            ...
            if (E !== "mixed") {
                ...
                V >= .8 && (K >= 1 || !Number.isFinite(K)) ? $ = `Strong ${M}` : V >= .66 ? $ = `Moderate ${M}` : V >= .55 ? $ = `Weak ${M}` : $ = `Mixed — ${M} leaning`
            }
            return {
                rows: t,
                valid: r,
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsx(jt, {
                ...
                children: [P.matches.length, "/", P.total, " bars matched · feature dim ", P.enabledList.length, " · ", P.algoInfo]
            }), J && be && e.jsxs("span", {
                className: "text-[10px] font-mono text-amber-300/80",
                children: ["consensus · ", be.valid.length, "/", be.rows.length, " valid presets · ", Se[I].label]
            }), B && e.jsxs("span", {
                className: "text-[10px] font-mono text-muted-foreground/60",
                children: [ke ? "OHLCV" : B.hasOHLC ? "OHLC" : "close-only", ye ? " · SPY benchmark loaded" : " · no benchmark"]
            })]
        }), e.jsxs("div", {
            ...
            children: [e.jsx("span", {
                ...
                children: ["single", "basket", "industry", "pair", "pairCombo"].map(t => e.jsx("button", {
                    onClick: () => h(t),
                ...
                children: [e.jsx(kt, {
                    ...
                    children: [e.jsx("span", {
                        className: "text-[10px] font-mono text-muted-foreground",
                        children: W.length === 0 ? "Pick at least one filter value" : `${W.length} tickers · equal-weight composite · ${De}`
                ...
                children: [e.jsx("label", {
                    ...
                    onClick: () => {
                        Ae(t => {
                            const r = !t;
                            return r || (te.cancelled = !0, Oe(!1), pe(null), ze(null)), r
                        })
                    },
                    ...
                    title: n === "pairCombo" ? "Run algorithm on each pair in the leg set" : "Run algorithm on each constituent ticker",
                    children: Re ? `Running… ${Ee.done}/${Ee.total}` : n === "pairCombo" ? `Run on ${Q.length} pair${Q.length===1?"":"s"}` : `Run on ${Q.length} ticker${Q.length===1?"":"s"}`
                    ...
                    children: [e.jsx("label", {
                        ...
                        children: [20, 30, 40, 60, 90, 120, 180, 252].map(t => e.jsxs("option", {
                            value: t,
                            children: [t, "b"]
                        }, t))
                    })]
                    ...
                    children: [e.jsx("label", {
                        ...
                        children: [2, 3, 4, 5, 6, 8, 10, 12].map(t => e.jsx("option", {
                            value: t,
                            children: t
                        }, t))
                    })]
                    ...
                    title: I === "kernel" ? "N controls how many neighbors appear in the matched-dates table; weighted summary uses up to 3N" : "Number of nearest neighbors",
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx("span", {
                    ...
                    className: "text-[10px] font-mono text-muted-foreground/70 ml-2",
                    children: [q.size, "/", Le.length + Object.keys(ae).length, " enabled"]
                })]
            }), Tt.map(t => {
                const r = t === "Time" ? Object.keys(ae) : Le.filter(u => Ne[u].category === t);
                    ...
                    children: [e.jsx("span", {
                        ...
                        children: r.map(u => {
                            const S = q.has(u),
                                ...
                                C = Ne[u] ?? ae[u];
                            let O = C?.label ?? u;
                            return T && C?.requiresVolume && (O += " — needs volume (single-ticker mode only)"), T && C?.requiresBench && (O += " — SPY benchmark not loaded"), e.jsx("button", {
                                disabled: T,
                                title: O,
                                onClick: () => {
                                    Z(V => {
                                        const E = new Set(V);
                                        return E.has(u) ? E.delete(u) : E.add(u), E
                                    })
                                },
            ...
            children: [ge && e.jsxs("div", {
                ...
                children: [n === "single" && "Select a ticker to begin.", n === "basket" && "Pick a basket to begin.", n === "industry" && "Pick a classification dim + value to build a composite.", n === "pair" && "Pick both legs (A and B) to compute a pair-ratio series.", n === "pairCombo" && "Pick a leg set and choose an anchor pair to compute a pair-ratio series."]
                            ...
                            children: [e.jsx("thead", {
                                ...
                                children: ft.map(t => e.jsxs("tr", {
                                    ...
                                    children: [e.jsx("td", {
                                        ...
                                        children: t.date
                                    }), t.zVec.map((r, u) => e.jsx("td", {
                                        className: "text-right text-muted-foreground pr-3 py-0.5",
                                        children: r.toFixed(2)
                                    }, u)), e.jsx("td", {
                                        className: "text-right text-muted-foreground pr-3 py-0.5",
                                        children: t.distance.toFixed(2)
                                    }), I === "kernel" && e.jsxs("td", {
                                        className: "text-right text-muted-foreground pr-3 py-0.5",
                                        children: [(t.weight * 100).toFixed(1), "%"]
                                    }), e.jsx("td", {
        ...
        children: [e.jsx("div", {
            ...
            children: [e.jsxs("span", {
                children: [e.jsxs("span", {
                    ...
                    className: o.hitRateLong - o.baseLong >= 0 ? "text-green-400/70" : "text-red-400/70",
                    title: `base rate ${o.baseLong.toFixed(0)}% over ${o.baseN} windows`,
                    children: [" ", "(", o.hitRateLong - o.baseLong >= 0 ? "+" : "", (o.hitRateLong - o.baseLong).toFixed(0), "pp)"]
                })]
            }), e.jsxs("span", {
                children: [e.jsxs("span", {
                    ...
                    className: o.hitRateShort - o.baseShort >= 0 ? "text-red-400/70" : "text-green-400/70",
                    title: `base rate ${o.baseShort.toFixed(0)}% over ${o.baseN} windows`,
                    children: [" ", "(", o.hitRateShort - o.baseShort >= 0 ? "+" : "", (o.hitRateShort - o.baseShort).toFixed(0), "pp)"]
                })]
            })]
        }), e.jsxs("div", {
...
function Rt({
    ...
    const g = l === "pair" ? "pairs" : "tickers",
        ...
        d = a => Number.isFinite(a) ? a > 0 ? "text-green-400" : a < 0 ? "text-red-400" : "text-foreground" : "text-muted-foreground/50",
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("span", {
                ...
                children: ["per-ticker · ", N.length, "/", i.length, " valid", o && e.jsxs(e.Fragment, {
                    children: [" ", "· ", e.jsx(He, {
                ...
                children: [e.jsx("thead", {
                    ...
                    children: i.map(a => e.jsxs("tr", {
                        ...
                        children: [e.jsx("td", {
                            ...
                            children: [e.jsx("span", {
                                className: "text-green-400",
                                children: Number.isFinite(a.hLong3M) ? `${a.hLong3M.toFixed(0)}%` : "—"
                            }), Number.isFinite(a.baseLong3M) && Number.isFinite(a.hLong3M) && e.jsxs("span", {
                                className: a.hLong3M - a.baseLong3M >= 0 ? "text-green-400/70" : "text-red-400/70",
                                title: `base rate ${a.baseLong3M.toFixed(0)}%`,
                                children: [" ", "(", b(a.hLong3M - a.baseLong3M), ")"]
                            })]
                        }), e.jsxs("td", {
                            className: "text-right pr-3 py-0.5",
                            children: [e.jsx("span", {
                                className: "text-red-400",
                                children: Number.isFinite(a.hShort3M) ? `${a.hShort3M.toFixed(0)}%` : "—"
                            }), Number.isFinite(a.baseShort3M) && Number.isFinite(a.hShort3M) && e.jsxs("span", {
                                className: a.hShort3M - a.baseShort3M >= 0 ? "text-red-400/70" : "text-green-400/70",
                                title: `base rate ${a.baseShort3M.toFixed(0)}%`,
                                children: [" ", "(", b(a.hShort3M - a.baseShort3M), ")"]
                            })]
                        }), e.jsx("td", {
...
function Ot({
    ...
    const o = s => Number.isFinite(s) ? `${s>=0?"+":""}${s.toFixed(1)}%` : "—",
        ...
        h = s => Number.isFinite(s) ? s > 0 ? "text-green-400" : s < 0 ? "text-red-400" : "text-foreground" : "text-muted-foreground/50",
        v = i.verdict,
        p = i.direction ?? "mixed",
        F = v.startsWith("Strong") && p === "long" ? "text-green-300 bg-green-500/10 border-green-500/40" : v.startsWith("Strong") && p === "short" ? "text-red-300 bg-red-500/10 border-red-500/40" : v.startsWith("Moderate") && p === "long" ? "text-green-300/90 bg-green-500/5 border-green-500/30" : v.startsWith("Moderate") && p === "short" ? "text-red-300/90 bg-red-500/5 border-red-500/30" : v.startsWith("Weak") && p === "long" ? "text-green-300/70 border-green-500/20" : v.startsWith("Weak") && p === "short" ? "text-red-300/70 border-red-500/20" : "text-muted-foreground border-border",
        l = i.cons,
        g = i.valid.length,
        f = i.rows.length,
        b = Number.isFinite(i.agreement) ? Math.round(i.agreement * 100) : NaN,
        d = p === "long" ? i.long3M ?? 0 : p === "short" ? i.short3M ?? 0 : Math.max(i.long3M ?? 0, i.short3M ?? 0);
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("span", {
                ...
                children: ["dispersion ±", Number.isFinite(l.sd3M) ? l.sd3M.toFixed(1) : "—", "pp"]
            }), e.jsxs("span", {
                ...
                children: [e.jsx("thead", {
                    ...
                    children: [i.rows.map(s => e.jsxs("tr", {
                        ...
                        children: [e.jsx("td", {
                            ...
                            className: "text-right pr-3 py-0.5",
                            children: s.valid && Number.isFinite(s.hLong3M) ? e.jsxs(e.Fragment, {
                                children: [e.jsxs("span", {
                                    className: "text-green-400",
                                    children: [s.hLong3M.toFixed(0), "%"]
                                }), Number.isFinite(s.baseLong3M) && e.jsxs("span", {
                                    className: s.hLong3M - s.baseLong3M >= 0 ? "text-green-400/70" : "text-red-400/70",
                                    children: [" ", "(", m(s.hLong3M - s.baseLong3M), ")"]
                                })]
                            }) : e.jsx("span", {
                            ...
                            className: "text-right pr-3 py-0.5",
                            children: s.valid && Number.isFinite(s.hShort3M) ? e.jsxs(e.Fragment, {
                                children: [e.jsxs("span", {
                                    className: "text-red-400",
                                    children: [s.hShort3M.toFixed(0), "%"]
                                }), Number.isFinite(s.baseShort3M) && e.jsxs("span", {
                                    className: s.hShort3M - s.baseShort3M >= 0 ? "text-red-400/70" : "text-green-400/70",
                                    children: [" ", "(", m(s.hShort3M - s.baseShort3M), ")"]
                                })]
                            }) : e.jsx("span", {
                                className: "text-muted-foreground/50",
                                children: "—"
                        ...
                        children: [e.jsx("td", {
                            ...
                            colSpan: 2,
                            children: ["±sd 3M: ", Number.isFinite(l.sd3M) ? l.sd3M.toFixed(1) : "—", "pp"]
                        }), e.jsx("td", {
