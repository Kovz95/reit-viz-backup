...
function Z({
    ...
    const [a, j] = l.useState(""), [v, h] = l.useState(!1), [N, b] = l.useState(0), [w, p] = l.useState(null), [C, E] = l.useState(""), $ = l.useRef(null), M = l.useRef(null), {
        baskets: B,
        addBasket: L,
        updateBasket: R,
        deleteBasket: Y
    ...
    const c = l.useMemo(() => {
            ...
            for (const r of g) {
                ...
                let u = -1;
                x === e ? u = 0 : x.startsWith(e) ? u = 1 : x.includes(e) ? u = 2 : K.includes(e) && (u = 3), u >= 0 && n.push({
                    t: r,
                    rank: u
                })
            }
            return n.sort((r, x) => r.rank - x.rank || r.t.ticker.localeCompare(x.t.ticker)), n.slice(0, 50).map(r => r.t)
        }, [g, a, s]),
        O = e => {
        ...
        q = e => {
            ...
            if (e.key === "ArrowDown") e.preventDefault(), b(o => Math.min(o + 1, Math.max(c.length - 1, 0)));
            ...
            } else e.key === "Backspace" && !a ? s.length > 0 && i(s.slice(0, -1)) : e.key === "Escape" && h(!1)
        },
        z = e => {
        ...
        children: [t.jsxs("div", {
            ...
            children: [s.map((e, o) => {
                ...
                return t.jsxs("span", {
                    ...
                    title: n ? "Workbook ticker (data still fetched from Yahoo)" : "Yahoo symbol",
                    children: [t.jsx("span", {
                        className: "font-bold",
                        children: e
                    }), t.jsx("button", {
                ...
                ref: M,
                type: "text",
                placeholder: s.length === 0 ? "Type a ticker, press Enter…" : "Add another…",
                value: a,
                onChange: e => {
            ...
            }, e.ticker)), a.trim() && !c.find(e => e.ticker.toUpperCase() === a.trim().toUpperCase()) && t.jsxs("button", {
                type: "button",
            ...
            children: [t.jsxs("div", {
                ...
                children: [t.jsx("input", {
                    ...
                    onKeyDown: e => {
                        e.key === "Enter" && (e.preventDefault(), U()), e.key === "Escape" && p(null)
                    },
            ...
            children: k.length === 0 ? t.jsx("div", {
                ...
                children: [t.jsxs("button", {
                    ...
                    children: [t.jsx("span", {
                        ...
                        children: [e.tickers.length, " tickers · ", e.tickers.slice(0, 6).join(", "), e.tickers.length > 6 ? "…" : ""]
                    })]
                }), t.jsx("button", {
                    type: "button",
                    onClick: () => Y(e.id),
