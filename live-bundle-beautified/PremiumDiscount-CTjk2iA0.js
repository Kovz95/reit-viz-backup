...
const sr = Ns("Settings2", [
    ...
    hs = ["premium", "growth", "ratio", "rollCorr", "relReturn", "relRatio", "rawRatio", "rvVerdictTs", "similar"],
    xs = {
        premium: "Premium",
        growth: "Growth Diff",
        ratio: "Prem ÷ Δg",
...
function gn() {
    const [j, A] = n.useState([]), [le, fe] = n.useState(!0), [x, ae] = n.useState(""), [U, Tt] = n.useState("subindustry"), {
        available: Be,
        valuationMetric: Ye,
        growthMetric: ze
    } = on(), Et = n.useRef(!1), Pr = n.useRef(!1), [O, Vt] = n.useState(Ye), [K, Bt] = n.useState(ze), nr = n.useRef(Be);
    n.useEffect(() => {
        nr.current = Be
    }, [Be]);
    ...
    const [Pe, ar] = n.useState(""), [Fe, _e] = n.useState(""), [ut, or] = n.useState("heatmap"), [mt, Gr] = n.useState(60), [pt, Ar] = n.useState(0), [Lt, Dr] = n.useState(20), [It, Tr] = n.useState(252), [Nt, Er] = n.useState(30), [ft, Vr] = n.useState(.2), [yt, Br] = n.useState(!1), [ir, lr] = n.useState([]), [f, Ot] = n.useState("peer"), [D, cr] = n.useState(""), [we, Lr] = n.useState("subindustry"), [oe, Kt] = n.useState(""), [Ge, Ir] = n.useState("subindustry"), [he, dr] = n.useState(tt), [Or, ys] = n.useState(0), [Wr, ws] = n.useState(0), [ce, ur] = n.useState("classification"), [de, mr] = n.useState("classification"), [wt, Yr] = n.useState(""), [jt, zr] = n.useState(""), [ue, Wt] = n.useState(""), [js, kt] = n.useState(!1), [Le, pr] = n.useState("capWeighted"), {
        baskets: je,
        getBasket: St
    } = Ws(), [ee, _r] = n.useState(() => new Set(["premium", "growth", "relReturn", "similar"])), [y, Zt] = n.useState([]), [C, Xt] = n.useState([]), [fr, Qt] = n.useState(0), [re, Hr] = n.useState(""), [ht, hr] = n.useState(""), [xr, qr] = n.useState(!1), [Ur, Kr] = n.useState(null), [Ie, Yt] = n.useState([]), [Oe, zt] = n.useState([]), [gr, Zr] = n.useState(!1), br = n.useRef(!1), ks = n.useCallback(() => ({
        target: x,
        dimension: U,
        valMetric: O,
        growthMetric: K,
        ...
        scatterView: ut,
        rvBand: ft
    }), [x, U, O, K, Pe, Fe, mt, pt, yt, f, D, ht, we, oe, Ge, he, ce, de, wt, jt, ue, Le, ee, Lt, It, Nt, ut, ft]), Ss = n.useCallback(e => {
        if (e) {
            if (typeof e.target == "string" && e.target && ae(e.target), typeof e.dimension == "string" && e.dimension && Tt(e.dimension), typeof e.valMetric == "string" && e.valMetric) {
                const s = nr.current;
            ...
            if (typeof e.pinDate == "string" && ar(e.pinDate), typeof e.periodFilter == "string" && _e(e.periodFilter), (e.scatterView === "heatmap" || e.scatterView === "points") && or(e.scatterView), typeof e.rollWindow == "number" && e.rollWindow > 1 && Gr(e.rollWindow), typeof e.rollLag == "number" && Number.isFinite(e.rollLag) && Ar(e.rollLag), typeof e.showEarnings == "boolean" && Br(e.showEarnings), (e.compareMode === "peer" || e.compareMode === "ticker" || e.compareMode === "group" || e.compareMode === "basket") && Ot(e.compareMode), typeof e.peerTicker == "string" && cr(e.peerTicker), typeof e.peerValueOverride == "string" && hr(e.peerValueOverride), typeof e.groupADim == "string" && Lr(e.groupADim), typeof e.groupAValue == "string" && Kt(e.groupAValue), typeof e.groupBDim == "string" && Ir(e.groupBDim), typeof e.groupBValue == "string" && dr(e.groupBValue), (e.groupAKind === "classification" || e.groupAKind === "basket") && ur(e.groupAKind), (e.groupBKind === "classification" || e.groupBKind === "basket") && mr(e.groupBKind), typeof e.groupABasketId == "string" && Yr(e.groupABasketId), typeof e.groupBBasketId == "string" && zr(e.groupBBasketId), (e.basketAggregation === "capWeighted" || e.basketAggregation === "median") && pr(e.basketAggregation), typeof e.basketId == "string" && Wt(e.basketId), Array.isArray(e.visibleCharts)) {
                const s = e.visibleCharts.filter(o => typeof o == "string" && hs.includes(o));
                s.length && _r(new Set(s))
            }
            typeof e.similarN == "number" && e.similarN >= 5 && e.similarN <= 200 && Dr(e.similarN), typeof e.similarExclusion == "number" && e.similarExclusion >= 0 && e.similarExclusion <= 1e3 && Tr(e.similarExclusion), typeof e.similarMinGap == "number" && e.similarMinGap >= 0 && e.similarMinGap <= 504 && Er(e.similarMinGap), typeof e.rvBand == "number" && e.rvBand >= .05 && e.rvBand <= 2 && Vr(e.rvBand), br.current = !0
        }
    }, []), Ms = an();
    Ys("premium-discount", ks, Ss, {
        ...
        try {
            ...
            typeof s.ticker == "string" && s.ticker && ae(s.ticker), typeof s.valMetric == "string" && s.valMetric && Vt(s.valMetric), typeof s.growthMetric == "string" && s.growthMetric && Bt(s.growthMetric), typeof s.dimension == "string" && s.dimension && Tt(s.dimension), br.current = !0
        } catch {}
    }, []);
    ...
    n.useEffect(() => {
        if (f !== "group" && f !== "basket" && !x || f === "peer" && !re || f === "ticker" && (!D || D === x) || f === "basket" && (!x || !se || se.tickers.length < 2)) return;
        if (f === "group") {
            const s = ce === "basket" ? Re && Re.tickers.length >= 2 : !!oe,
                o = de === "basket" ? Ce && Ce.tickers.length >= 2 : !!he;
            if (!s || !o || ce === "classification" && de === "classification" && we === Ge && oe === he) return
        }
        let e = !0;
        return qr(!0), Kr(null), (async () => {
            try {
                if (f === "peer") {
                    ...
                    const [s, o, a, r] = await Promise.all([ye(x, O).catch(() => []), ye(D, O).catch(() => []), ye(x, K).catch(() => []), ye(D, K).catch(() => [])]), c = rt(s, o, "pct"), i = rt(a, r, "abs");
                    if (!e) return;
                    Zt(c), Xt(i), Qt(1)
                } else if (f === "basket") {
                    const s = se,
                        [o, a, r, c] = await Promise.all([ye(x, O).catch(() => []), ye(x, K).catch(() => []), xt(s, O), xt(s, K)]),
                        i = rt(o, r.groupSeries, "pct"),
                        d = rt(a, c.groupSeries, "abs");
                    if (!e) return;
                    Zt(i), Xt(d), Qt(s.tickers.length)
                } else {
                    const s = ce === "basket" && Re ? [xt(Re, O), xt(Re, K)] : [rr(we, oe, O, "median", ye), rr(we, oe, K, "median", ye)],
                        o = de === "basket" && Ce ? [xt(Ce, O), xt(Ce, K)] : [rr(Ge, he, O, "median", ye), rr(Ge, he, K, "median", ye)],
                        [a, r, c, i] = await Promise.all([...s, ...o]),
                        d = rt(a.groupSeries, c.groupSeries, "pct"),
                        p = rt(r.groupSeries, i.groupSeries, "abs");
                    if (!e) return;
                    Zt(d), Xt(p), Qt(a.peerTickers.length), ys(a.peerTickers.length), ws(c.peerTickers.length)
                }
            } catch (s) {
                if (!e) return;
        ...
        if (f !== "group" && f !== "basket" && !x || f === "peer" && (!re || Ht.length === 0) || f === "ticker" && (!D || D === x) || f === "basket" && (!se || se.tickers.length < 2) || f === "group" && (!(ce === "basket" ? !!Re : !!oe) || !(de === "basket" ? !!Ce : !!he))) return;
        let e = !0;
        Zr(!0);
        const s = o => {
            const a = new Set,
            ...
            for (const d of o) {
                const p = new Map;
                let u = null;
                for (const g of d) !Number.isFinite(g.value) || g.value <= 0 || (u === null && (u = g.value), p.set(g.time, g.value / u), a.add(g.time));
                r.push(p)
            }
            ...
            try {
                if (f === "group") {
                    const a = ce === "basket" && Re ? Re.tickers : kr(j, we, oe).map(d => d.ticker),
                        ...
                        [c, i] = await Promise.all([Promise.all(a.map(d => We(d, "close").catch(() => []))), Promise.all(r.map(d => We(d, "close").catch(() => [])))]);
                    if (!e) return;
                    Yt(s(c)), zt(s(i));
                    return
                }
                if (f === "basket") {
                    ...
                    if (Le === "capWeighted") {
                        ...
                        const c = await Promise.all(a.tickers.filter(i => i !== x).map(i => We(i, "close").catch(() => [])));
                        if (!e) return;
                        Yt(r), zt(s(c))
                    }
                    return
    ...
    const Nr = n.useMemo(() => D ? j.find(e => e.ticker === D)?.name || D : "", [j, D]),
        et = n.useMemo(() => ce === "basket" ? Re ? Re.name : "—" : oe === tt ? "All REITs" : oe || "—", [ce, Re, oe]),
        Ae = n.useMemo(() => de === "basket" ? Ce ? Ce.name : "—" : he === tt ? "All REITs" : he || "—", [de, Ce, he]),
        gt = n.useMemo(() => se ? se.name : "—", [se]);
    n.useEffect(() => {
        f === "basket" && (ue && je.find(e => e.id === ue) || (je.length > 0 ? Wt(je[0].id) : ue && Wt(null)))
    }, [je, ue, f]), n.useEffect(() => {
    ...
    const Rs = .5,
        ...
        me = n.useMemo(() => {
            ...
            for (const o of y) {
                ...
                if (a === void 0 || !Number.isFinite(a) || !Number.isFinite(o.value) || Math.abs(a) < Rs) continue;
                const r = o.value / a;
    ...
    const wr = n.useDeferredValue(ft),
        ...
        Ee = n.useMemo(() => {
            ...
            for (const v of y) {
                ...
                P !== void 0 && (!Number.isFinite(v.value) || !Number.isFinite(P) || (o[c] = v.time, a[c] = v.value, r[c] = P, c++))
            }
            if (c < 60) return [];
            ...
            for (let v = 0; v < c; v++) {
                ...
                if (v >= 60) {
                    ...
                    if (J > 0 && N > 0) {
                        ...
                        let L = 0,
                            H = 0;
                        B != null && (L = B <= 25 ? 1 : B >= 75 ? -1 : 0), ne != null && (H = ne >= 75 ? 1 : ne <= 25 ? -1 : 0);
                        const m = L + H;
                        let b = "Neutral";
                        L === 1 && H === 1 ? b = "Attractive" : L === -1 && H === -1 ? b = "Expensive" : L === 1 && H >= 0 ? b = "Attractive" : L === -1 && H <= 0 ? b = "Expensive" : H === 1 && L >= 0 ? b = "Attractive" : H === -1 && L <= 0 && (b = "Expensive"), p.push({
                            time: o[v],
                            score: m,
                            label: b
                        })
    ...
    n.useEffect(() => {
        if (Je.current) {
            ...
            if (_t.current) {
                const e = "rgba(34,197,94,0.95)",
                    ...
                    c = Ee.map(i => {
                        let d = r;
                        return i.score >= 2 ? d = e : i.score === 1 ? d = s : i.score <= -2 ? d = o : i.score === -1 && (d = a), {
                            time: i.time,
                            value: i.score,
                            color: d
                        }
        ...
        const e = [],
            s = () => {
                ...
                Qr.current = null, Jr.current = null, es.current = null, ts.current = null, rs.current = null, ss.current = null, ns.current = null
            };
        ...
        return a(Qr, Mt.current), a(Jr, Rt.current), a(es, Ct.current), a(ts, Pt.current), a(rs, Ft.current), a(ss, $t.current), a(ns, Gt.current), requestAnimationFrame(() => {
            try {
                xe.current?.applyOptions({})
            } catch {}
            try {
    ...
    }, [ir, yt, y.length === 0, C.length === 0, me.length === 0, De.length === 0, te.length === 0, Te.length === 0, Ne.length === 0]), n.useEffect(() => {
        const s = [{
            chart: xe.current,
            hasData: y.length > 0
        }, {
    ...
    }, [y.length === 0, C.length === 0, me.length === 0, De.length === 0, te.length === 0, Te.length === 0, Ne.length === 0, Ee.length === 0, ee]), n.useEffect(() => {
        const e = i => {
                ...
                if (!a) {
                    ...
                    try {
                        ...
                        for (const {
                            ...
                            of o)
                            if (u !== i) try {
                                d?.time && g ? u.setCrosshairPosition(NaN, d.time, g) : u.clearCrosshairPosition()
                            } catch {}
                        as(u => u === p ? u : p)
                    } finally {
                        a = !1
    ...
    }, [y.length === 0, C.length === 0, me.length === 0, De.length === 0, te.length === 0, Te.length === 0, Ne.length === 0, Ee.length === 0, ee]);
    const Ps = n.useMemo(() => {
            const e = new Map;
    ...
    n.useEffect(() => {
        ...
        return He.current && s.observe(He.current), qe.current && s.observe(qe.current), Ue.current && s.observe(Ue.current), Ke.current && s.observe(Ke.current), Ze.current && s.observe(Ze.current), Xe.current && s.observe(Xe.current), Qe.current && s.observe(Qe.current), Je.current && s.observe(Je.current), window.addEventListener("resize", e), () => {
        ...
        xe.current = null, ge.current = null, be.current = null, ve.current = null, ke.current = null, Se.current = null, Me.current = null, $e.current = null, Mt.current = null, Rt.current = null, Ct.current = null, Pt.current = null, Jt.current = null, Ft.current = null, $t.current = null, Gt.current = null, _t.current = null
    }, []);
    const R = n.useMemo(() => {
        ...
        Ds = n.useMemo(() => {
            ...
            let V = "Neutral",
                J = "";
            return Z === 1 && Q === 1 ? (V = "Attractive", J = "premium below fair-for-growth & growth above fair-for-premium") : Z === -1 && Q === -1 ? (V = "Expensive", J = "premium above fair-for-growth & growth below fair-for-premium") : Z === 1 && Q >= 0 ? (V = "Attractive", J = "premium below what history pays for this growth") : Z === -1 && Q <= 0 ? (V = "Expensive", J = "premium above what history pays for this growth") : Q === 1 && Z >= 0 ? (V = "Attractive", J = "growth above what history accompanies this premium") : Q === -1 && Z <= 0 ? (V = "Expensive", J = "growth below what history accompanies this premium") : Z === 1 && Q === -1 ? (V = "Neutral", J = "cheap-for-growth but growth lagging — mixed") : Z === -1 && Q === 1 ? (V = "Neutral", J = "rich-for-growth but growth ripping — mixed") : (V = "Neutral", J = "within historical range"), {
                premGivenGrowth: g,
                growthGivenPrem: w,
                impliedPrem: k,
                premGap: v,
        ...
        E = n.useMemo(() => {
                ...
                Z = new Float64Array(s.length);
            {
                ...
                for (let T = 0; T < s.length; T++) {
                    ...
                    h += z / l, M += z * (s[T].p - h);
                    const q = s[T].g - F;
                    F += q / l, G += q * (s[T].g - F), v[T] = h, W[T] = F, P[T] = l >= 2 ? Math.sqrt(M / (l - 1)) : p, Z[T] = l >= 2 ? Math.sqrt(G / (l - 1)) : u
                }
            }
            const Q = new Map;
    ...
    n.useEffect(() => {
        ...
        if (i.length < 5) {
            r.fillStyle = "rgba(255,255,255,0.45)", r.font = "12px ui-monospace, monospace", r.textAlign = "center", r.fillText(xr ? "Computing…" : "Not enough overlapping data", o / 2, a / 2);
            return
        }
        let k = 1 / 0,
            v = -1 / 0,
            P = 1 / 0,
            W = -1 / 0;
        for (const m of i) m.x < k && (k = m.x), m.x > v && (v = m.x), m.y < P && (P = m.y), m.y > W && (W = m.y);
        const Z = (v - k) * .06 || 1,
            Q = (W - P) * .06 || 1;
        k -= Z, v += Z, P -= Q, W += Q, k > 0 && k < v - k && (k = 0), v < 0 && v > -(v - k) && (v = 0), P > 0 && P < W - P && (P = 0), W < 0 && W > -(W - P) && (W = 0);
        ...
        r.strokeStyle = $, r.lineWidth = 1, r.strokeRect(u.l, u.t, g, w), r.fillStyle = "rgba(255,255,255,0.55)", r.font = "10px ui-monospace, monospace", r.textAlign = "right", r.textBaseline = "middle";
        for (let m = 0; m <= 4; m++) {
            const b = P + m / 4 * (W - P),
                S = V(b);
            r.fillText(`${Math.round(b)}%`, u.l - 6, S), r.strokeStyle = $, r.beginPath(), r.moveTo(u.l, S), r.lineTo(u.l + g, S), r.stroke()
        }
        r.textAlign = "center", r.textBaseline = "top";
        for (let m = 0; m <= 4; m++) {
            const b = k + m / 4 * (v - k),
                S = Y(b);
            r.fillText(`${Math.round(b)}`, S, u.t + w + 6), r.strokeStyle = $, r.beginPath(), r.moveTo(S, u.t), r.lineTo(S, u.t + w), r.stroke()
        }
        ...
        if (r.setLineDash([]), r.fillStyle = "rgba(255,255,255,0.75)", r.font = "11px ui-monospace, monospace", r.textAlign = "center", r.textBaseline = "alphabetic", r.fillText(`Growth differential (pp) — ${K}`, u.l + g / 2, a - 14), r.save(), r.translate(16, u.t + w / 2), r.rotate(-Math.PI / 2), r.fillText(`Premium / Discount (%) — ${O}`, 0, 0), r.restore(), ut === "heatmap") {
            ...
            if (l > 0) {
                for (let z = 0; z < _; z++)
                    for (let q = 0; q < S; q++) {
                        ...
                        r.fillStyle = `rgba(${ie}, ${Ve}, ${tr}, ${qt})`, r.fillRect(u.l + q * b, u.t + z * b, b, b)
                    }
                const M = 100,
                    F = 8,
                    G = u.l + g - M - 4,
                ...
                r.strokeStyle = "rgba(255,255,255,0.25)", r.lineWidth = 1, r.strokeRect(G, T, M, F), r.fillStyle = "rgba(255,255,255,0.7)", r.font = "9px ui-monospace, monospace", r.textAlign = "left", r.textBaseline = "top", r.fillText("low", G, T + F + 2), r.textAlign = "right", r.fillText(`${l} days`, G + M, T + F + 2)
            }
            if (N)
                for (const M of i) B(M.t) && (r.fillStyle = "rgba(56,189,248,0.95)", r.beginPath(), r.arc(Y(M.x), V(M.y), 3.5, 0, Math.PI * 2), r.fill(), r.strokeStyle = "rgba(15,23,42,0.6)", r.lineWidth = .5, r.stroke())
        } else if (N) {
            for (const m of i) B(m.t) || (r.fillStyle = "rgba(255,255,255,0.06)", r.beginPath(), r.arc(Y(m.x), V(m.y), 2, 0, Math.PI * 2), r.fill());
            for (const m of i) B(m.t) && (r.fillStyle = "rgba(56,189,248,0.85)", r.beginPath(), r.arc(Y(m.x), V(m.y), 4, 0, Math.PI * 2), r.fill())
        } else
            for (const m of i) {
                ...
                r.fillStyle = `rgba(${_}, ${I}, ${l}, ${b})`, r.beginPath(), r.arc(Y(m.x), V(m.y), S, 0, Math.PI * 2), r.fill()
            }
        const H = i[i.length - 1];
        if (r.strokeStyle = gs, r.lineWidth = 2, r.beginPath(), r.arc(Y(H.x), V(H.y), 6, 0, Math.PI * 2), r.stroke(), r.fillStyle = "rgba(245,158,11,0.95)", r.font = "10px ui-monospace, monospace", r.textAlign = "left", r.textBaseline = "middle", r.fillText("today", Y(H.x) + 9, V(H.y)), L) {
            const m = Y(L.x),
                b = V(L.y),
                S = "rgba(34,197,94,0.95)";
            r.strokeStyle = "rgba(34,197,94,0.35)", r.setLineDash([4, 4]), r.lineWidth = 1, r.beginPath(), r.moveTo(u.l, b), r.lineTo(u.l + g, b), r.stroke(), r.beginPath(), r.moveTo(m, u.t), r.lineTo(m, u.t + w), r.stroke(), r.setLineDash([]), r.fillStyle = S, r.beginPath(), r.arc(m, b, 4, 0, Math.PI * 2), r.fill(), r.strokeStyle = S, r.lineWidth = 2, r.beginPath(), r.arc(m, b, 9, 0, Math.PI * 2), r.stroke();
            ...
            let h = m + 12,
                M = b - l - 12;
            h + I > u.l + g && (h = m - I - 12), M < u.t && (M = b + 12), r.fillStyle = "rgba(20,20,20,0.92)", r.fillRect(h, M, I, l), r.strokeStyle = S, r.lineWidth = 1, r.strokeRect(h, M, I, l), r.fillStyle = S, r.textAlign = "left", r.textBaseline = "middle", r.fillText(_, h + 6, M + l / 2)
        }
    }, [y, C, O, K, xr, Pe, Fe, ut]);
    ...
    function Ts() {
        ...
        for (const p of y) {
            const u = e.get(p.time),
                g = s.get(p.time),
                w = o.get(p.time);
            a.push(`${p.time},${p.value.toFixed(4)},${u!==void 0?u.toFixed(4):""},${g!==void 0?g.toFixed(4):""},${w!==void 0?w.toFixed(6):""}`)
        }
...
`)], {
        ...
        i.href = c;
        const d = f === "peer" ? `${x}_vs_${U}_${O}_${K}.csv` : f === "ticker" ? `${x}_vs_${D}_${O}_${K}.csv` : f === "basket" ? `${x}_vs_basket_${gt}_${O}_${K}.csv` : `${et}_vs_${Ae}_${O}_${K}.csv`;
    ...
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsxs("div", {
                ...
                children: [t.jsxs("div", {
                    ...
                    children: [t.jsx("label", {
                        ...
                        children: [t.jsx("select", {
                            ...
                            children: [re && re !== tt && t.jsxs("option", {
                                ...
                                value: tt,
                                children: "All REITs"
                            }), (vr[U] || []).filter(e => e !== re).map(e => t.jsx("option", {
                                value: e,
                                children: e
                            }, e))]
                        })]
                    ...
                    children: [t.jsx("label", {
                        ...
                        }), j.filter(e => e.ticker !== x).map(e => t.jsxs("option", {
                            value: e.ticker,
                            children: [e.ticker, " — ", e.name]
                        }, e.ticker))]
                    })]
                ...
                children: [f === "peer" ? t.jsxs(t.Fragment, {
                    ...
                    children: [t.jsxs("span", {
                        children: [t.jsx("span", {
                            ...
                            className: "text-muted-foreground/60",
                            children: ["(", ce === "basket" ? `basket · ${Or}` : `${At[we]} · ${Or}`, ")"]
                        })]
                    }), t.jsxs("span", {
                        children: [t.jsx("span", {
                            className: "text-muted-foreground/60",
                            ...
                            className: "text-muted-foreground/60",
                            children: ["(", de === "basket" ? `basket · ${Wr}` : `${At[Ge]} · ${Wr}`, ")"]
                        })]
                    }), t.jsxs("span", {
                        children: [t.jsx("span", {
                            className: "text-muted-foreground/60",
            ...
            children: [t.jsx(dt, {
                ...
                value: bs(R.lastP),
                sub: f === "peer" ? `vs ${O}` : f === "ticker" ? `vs ${D||"—"} · ${O}` : f === "basket" ? `vs basket ${gt} · ${O}` : `${et} vs ${Ae} · ${O}`,
                tone: R.lastP > 0 ? "rich" : R.lastP < 0 ? "cheap" : "neutral"
            }), t.jsx(dt, {
                label: "History percentile",
                value: Number.isFinite(R.pctile) ? `${R.pctile.toFixed(0)}%` : "—",
                sub: R.pctile > 80 ? "richest 20%" : R.pctile < 20 ? "cheapest 20%" : "mid-range",
                ...
                value: bs(R.lastG),
                sub: f === "peer" ? "pp vs peer median" : f === "ticker" ? `pp vs ${D||"—"}` : f === "basket" ? `pp vs basket ${gt}` : `pp · ${et} vs ${Ae}`,
                tone: R.lastG > 0 ? "cheap" : R.lastG < 0 ? "rich" : "neutral"
            }), t.jsx(dt, {
                label: "Premium ↔ Growth corr",
                value: Rr(R.corr),
                sub: R.corr > .4 ? "premium tracks growth" : R.corr < -.4 ? "premium fights growth" : "weak relationship",
                tone: "neutral"
            }), t.jsx(dt, {
                label: "Prem÷Δg ↔ A/B corr",
                value: Rr(R.corrRatioVsAB),
                sub: R.corrRatioVsAB > .4 ? "ratio tracks price spread" : R.corrRatioVsAB < -.4 ? "ratio fights price spread" : "weak relationship",
                tone: "neutral"
            }), t.jsx(dt, {
                label: "Rel return since anchor",
                value: Number.isFinite(R.relReturnSinceAnchor) ? `${R.relReturnSinceAnchor>=0?"+":""}${R.relReturnSinceAnchor.toFixed(1)}pp` : "—",
                sub: bt ? `since ${bt}${Pe?" (pin)":""}` : f === "peer" ? "vs peer median" : f === "ticker" ? `vs ${D||"—"}` : f === "basket" ? `vs basket ${gt}` : `${et} vs ${Ae}`,
                tone: R.relReturnSinceAnchor > 0 ? "cheap" : R.relReturnSinceAnchor < 0 ? "rich" : "neutral"
            }), t.jsx(dt, {
                label: "Forward 1Y rel return",
                value: Number.isFinite(R.forwardRelReturn252) ? `${R.forwardRelReturn252>=0?"+":""}${R.forwardRelReturn252.toFixed(1)}pp` : "—",
                sub: "252d after anchor",
                tone: R.forwardRelReturn252 > 0 ? "cheap" : R.forwardRelReturn252 < 0 ? "rich" : "neutral"
            })]
        }), (() => {
            const e = Ds,
                s = e.label === "Attractive" ? "text-emerald-300 border-emerald-500/40 bg-emerald-500/10" : e.label === "Expensive" ? "text-rose-300 border-rose-500/40 bg-rose-500/10" : "text-amber-300/90 border-amber-500/30 bg-amber-500/5",
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("div", {
                            ...
                            children: [t.jsx("span", {
                                ...
                                children: ["when Δg ∈ [", a(e.premGivenGrowth?.bandLo ?? NaN), ", ", a(e.premGivenGrowth?.bandHi ?? NaN), "]", e.premGivenGrowth ? ` · n=${e.premGivenGrowth.n}` : ""]
                            })]
                            ...
                            children: [t.jsxs("div", {
                                ...
                                children: [t.jsxs("span", {
                                    ...
                                    children: ["gap ", o(e.premGap), " ", e.premGap < 0 ? "→ cheap-for-growth" : e.premGap > 0 ? "→ rich-for-growth" : ""]
                                })]
                            }), t.jsx(r, {
                                ...
                                children: [t.jsxs("span", {
                                    children: ["p25 ", a(e.premGivenGrowth.p25)]
                                }), t.jsxs("span", {
                                    children: ["median ", a(e.premGivenGrowth.median)]
                                }), t.jsxs("span", {
                                    children: ["p75 ", a(e.premGivenGrowth.p75)]
                                })]
                            }), t.jsxs("div", {
                                className: "text-[9px] font-mono text-muted-foreground/70 mt-0.5",
                                children: ["today is at ", t.jsxs("span", {
                                    className: "text-amber-300",
                                    children: [e.premGivenGrowth.todayPctile.toFixed(0), "th pctile"]
                        ...
                        children: [t.jsxs("div", {
                            ...
                            children: [t.jsx("span", {
                                ...
                                className: "text-[10px] font-mono text-muted-foreground/70",
                                children: ["when premium ∈ [", a(e.growthGivenPrem?.bandLo ?? NaN), ", ", a(e.growthGivenPrem?.bandHi ?? NaN), "]", e.growthGivenPrem ? ` · n=${e.growthGivenPrem.n}` : ""]
                            })]
                            ...
                            children: [t.jsxs("div", {
                                ...
                                children: [t.jsxs("span", {
                                    ...
                                    children: ["gap ", o(e.growthGap), " ", e.growthGap > 0 ? "→ excess growth" : e.growthGap < 0 ? "→ weak growth" : ""]
                                })]
                            }), t.jsx(r, {
                                ...
                                className: "flex justify-between text-[9px] font-mono text-muted-foreground/70 mt-1",
                                children: [t.jsxs("span", {
                                    children: ["p25 ", a(e.growthGivenPrem.p25)]
                                }), t.jsxs("span", {
                                    children: ["median ", a(e.growthGivenPrem.median)]
                                }), t.jsxs("span", {
                                    children: ["p75 ", a(e.growthGivenPrem.p75)]
                                })]
                            }), t.jsxs("div", {
                                className: "text-[9px] font-mono text-muted-foreground/70 mt-0.5",
                                children: ["today is at ", t.jsxs("span", {
                                    className: "text-amber-300",
                                    children: [e.growthGivenPrem.todayPctile.toFixed(0), "th pctile"]
                                }), " of conditional sample"]
                            })]
                        }) : t.jsx("span", {
                            className: "text-[11px] font-mono text-muted-foreground",
            ...
            children: [t.jsxs("div", {
                ...
                children: [t.jsxs("div", {
                    ...
                    children: [t.jsx("span", {
                        ...
                        children: ["today z=(", E.todayZPrem.toFixed(2), ", ", E.todayZGrowth.toFixed(2), ") ·", " ", E.matches.length, "/", E.totalCandidates, " bars matched", E.droppedByGap > 0 && t.jsxs("span", {
                            className: "text-muted-foreground/70",
                            children: [" · ", E.droppedByGap, " dropped by gap"]
                        })]
                    })]
                }), E && E.matches.length > 0 && E.yearMax >= E.yearMin && t.jsxs("div", {
                    ...
                    children: [(() => {
                        ...
                        for (let o = E.yearMin; o <= E.yearMax; o++) {
                            ...
                            e.push(t.jsx("div", {
                                className: a > 0 ? "bg-amber-400/80" : "bg-muted-foreground/20",
                                style: {
                                    width: 4,
                                    height: `${r}px`
                                },
                    ...
                    children: ["⚠ ", Math.round(E.cluster.share * 100), "% in ", E.cluster.dominantMonth]
                }), t.jsx("div", {
                    className: "flex-1"
                }), t.jsxs("div", {
                    className: "flex items-center gap-2",
            ...
            children: [t.jsxs("div", {
                ...
                children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("span", {
                            ...
                            children: [t.jsxs("label", {
                                ...
                                children: [t.jsx("span", {
                                    ...
                                    value: mt,
                                    onChange: e => Gr(Number(e.target.value)),
                                ...
                                children: [t.jsx("span", {
                                    ...
                                    onChange: e => {
                                        ...
                                        Number.isFinite(s) && Ar(Math.max(-60, Math.min(60, Math.round(s))))
                                    },
                                ...
                                children: ["Peak: ", er.lag >= 0 ? "+" : "", er.lag, "d · ρ=", er.rho.toFixed(2)]
                            }) : t.jsx("span", {
                                className: "text-muted-foreground",
                                children: "Peak: —"
                            }), t.jsx(vt, {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("span", {
                            ...
                            children: [t.jsx(vt, {
                                ...
                                children: f === "peer" ? "A vs peer median" : f === "ticker" ? `A vs ${D||"—"}` : `${et} vs ${Ae}`
                            })]
                        })]
                    }), t.jsx("div", {
                        ref: Ze,
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("span", {
                            className: "text-[10px] font-mono text-muted-foreground uppercase tracking-wider whitespace-nowrap",
                            children: ["Rel Strength (×, log)", " ", t.jsxs("span", {
                                className: "text-muted-foreground/60 normal-case tracking-normal",
                                children: ["vs anchor: ", bt || "—"]
                            })]
                        }), t.jsxs("div", {
                            ...
                            children: [t.jsx(vt, {
                                ...
                                children: f === "peer" ? "A / peer median" : f === "ticker" ? `A / ${D||"—"}` : `${et} / ${Ae}`
                            })]
                        })]
                    }), t.jsx("div", {
                        ref: Xe,
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("span", {
                            className: "text-[10px] font-mono text-muted-foreground uppercase tracking-wider whitespace-nowrap",
                            children: ["A / B Ratio (×, log)", " ", t.jsx("span", {
                                className: "text-muted-foreground/60 normal-case tracking-normal",
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("span", {
                            className: "text-[10px] font-mono text-muted-foreground uppercase tracking-wider whitespace-nowrap",
                            children: ["RV Verdict (history)", " ", t.jsx("span", {
                                className: "text-muted-foreground/60 normal-case tracking-normal",
                            ...
                            className: "flex items-center gap-3 text-[10px] font-mono",
                            children: (() => {
                                const e = Ee.length ? Ee[Ee.length - 1] : null;
                                if (!e) return t.jsx("span", {
                                    className: "text-muted-foreground/60",
                                    children: "—"
                                });
                                const s = e.label === "Attractive" ? "text-emerald-400" : e.label === "Expensive" ? "text-rose-400" : "text-muted-foreground";
                                return t.jsxs("span", {
                                    className: s,
                                    "data-testid": "hover-rvverdict",
                                    children: [e.label, " (", e.score >= 0 ? "+" : "", e.score, ")"]
                                })
                            })()
                        })]
                    }), t.jsx("div", {
                ...
                children: [t.jsxs("div", {
                    ...
                    children: [t.jsxs("div", {
                        ...
                        children: [t.jsxs("label", {
                            ...
                            children: [t.jsx("input", {
                                type: "date",
                                value: (() => {
                                    const e = Fe.match(/^(\d{4}-\d{2}-\d{2})\.\.(\d{4}-\d{2}-\d{2})$/);
                                    return e ? e[1] : ""
                                })(),
                                onChange: e => {
                                    const s = e.target.value,
                                        o = Fe.match(/^(\d{4}-\d{2}-\d{2})\.\.(\d{4}-\d{2}-\d{2})$/),
                                        a = o ? o[2] : "";
                                    _e(s && a ? `${s}..${a}` : s ? `${s}..${s}` : "")
                                },
                                title: "Start date",
                    ...
                    children: ut === "heatmap" ? t.jsxs(t.Fragment, {
                        children: ["Each cell shows how many trading days landed in that (Δgrowth, premium) bucket — brighter = more frequent. Top-right = expensive AND faster-growing than", " ", f === "peer" ? "peers" : f === "ticker" ? D || "comparison" : f === "basket" ? gt : Ae, "; bottom-left = cheap AND slower-growing. Switch to Points to see individual days."]
                    }) : t.jsxs(t.Fragment, {
                        children: ["Each dot is one trading day. Older points fade purple→amber. Top-right = expensive AND faster-growing than", " ", f === "peer" ? "peers" : f === "ticker" ? D || "comparison" : f === "basket" ? gt : Ae, "; bottom-left = cheap AND slower-growing. Pin a date or pick a start/end date range to inspect specific windows."]
                    })
                })]
            })]
        }), js && t.jsx("div", {
