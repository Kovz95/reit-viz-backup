...
function le(e) {
    ...
    let n = 0;
    for (let s = 0; s < e.volumes.length && !(Number.isFinite(e.volumes[s]) && e.volumes[s] > 0 && (n++, n >= 30)); s++);
...
function He(e) {
    ...
    return t > .25 ? "text-emerald-400 font-bold" : t > .15 ? "text-emerald-300" : t > .08 ? "text-yellow-300" : "text-muted-foreground"
}

function Oe(e) {
    const t = Math.abs(e);
    return t > .8 ? "text-emerald-400 font-bold" : t > .5 ? "text-emerald-300" : t > .2 ? "text-yellow-300" : "text-muted-foreground"
}
...
function ze({
    ...
    const [d, m] = k.useState(n), [u, i] = k.useState(5), [l, x] = k.useState([]), [F, y] = k.useState("all"), [g, j] = k.useState("all"), N = k.useMemo(() => Ce({
        signals: e,
        horizon: d,
        useBand: s,
        context: t,
        minSamples: u
    }), [e, d, s, t, u]), b = k.useMemo(() => l.length === 0 ? null : Pe(e, d, s, l, t), [e, d, s, l, t]), h = k.useMemo(() => {
        const c = new Map;
    ...
    return r.jsxs("div", {
        ...
        children: [r.jsxs("div", {
            ...
            children: [r.jsxs("label", {
                ...
                children: a === "buy" ? "Hit = signal reached upside target" : "Hit = signal reached downside target"
            })]
        }), r.jsx("div", {
                ...
                children: [r.jsx("thead", {
                    ...
                    children: [w.length === 0 && r.jsx("tr", {
                        children: r.jsxs("td", {
                            ...
                            children: ["No features have enough hit AND miss samples (≥ ", u, " each). Try lowering Min n, or pick a horizon with more hits."]
                        })
                    }), w.map(c => {
                            ...
                            children: [r.jsx("td", {
                                ...
                                children: r.jsxs("div", {
                                    ...
                                    children: [r.jsx("span", {
                                        ...
                                        children: c.feature.category.split("-")[0].slice(0, 4)
                                    }), r.jsx("span", {
                                ...
                                children: r.jsx("button", {
                                    ...
                                    disabled: l.length >= 3 || l.some(E => E.featureId === c.feature.id),
                                    onClick: () => I(c.feature.id, c.hitMedian),
                                    title: l.length >= 3 ? "Max 3 filters" : "Add this indicator as a filter",
                                    children: "+ filter"
                                })
                            })]
                        }, c.feature.id)
                ...
                children: [l.map((c, f) => {
                    ...
                    return p ? r.jsxs("div", {
                        ...
                        children: [f > 0 && r.jsx("span", {
                            ...
                            className: "text-muted-foreground",
                            children: ["(", p.format === "pct" ? "decimal — 0.05 = 5%" : p.format === "bp" ? "bp" : p.format === "z" ? "stdevs" : p.format === "ratio" ? "× multiple" : "raw", ")"]
                        }), S && r.jsxs("span", {
                            className: "text-muted-foreground",
                            children: ["hit median ", $(S.hitMedian, p.format, p.decimals), " · miss median ", $(S.missMedian, p.format, p.decimals)]
                        }), r.jsx("button", {
                    ...
                    children: [r.jsxs("div", {
                        ...
                        children: [r.jsx("div", {
                            ...
                            className: b.lift >= 1.2 ? "text-emerald-400 font-bold" : b.lift >= 1 ? "text-yellow-300" : "text-rose-300",
                            children: [b.lift.toFixed(2), "×"]
                        })]
                    })]
                }), b && b.retained < 5 && r.jsxs("div", {
                    className: "text-[10px] text-yellow-400 italic",
                    children: ["⚠ Only ", b.retained, " signals retained — too few for any conclusion. Loosen the rule(s) or pick a coarser threshold."]
                })]
            })]
        }), r.jsxs("details", {
...
const qe = ["P/FFO FY2", "FFO Yield FY2", "Dividend Yield", "EV/EBITDA FY2", "FY1 EPS Growth", "FY2 FFO Growth", "FFO FY2", "% off 52wk High", "% off 52wk Low", "Short Interest%", "Buy Ratings", "Hold Ratings", "Sell Ratings", "Bull%", "Bear%"],
    X = ["DGS10", "DGS2", "SPREAD_10Y_2Y", "BAMLC0A0CM", "BAMLH0A0HYM2", "VIXCLS", "DFII10", "T10YIE"];
...
function We({
    ...
    return e >= .55 ? t = "bg-emerald-500/15 text-emerald-300 border-emerald-500/30" : e >= .4 && (t = "bg-amber-500/15 text-amber-300 border-amber-500/30"), r.jsx("span", {
...
function Ge({
    ...
    return t >= 2 ? n = "text-emerald-400 font-semibold" : t >= 1.5 && (n = "text-amber-300"), r.jsx("span", {
        className: n,
        children: $e(e)
    })
}
...
function Ke({
    ...
    const {
        ...
        yToPx: j,
        yTicks: N
    } = o, b = a.map((c, f) => `${f===0?"M":"L"}${g(f)},${j(c.cumReturn)}`).join(" "), h = a[a.length - 1].cumReturn, w = h >= 0 ? "rgb(52 211 153)" : "rgb(248 113 113)", A = h >= 0 ? "rgba(52,211,153,0.12)" : "rgba(248,113,113,0.12)", R = j(0), I = `${a.map((f,p)=>`${p===0?"M":"L"}${g(p)},${j(f.cumReturn)}`).join(" ")} L${g(a.length-1)},${R} L${g(0)},${R} Z`, C = (() => {
            ...
            children: [r.jsxs("div", {
                ...
                children: [r.jsxs("div", {
                    ...
                    children: [r.jsx("div", {
                        ...
                        children: [e.firstSignalDate ?? "—", " → ", e.lastSignalDate ?? "—"]
                    })]
                })]
            }), r.jsx(Ze, {
                rows: e.rows
...
function Xe({
    ...
    const [t, n] = k.useState(!1), [s, a] = k.useState("date"), [o, d] = k.useState("asc"), m = k.useMemo(() => {
        const l = [...e];
        return l.sort((x, F) => {
            let y, g;
            return s === "date" ? (y = x.num, g = F.num) : (y = x.returns[s] ?? -1 / 0, g = F.returns[s] ?? -1 / 0), o === "asc" ? y - g : g - y
        }), l
    }, [e, s, o]);
...
`),
        ...
        g.href = URL.createObjectURL(y), g.download = `signals_${new Date().toISOString().slice(0,10)}.csv`, g.click(), URL.revokeObjectURL(g.href)
    }
        ...
        children: [r.jsxs("button", {
            ...
            children: [r.jsxs("span", {
                ...
                children: [r.jsx("span", {
                    ...
                    children: t ? "▼" : "▶"
                }), "Per-signal detail · ", e.length, " signal", e.length === 1 ? "" : "s"]
            }), r.jsx("span", {
                className: "text-muted-foreground",
                    ...
                    children: [r.jsx("thead", {
                        ...
                        children: r.jsxs("tr", {
                            ...
                            children: [r.jsxs("th", {
                                ...
                                children: [l.label, s === l.label ? o === "asc" ? " ↑" : " ↓" : ""]
                            }, l.label))]
                        })
                    }), r.jsx("tbody", {
                        children: m.map(l => r.jsxs("tr", {
                            ...
                            children: [r.jsx("td", {
                                ...
                                const g = F >= 0 ? "text-emerald-300" : "text-red-300";
                                return r.jsxs("td", {
                                    className: "text-right px-2 py-1",
                                    children: [r.jsx("span", {
                                        className: g,
                                        children: (F >= 0 ? "+" : "") + (F * 100).toFixed(2) + "%"
                                    }), y && r.jsx("span", {
