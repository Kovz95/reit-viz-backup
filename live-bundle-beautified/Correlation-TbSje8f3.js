const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["./index-CsG73Aq_.js", "./index-B6yc4oNj.css"]))) => i.map(i => d[i]);
import {
    c as lt,
    bp as Fe,
    r as y,
...
function Ve(t) {
    ...
    for (let r = 1; r < t.length; r++) {
        const i = t[r - 1],
            c = t[r];
        Number.isFinite(i) && Number.isFinite(c) && i > 0 && c > 0 ? o.push(Math.log(c / i)) : o.push(NaN)
    }
    return o
}
...
function ie(t, o) {
    ...
    for (let j = 0; j < r; j++) {
        const g = t[j],
            k = o[j];
        !Number.isFinite(g) || !Number.isFinite(k) || (c += g, u += k, s += g * k, a += g * g, n += k * k, i++)
    }
    if (i < 3) return 0;
    const l = c / i,
        h = u / i,
...
function pe(t) {
    const r = [.9999999999998099, 676.5203681218851, -1259.1392167224028, 771.3234287776531, -176.6150291621406, 12.507343278686905, -.13857109526572012, 9984369578019572e-21, 15056327351493116e-23];
...
function Vt(t, o, r) {
    ...
    for (let l = 0; l < 200; l++) {
        ...
        n = 1 + h * n, Math.abs(n) < 1e-30 && (n = 1e-30), a = 1 + h / a, Math.abs(a) < 1e-30 && (a = 1e-30), n = 1 / n;
        const f = n * a;
...
function Be(t, o) {
    ...
    const b = Math.sqrt(g * k[1][a + 1]),
        C = b > 0 ? m / b : 0;
    let F;
    return C <= -3.43 ? F = .005 : C <= -2.86 ? F = .01 + (C - -3.43) / (-2.86 - -3.43) * (.05 - .01) : C <= -2.57 ? F = .05 + (C - -2.86) / (-2.57 - -2.86) * (.1 - .05) : C <= -1.94 ? F = .1 + (C - -2.57) / (-1.94 - -2.57) * (.3 - .1) : C <= -1.62 ? F = .3 + (C - -1.94) / (-1.62 - -1.94) * (.5 - .3) : F = .5 + Math.min(.49, (C - -1.62) * .15), F = Math.max(.001, Math.min(.99, F)), {
...
function Et(t, o) {
    ...
    const m = Be(x);
    let j;
    return m.stat <= -3.9 ? j = .005 : m.stat <= -3.34 ? j = .01 + (m.stat - -3.9) / (-3.34 - -3.9) * (.05 - .01) : m.stat <= -3.04 ? j = .05 + (m.stat - -3.34) / (-3.04 - -3.34) * (.1 - .05) : m.stat <= -2.03 ? j = .1 + (m.stat - -3.04) / (-2.03 - -3.04) * (.5 - .1) : j = .5 + Math.min(.49, (m.stat - -2.03) * .1), j = Math.max(.001, Math.min(.99, j)), {
        stat: m.stat,
...
async function Wt(t, o, r, i) {
    ...
    let a, n, l;
    i === "returns" ? (a = Ve(s.valuesA), n = Ve(s.valuesB), l = s.dates.slice(1)) : i === "changes" ? (a = $e(s.valuesA), n = $e(s.valuesB), l = s.dates.slice(1)) : (a = s.valuesA, n = s.valuesB, l = s.dates);
    const h = ie(a, n),
        f = It(a, n),
        d = tt(a, n, h),
    ...
    for (let w = -20; w <= 20; w++) {
        let V, D;
        w >= 0 ? (V = a.slice(w), D = n.slice(0, n.length - w)) : (V = a.slice(0, a.length + w), D = n.slice(-w));
...
async function Dt(t, o, r) {
    ...
    const n = [];
    for (const f of a) o === "returns" ? n.push(Ve(f)) : o === "changes" ? n.push($e(f)) : n.push(f);
    const l = [],
        h = [];
...
function fe(t) {
    return t >= .7 ? "#22c55e" : t >= .5 ? "#86efac" : t >= .3 ? "#f59e0b" : t >= .15 ? "#94a3b8" : "#475569"
}
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("span", {
                children: [r === "load" ? "Loading factor data" : "Scanning factors", ": ", t, " / ", o]
            }), e.jsxs("span", {
                children: [i, "%"]
            })]
        }), e.jsx("div", {
        ...
        children: [e.jsxs("table", {
            ...
            children: [e.jsx("thead", {
                children: e.jsx("tr", {
                    ...
                    children: ["#", "Factor", "Category", "Best |ρ|", "Spearman", "Window", "Lag", "Stability", "p-val", "Sparkline", "Action"].map(s => e.jsx("th", {
                ...
                children: u.map((s, a) => e.jsxs("tr", {
                    ...
                    children: [e.jsx("td", {
                        ...
                        className: "px-2 py-1 whitespace-nowrap text-muted-foreground",
                        children: s.bestLag === 0 ? "0" : s.bestLag > 0 ? `+${s.bestLag}d` : `${s.bestLag}d`
                    }), e.jsx("td", {
                        className: "px-2 py-1 whitespace-nowrap",
                        style: {
...
function Ht({
    ...
    const [r, i] = y.useState("SPG"), [c, u] = y.useState(!1), [s, a] = y.useState("1d"), [n, l] = y.useState(!0), [h, f] = y.useState(!0), [d, x] = y.useState(60), [m, j] = y.useState(!1), [g, k] = y.useState(null), [b, C] = y.useState(null), [F, p] = y.useState(null), [N, M] = y.useState(!1), A = y.useRef(null), O = Ae().length > 0, T = y.useCallback(async () => {
        if (m) {
            A.current?.abort(), j(!1);
            return
        }
        ...
        R.href = I, R.download = `driver_scan_${b.ticker}_${b.targetMode}.csv`, R.click(), URL.revokeObjectURL(I)
    }, [b]), E = y.useCallback(S => {
        let $;
    ...
    return y.useMemo(() => t.find(S => S.ticker === r), [t, r]), e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                        ...
                        children: [e.jsxs(_e, {
                            children: [e.jsx(qe, {
                                ...
                                children: [e.jsx(Ke, {
                                    ...
                                    }, S.ticker)), r && !t.find(S => S.ticker === r) && e.jsxs(Oe, {
                                        value: r,
                                        onSelect: () => u(!1),
                                        className: "text-[11px]",
                                        children: [e.jsx("span", {
                            ...
                            children: e.jsx(Ee, {
                                ...
                                value: r,
                                onChange: S => i(S.target.value.toUpperCase().trim()),
                                onKeyDown: S => {
                                    S.key === "Enter" && u(!1)
                                }
                            })
                ...
                children: [b.rows.length, " factors found · ", b.totalFactors, " scanned · ", b.durationMs, "ms"]
            })]
        }), e.jsxs("div", {
...
function be(t) {
    return t >= .7 ? "#22c55e" : t >= .3 ? "#86efac" : t >= -.3 ? "#94a3b8" : t >= -.7 ? "#fca5a5" : "#ef4444"
}
            ...
            children: [e.jsx("thead", {
                ...
                children: t.map((i, c) => e.jsxs("tr", {
                    children: [e.jsx("td", {
                        ...
                        style: {
                            backgroundColor: c === s ? "rgba(255,255,255,0.05)" : Qt(u)
                        },
...
function xe({
    ...
    return y.useEffect(() => {
        ...
        s.clearRect(0, 0, l, h);
        const m = f.top + x / 2;
        s.strokeStyle = "rgba(255,255,255,0.15)", s.lineWidth = 1, s.beginPath(), s.moveTo(f.left, m), s.lineTo(l - f.right, m), s.stroke();
        const j = 1 / Math.sqrt(o),
            g = m - 1.96 * j * (x / 2),
            k = m + 1.96 * j * (x / 2);
        s.strokeStyle = "rgba(239, 68, 68, 0.3)", s.setLineDash([4, 4]), s.beginPath(), s.moveTo(f.left, g), s.lineTo(l - f.right, g), s.stroke(), s.beginPath(), s.moveTo(f.left, k), s.lineTo(l - f.right, k), s.stroke(), s.setLineDash([]);
        const b = Math.max(3, d / t.length - 2);
        t.forEach((C, F) => {
            const p = f.left + F / t.length * d + (d / t.length - b) / 2,
                N = C.value * (x / 2),
                M = C.value >= 0 ? m - N : m;
            s.fillStyle = Math.abs(C.value) > 1.96 * j ? "#0ea5e9" : "rgba(14, 165, 233, 0.4)", s.fillRect(p, M, b, Math.abs(N))
        }), s.fillStyle = "#7a8a9e", s.font = "9px 'JetBrains Mono', monospace", s.textAlign = "right", s.fillText("1.0", f.left - 4, f.top + 6), s.fillText("0", f.left - 4, m + 3), s.fillText("-1.0", f.left - 4, h - f.bottom), s.textAlign = "center";
...
function Zt({
    ...
    return y.useEffect(() => {
        ...
        a.clearRect(0, 0, h, f);
        const j = d.top + m / 2;
        a.strokeStyle = "rgba(255,255,255,0.15)", a.lineWidth = 1, a.beginPath(), a.moveTo(d.left, j), a.lineTo(h - d.right, j), a.stroke();
        const g = t.findIndex(b => b.lag === 0);
        if (g >= 0) {
            const b = d.left + (g + .5) / t.length * x;
            a.strokeStyle = "rgba(255,255,255,0.2)", a.beginPath(), a.moveTo(b, d.top), a.lineTo(b, f - d.bottom), a.stroke()
        }
        ...
        t.forEach((b, C) => {
            const F = d.left + C / t.length * x + (x / t.length - k) / 2,
                p = b.value * (m / 2),
                N = b.value >= 0 ? j - p : j;
            a.fillStyle = b.lag === 0 ? "#f59e0b" : b.value >= 0 ? "rgba(34, 197, 94, 0.6)" : "rgba(239, 68, 68, 0.6)", a.fillRect(F, N, k, Math.abs(p))
        }), a.fillStyle = "#7a8a9e", a.font = "9px 'JetBrains Mono', monospace", a.textAlign = "right", a.fillText("1.0", d.left - 4, d.top + 6), a.fillText("0", d.left - 4, j + 3), a.fillText("-1.0", d.left - 4, f - d.bottom), a.textAlign = "center";
        for (let b = 0; b < t.length; b += 5) {
            const C = d.left + (b + .5) / t.length * x;
            a.fillText(String(t[b].lag), C, f - 4)
        }
        a.font = "8px 'JetBrains Mono', monospace", a.fillStyle = "#94a3b8", a.textAlign = "left", a.fillText(`← ${o} leads`, d.left + 2, f - d.bottom + 14), a.textAlign = "right", a.fillText(`${r} leads →`, h - d.right - 2, f - d.bottom + 14)
...
function es({
    ...
    return y.useEffect(() => {
        ...
        if (C < 0 && F > 0) {
            const R = L(0);
            l.strokeStyle = "rgba(255,255,255,0.15)", l.lineWidth = 1, l.beginPath(), l.moveTo(R, m.top), l.lineTo(R, x - m.bottom), l.stroke()
        }
        if (p < 0 && N > 0) {
            const R = E(0);
            l.strokeStyle = "rgba(255,255,255,0.15)", l.lineWidth = 1, l.beginPath(), l.moveTo(m.left, R), l.lineTo(d - m.right, R), l.stroke()
        }
        const X = C - O,
            S = F + O,
            $ = c + i * X,
            I = c + i * S;
        l.strokeStyle = "rgba(245, 158, 11, 0.6)", l.lineWidth = 1.5, l.setLineDash([6, 3]), l.beginPath(), l.moveTo(L(X), E($)), l.lineTo(L(S), E(I)), l.stroke(), l.setLineDash([]), t.forEach(R => {
            l.beginPath(), l.arc(L(R.x), E(R.y), 2.5, 0, Math.PI * 2), l.fillStyle = "rgba(14, 165, 233, 0.5)", l.fill()
        }), l.fillStyle = "#7a8a9e", l.font = "9px 'JetBrains Mono', monospace", l.textAlign = "center", l.fillText(o, m.left + j / 2, x - 4), l.textAlign = "right";
        for (let R = 0; R <= 4; R++) {
...
function Me({
    ...
    const [s, a] = y.useState(!1), [n, l] = y.useState(o.startsWith("MACRO:") ? "macro" : "stock"), [h, f] = y.useState(() => o.startsWith("MACRO:") ? "" : o.split(":")[0] || ""), [d, x] = y.useState(() => o.startsWith("MACRO:") ? o.replace("MACRO:", "") : o.split(":").slice(1).join(":") || "close"), [m, j] = y.useState(!1), g = y.useMemo(() => {
        const b = {};
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsxs(Re, {
                        ...
                        children: [e.jsx(Z, {
                            ...
                            children: [Object.entries(st).map(([b, C]) => e.jsxs("div", {
                                children: [e.jsx("div", {
...
function xs() {
    const [t, o] = y.useState("pairwise"), [r, i] = y.useState("SPG:close"), [c, u] = y.useState("MACRO:DGS10"), [s, a] = y.useState("returns"), [n, l] = y.useState("60"), [h, f] = y.useState(new Set([60, 252])), [d, x] = y.useState(() => new Set(Ie)), [m, j] = y.useState(["SPG:close", "O:close", "PLD:close", "PSA:close", "MACRO:DGS10", "MACRO:VIXCLS"]), [g, k] = y.useState("returns"), [b, C] = y.useState("252"), [F, p] = y.useState(""), N = y.useCallback(v => {
        f(Y => {
            const B = new Set(Y);
    ...
    } = dt(), [E, X] = y.useState("returns"), [S, $] = y.useState("252"), [I, R] = y.useState("close"), z = y.useCallback(() => ({
        activeTab: t,
        specA: r,
        specB: c,
        corrMode: s,
        ...
        if (v.activeTab !== void 0 && o(v.activeTab), v.specA !== void 0 && i(v.specA), v.specB !== void 0 && u(v.specB), v.corrMode !== void 0 && a(v.corrMode), v.corrWindow !== void 0 && l(v.corrWindow), v.matrixSpecs !== void 0 && j(v.matrixSpecs), v.matrixMode !== void 0 && k(v.matrixMode), v.matrixWindow !== void 0 && C(v.matrixWindow), v.visibleWindows !== void 0 && f(new Set(v.visibleWindows)), Array.isArray(v.visibleCorrCharts)) {
            const Y = v.visibleCorrCharts.filter(B => typeof B == "string" && Ie.includes(B));
            x(new Set(Y))
        }
        v.uniMode !== void 0 && X(v.uniMode), v.uniWindow !== void 0 && $(v.uniWindow), v.uniMetric !== void 0 && R(v.uniMetric)
    }, []), je = At();
    ut("correlation", z, ue, {
        universeSig: je,
    ...
    const {
        ...
        queryFn: Ft
    }), q = y.useMemo(() => A && M ? L.map(v => `${v.ticker}:${I}`) : K.map(v => `${v.ticker}:${I}`), [M, A, L, K, I]), {
        data: J,
        isLoading: w
    } = ce({
...
`),
        ...
        H.href = ne, H.download = `correlation_${G(r)}_${G(c)}.csv`, H.click(), URL.revokeObjectURL(ne)
...
`),
            ...
            H = URL.createObjectURL(ne),
            _ = document.createElement("a");
        _.href = H, _.download = "universe_correlation_matrix.csv", _.click(), URL.revokeObjectURL(H)
            ...
            children: [e.jsx("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("div", {
                        ...
                        children: [{
                            label: "REITs + Rates",
                            specs: ["SPG:close", "O:close", "PLD:close", "PSA:close", "MACRO:DGS10", "MACRO:DGS2", "MACRO:MORTGAGE30US"]
                        }, {
                            label: "REITs + Housing",
                            specs: ["EQR:close", "AVB:close", "MAA:close", "CPT:close", "MACRO:HOUST5F", "MACRO:PERMIT5", "MACRO:COMPU"]
                        }, {
                            label: "REITs + Macro",
                            specs: ["SPG:close", "O:close", "PLD:close", "MACRO:DGS10", "MACRO:VIXCLS", "MACRO:CPIAUCSL", "MACRO:UNRATE"]
                        }, {
                            label: "Net Lease",
                            specs: ["O:close", "NNN:close", "EPRT:close", "ADC:close", "MACRO:DGS10"]
                        }].map(v => e.jsx(W, {
                            variant: "ghost",
                            size: "sm",
                            className: "h-5 px-2 text-[10px]",
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("div", {
                        ...
                        children: A ? `Filtered from ${T} total` : "All tickers (no filter)"
                    })]
                }), e.jsxs("div", {
                    className: "space-y-1",
                    children: [e.jsx("div", {
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx("div", {
            ...
            children: [{
                ...
                sub: t.diagnostics?.fisherCI ? `95% CI [${t.diagnostics.fisherCI.lower.toFixed(3)}, ${t.diagnostics.fisherCI.upper.toFixed(3)}]` : void 0
            }, {
                label: "Spearman ρₛ",
            ...
            const x = t.diagnostics,
                m = [];
            return (Math.abs(h.autoCorrelationA) > .3 || Math.abs(h.autoCorrelationB) > .3) && m.push(`High autocorrelation: ${f} AC(1)=${h.autoCorrelationA.toFixed(3)}, ${d} AC(1)=${h.autoCorrelationB.toFixed(3)}. Effective N reduced to ${h.effectiveN}.`), c === "levels" && x.adfA && !x.adfA.isStationary && m.push(`${f} is non-stationary (ADF=${x.adfA.stat.toFixed(2)}, p=${x.adfA.pValue.toFixed(3)}). Level correlation may be spurious.`), c === "levels" && x.adfB && !x.adfB.isStationary && m.push(`${d} is non-stationary (ADF=${x.adfB.stat.toFixed(2)}, p=${x.adfB.pValue.toFixed(3)}). Level correlation may be spurious.`), c === "levels" && x.cointegration && !x.cointegration.isCointegrated && x.adfA && !x.adfA.isStationary && m.push(`No cointegration detected (EG stat=${x.cointegration.stat.toFixed(2)}, p=${x.cointegration.pValue.toFixed(3)}). The level relationship may not represent a stable equilibrium. Consider using Log Returns mode.`), c === "levels" && x.cointegration?.isCointegrated && m.push(`Cointegrated pair (EG p=${x.cointegration.pValue.toFixed(3)}). The spread is mean-reverting — pair/equilibrium analysis is valid.`), c === "returns" && Math.abs(h.correlation - (h.spearmanCorrelation ?? 0)) > .15 && m.push(`Pearson (${h.correlation.toFixed(3)}) and Spearman (${(h.spearmanCorrelation??0).toFixed(3)}) diverge, suggesting nonlinear or outlier-driven relationship.`), m.length === 0 ? null : e.jsx("div", {
            ...
            children: [s.has("levels") && (!n || n === "levels") && e.jsx(ke, {
                ...
                onMaximize: l
            }), s.has("rolling") && t.multiWindowRolling && u.size > 0 && (!n || n === "rolling") && (() => {
            ...
            })(), s.has("rollingBeta") && t.rollingBeta && t.rollingBeta.length > 0 && (!n || n === "rollingBeta") && e.jsx(ke, {
                data: t.rollingBeta,
                color: "#ec4899",
                height: 280,
    ...
    return o ? e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            ...
            children: [e.jsxs("span", {
                ...
                children: t.mode === "returns" ? "Log Returns" : t.mode === "changes" ? "Simple Changes" : "Levels"
            }), e.jsx("span", {
                children: "·"
            }), e.jsxs("span", {
                className: "text-[9px]",
        ...
        className: "flex items-center justify-center h-full text-muted-foreground text-sm",
        children: r < 2 ? "Need at least 2 tickers — apply a Universe filter or load data" : "Loading..."
    })
}
...
function ve({
    ...
    const i = y.useMemo(() => {
        ...
        return r === "positive" ? c.sort((u, s) => s.corr - u.corr).slice(0, 10) : c.sort((u, s) => u.corr - s.corr).slice(0, 10)
    }, [t, o, r]);
    return e.jsxs("div", {
