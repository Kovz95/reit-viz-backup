...
function Zt(r) {
    return r.type === "ma" ? `${r.maType??"MA"} ${r.maPeriod??""}`.trim() : r.type === "fib" ? `Fib ${((r.fibLevel??0)*100).toFixed(1)}%` : "Horizontal"
}
...
function tr({
    ...
    l.useEffect(() => {
        ...
        return n.observe(p), () => {
            n.disconnect(), i.remove(), A.current = null, F.current = null, S.current = [], z.current = []
        }
    }, [v]), l.useEffect(() => {
        const p = F.current;
        if (!p) return;
        ...
        const m = u.find(a => a && a.touches && a.touches.length > 0 && (a.type === "horizontal" || a.type === "fib"));
        if (m) try {
            const a = m.touches.filter(w => w.date).map(w => ({
                time: w.date,
                value: m.price
            })).sort((w, N) => w.time < N.time ? -1 : w.time > N.time ? 1 : 0).filter((w, N, U) => N === 0 || U[N - 1].time !== w.time);
            if (a.length > 0) {
    ...
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsxs("span", {
                children: [y, " ·", " ", u && u.length > 0 ? `${u.length} level${u.length===1?"":"s"} plotted${M}` : "select one or more levels from the table above"]
...
function sr() {
    ...
    const [i, B] = l.useState("single"), [n, h] = l.useState(""), [b, m] = l.useState(""), [a, w] = l.useState(""), [N, U] = l.useState(() => Mt()), [pe, te] = l.useState("workbook"), {
        metas: se
    } = Yt(), [H, _] = l.useState(""), [W, oe] = l.useState(() => new Set), k = 50, O = 500, X = l.useMemo(() => N.economy.size + N.sector.size + N.subsector.size + N.industryGroup.size + N.industry.size + N.subindustry.size + W.size + (H.trim().length > 0 ? 1 : 0) === 0 ? [] : Pt(pe === "global" ? se : r, N, H, W).map(f => f.ticker.toUpperCase()).filter((f, s, c) => c.indexOf(f) === s), [r, se, pe, N, H, W]), he = l.useMemo(() => {
        const e = X.length;
        return e >= 2 ? e * (e - 1) / 2 : 0
    }, [X]), [ne, g] = l.useState([]);
    l.useEffect(() => {
        r.length > 0 && (h(e => e || r[0].ticker), m(e => e || r[0].ticker), w(e => e || (r[1]?.ticker ?? r[0].ticker)))
    }, [r]);
    const [P, re] = l.useState("10y"), [K, le] = l.useState(() => Bt()), [de, ke] = l.useState("daily"), [ae, J] = l.useState(!0), [R, G] = l.useState(!0), [Q, Se] = l.useState(!0), [fe, Ae] = l.useState(.5), [be, Ne] = l.useState(1.5), [Z, E] = l.useState(5), [Y, ge] = l.useState(5), [Le, Qe] = l.useState(3), [Re, Ze] = l.useState(5), [Me, et] = l.useState(5), [Pe, tt] = l.useState(10), [Be, rt] = l.useState(_e.maTypes), [Fe, st] = l.useState(_e.maPeriods), xt = ["SMA", "EMA", "WMA", "HMA", "KAMA", "FRAMA", "T3", "ALMA", "LSMA", "SLSMA"], bt = [10, 20, 50, 100, 150, 200], gt = e => {
        ...
        current: 0,
        total: 0
    }), [me, Ge] = l.useState([]), [ve, Ye] = l.useState([]), [Ke, Ue] = l.useState(null), [He, De] = l.useState({}), ot = l.useCallback((e, d) => {
        De(j => {
        ...
        if (!(!d || d.length === 0)) try {
            ...
            const $ = "Charts",
                D = c && s && s.pairA && s.pairB ? `${s.pairA.toUpperCase()}/${s.pairB.toUpperCase()}` : o;
            console.log(`[SupportResistance] Sent ${d.length} level(s) for ${D} → ${$} tab.`);
            const q = document.createElement("div");
            q.textContent = `Sent ${d.length} level${d.length===1?"":"s"} for ${D} → ${$}`, q.className = "fixed top-4 right-4 z-50 px-3 py-2 rounded bg-cyan-500/20 text-cyan-300 text-xs font-mono border border-cyan-500/40 shadow-lg", document.body.appendChild(q), setTimeout(() => {
                q.remove()
            }, 2500), c && s && s.pairA && s.pairB && Ft(s.pairA.toUpperCase(), s.pairB.toUpperCase())
        } catch (j) {
    ...
    }, [i, n, b, a, ne, N, H, W, P, K, de, ae, R, Q, fe, be, Z, Y, Le, Re, Me, Pe, Be, Fe, we, me, ve, Ke, He, Te]), vt = l.useCallback(e => {
        if (!(!e || typeof e != "object")) {
            if (e.mode && B(e.mode), typeof e.selectedTicker == "string" && h(e.selectedTicker), typeof e.pairTickerA == "string" && m(e.pairTickerA), typeof e.pairTickerB == "string" && w(e.pairTickerB), Array.isArray(e.basketTickers) && g(e.basketTickers), e.pcFiltersSer && typeof e.pcFiltersSer == "object") {
            ...
            if (typeof e.pcClassSearch == "string" && _(e.pcClassSearch), Array.isArray(e.pcManualTickersSer) && oe(new Set(e.pcManualTickersSer)), typeof e.datePreset == "string" && re(e.datePreset), e.dateRange && le(e.dateRange), e.timeframe && ke(e.timeframe), typeof e.enableHorizontal == "boolean" && J(e.enableHorizontal), typeof e.enableMA == "boolean" && G(e.enableMA), typeof e.enableFib == "boolean" && Se(e.enableFib), typeof e.tolerancePct == "number" && Ae(e.tolerancePct), typeof e.bounceThresholdPct == "number" && Ne(e.bounceThresholdPct), typeof e.bounceLookahead == "number" && E(e.bounceLookahead), typeof e.holdBars == "number" && ge(e.holdBars), typeof e.minTouches == "number" && Qe(e.minTouches), typeof e.pivotLeft == "number" && Ze(e.pivotLeft), typeof e.pivotRight == "number" && et(e.pivotRight), typeof e.topN == "number" && tt(e.topN), Array.isArray(e.maTypes) && rt(e.maTypes), Array.isArray(e.maPeriods) && st(e.maPeriods), typeof e.futureBars == "number" && nt(e.futureBars), Array.isArray(e.results) && Ge(e.results), Array.isArray(e.skipped) && Ye(e.skipped), (e.expandedTicker === null || typeof e.expandedTicker == "string") && Ue(e.expandedTicker), e.selIdxs && typeof e.selIdxs == "object") {
                const d = {};
    ...
    const ct = l.useMemo(() => ({
        ...
        St = l.useCallback(async () => {
            ...
            } else i === "basket" ? e = ne.map(s => p.find(o => o.ticker.toUpperCase() === s.toUpperCase()) ?? {
                ticker: s,
                name: s
            }) : e = p;
            if (e.length === 0) {
            ...
            for (let s = 0; s < e.length && !Je.current; s++) {
                ...
                try {
                    ...
                    if (i === "pair" || i === "pairCombo") {
                        ...
                        o = ue.prices, x = ue.prices, $ = ue.prices, D = ue.indices.map(je => f[je] || ""), q = o[o.length - 1]
                    } else {
                        ...
                        o = ee.adjCloses, x = ee.highs.map((je, Ie) => {
                            const xe = ee.closes[Ie],
                                ze = ee.adjCloses[Ie];
                            return xe && xe > 0 && Number.isFinite(xe) && Number.isFinite(ze) ? je * (ze / xe) : je
                        }), $ = ee.lows.map((je, Ie) => {
                            const xe = ee.closes[Ie],
                                ze = ee.adjCloses[Ie];
                            return xe && xe > 0 && Number.isFinite(xe) && Number.isFinite(ze) ? je * (ze / xe) : je
        ...
        Nt = l.useMemo(() => i === "single" ? !!n : i === "pair" ? !!b && !!a && b !== a : i === "pairCombo" ? X.length >= 2 : i === "basket" ? ne.length > 0 : p.length > 0, [i, n, b, a, ne, p, X]);
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: [t.jsxs("div", {
                ...
                children: [t.jsx("label", {
                    ...
                    children: ["single", "universe", "basket", "pair", "pairCombo"].map(e => t.jsx("button", {
            ...
            children: [t.jsx("label", {
                ...
                children: X.length < 2 ? t.jsx(t.Fragment, {
                    ...
                    }), " unordered pairs (A/B == B/A)", " ", he > O && t.jsxs("span", {
            ...
            children: [me.length === 0 && !L && t.jsxs("div", {
                ...
                children: ["Configure settings above and click Run Detection. Tickers with fewer than ", We, " bars will be skipped."]
                    ...
                    return t.jsxs("div", {
                        ...
                        children: [t.jsxs("button", {
                            ...
                            children: [t.jsx("span", {
                                ...
                                children: j ? (j.compositeScore * 100).toFixed(1) : "—"
                            }), t.jsx("span", {
                                className: "font-mono text-[10px] text-muted-foreground",
                            ...
                            children: [t.jsxs("div", {
                                ...
                                children: ["Top ", e.topLevels.length, " levels (of ", e.totalLevels, " total detected):"]
                            }), t.jsxs("table", {
                                ...
                                children: [t.jsx("thead", {
                                    children: t.jsx("tr", {
                                        ...
                                        children: (() => {
                                            const f = o => Te.key === o ? Te.dir === "asc" ? " ▲" : " ▼" : "",
                                                s = "text-left py-1 px-1 cursor-pointer hover:text-foreground select-none",
                                                c = "text-right py-1 px-1 cursor-pointer hover:text-foreground select-none";
                                            return t.jsxs(t.Fragment, {
                                                children: [t.jsx("th", {
                                                    ...
                                                    children: ["Bounce %", f("bounce")]
                                                }), t.jsxs("th", {
                                                    className: c,
                                                    onClick: () => ie("avgBounce"),
                                                    ...
                                                    children: ["Avg Bounce", f("avgBounce")]
                                                }), t.jsxs("th", {
                                                    className: c,
                                                    onClick: () => ie("hold"),
                                    ...
                                    children: (() => {
                                        const f = e.topLevels.map((o, x) => {
                                                const $ = e.currentPrice > 0 ? (o.price - e.currentPrice) / e.currentPrice : 0,
                                                    D = o.price > e.currentPrice;
                                                return {
                                                    level: o,
                                                    originalIdx: x,
                                                    dist: $,
                                        ...
                                        f.sort((o, x) => {
                                            switch (Te.key) {
                                                case "rank":
                                                    return (o.originalIdx - x.originalIdx) * s;
                                                case "type": {
                                                    const $ = Ve(o.level),
                                                        D = Ve(x.level);
                                                    return $.localeCompare(D) * s
                                                }
                                                case "sr":
                                                    return ((o.isResistance ? 1 : 0) - (x.isResistance ? 1 : 0)) * s;
                                                case "price":
                                                    return (o.level.price - x.level.price) * s;
                                                case "dist":
                                                    return (o.dist - x.dist) * s;
                                                case "touches":
                                                    return (o.level.touchCount - x.level.touchCount) * s;
                                                case "bounce":
                                                    return (o.level.bounceReverseRate - x.level.bounceReverseRate) * s;
                                                case "avgBounce":
                                                    return (o.level.avgBounceMagnitudePct - x.level.avgBounceMagnitudePct) * s;
                                                case "hold":
                                                    return (o.level.holdRate - x.level.holdRate) * s;
                                                case "days": {
                                                    const $ = o.level.daysSinceLastTouch ?? Number.POSITIVE_INFINITY,
                                                        D = x.level.daysSinceLastTouch ?? Number.POSITIVE_INFINITY;
                                                    return ($ - D) * s
                                                }
                                                case "score":
                                                    return (o.level.compositeScore - x.level.compositeScore) * s
                                            }
                                        });
                                        const c = He[e.ticker] ?? new Set([0]);
                                        return f.map(({
                                            level: o,
                                            originalIdx: x,
                                            dist: $,
                                            ...
                                            return t.jsxs("tr", {
                                                ...
                                                children: [t.jsx("td", {
                                                    ...
                                                    className: "py-1 px-1 text-right",
                                                    children: [(o.bounceReverseRate * 100).toFixed(1), "%"]
                                                }), t.jsxs("td", {
                                                    className: "py-1 px-1 text-right",
                                                    children: [o.avgBounceMagnitudePct.toFixed(2), "%"]
                                                }), t.jsxs("td", {
                                                    className: "py-1 px-1 text-right",
                                                    children: [(o.holdRate * 100).toFixed(1), "%"]
                                                }), t.jsx("td", {
                                                    ...
                                                    children: t.jsx("span", {
                                                        ...
                                                        style: {
                                                            backgroundColor: dt(o.compositeScore)
                                                        },
                                                    ...
                                                    children: t.jsx("button", {
                                                        onClick: ce => {
                                                            ce.stopPropagation(), at(e.ticker, [o])
                                                        },
                                ...
                                children: (() => {
                                    const f = He[e.ticker] ?? new Set([0]),
                                        s = Array.from(f).sort((c, o) => c - o).map(c => e.topLevels[c]).filter(c => !!c);
                                    return t.jsxs(t.Fragment, {
                                        children: [t.jsxs("div", {
                                            ...
                                            children: [t.jsxs("div", {
                                                ...
                                                children: [t.jsxs("span", {
                                                    className: "text-muted-foreground",
                                                    children: ["Plotting ", s.length, " of ", e.topLevels.length]
                                                }), t.jsx("button", {
                                                    onClick: () => De(c => ({
                                                        ...c,
                                                        [e.ticker]: new Set(e.topLevels.map((o, x) => x))
                                                    })),
                                                ...
                                                children: [t.jsx("label", {
                                                    ...
                                                    max: 500,
                                                    value: we,
                                                    onChange: c => nt(Math.max(0, Math.min(500, parseInt(c.target.value) || 0))),
