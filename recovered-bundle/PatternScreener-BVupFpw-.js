...
function as() {
  try {
    ...
    return {
      ...
      channelLookbacks: Array.isArray(n?.channelLookbacks) && n.channelLookbacks.length > 0 ? n
        .channelLookbacks : R.channelLookbacks
    }
  } catch {
    return {
      ...R
...
function vs() {
  const [, a] = Fe(), [n, D] = l.useState([]), [u, Be] = l.useState("universe"), [Y, Me] = l
    .useState("latest"), [r, p] = l.useState(() => as()), [y, Z] = l.useState(""), [A, ee] = l
    .useState(""), [F, se] = l.useState(""), {
      baskets: w
    } = _e(), [_, te] = l.useState(""), P = Xe(n, u === "universe", "ps-clf"), I = Ze(n.map(s => s
      .ticker), u === "pairCombo", "ps-pc"), [v, H] = l.useState([]), [B, ae] = l.useState(!1), [ne,
      re
    ] = l.useState({
      done: 0,
      total: 0
  ...
  l.useEffect(() => {
    ...
    Ie().then(s => {
      D(s), s.length > 0 && (y || Z(s[0].ticker), ee(t => t || s[0].ticker), se(t => t || (
  ...
  const N = l.useMemo(() => {
    ...
    $ = l.useMemo(() => {
      ...
      for (const t of v) {
        ...
        for (const x of i) x.confidence < r.minConfidence || r.maxAgeBars > 0 && x.ageBars > r
          .maxAgeBars || os(x.direction, r.directionFilter) && s.push(x)
      }
      return s
    ...
    U = l.useMemo(() => {
      ...
      return s.sort((i, x) => {
        ...
        return typeof h == "string" && typeof c == "string" ? t * h.localeCompare(c) : t * (
          h - c)
      }), s
    }, [$, O, q]),
    C = s => {
    ...
    children: [e.jsxs("div", {
      ...
      children: [e.jsxs(be, {
        children: [e.jsx(ge, {
          ...
          children: [u === "single" && e.jsx("div", {
            ...
            children: [e.jsx(M, {
              ...
              children: [P.filteredTickers.length,
                " tickers selected"
              ]
            })]
          }), u === "pair" && e.jsxs("div", {
            ...
            children: [I.ui, e.jsxs("div", {
              className: "text-[11px] text-muted-foreground",
              children: [I.cappedPairCount, " pairs ", I.capped &&
                e.jsx("span", {
        ...
        children: [e.jsxs(ge, {
          ...
          children: [e.jsxs(fe, {
            className: "text-xs",
            children: ["Results · ", U.length, " hit", U.length === 1 ?
              "" : "s", B && e.jsxs("span", {
            ...
            className: "text-[11px] text-muted-foreground",
            children: [b.ok, " ok · ", b.sk, " skipped · ", b.err,
              " errors · ", b.totalHits, " raw hits", b.totalHits >
              0 && b.filteredHits < b.totalHits && e.jsxs("span", {
                className: "ml-1 text-amber-400",
                children: ["(", b.totalHits - b.filteredHits,
                  " filtered)"
                ]
              })
            ]
          ...
          children: [ie && e.jsxs("div", {
            ...
            children: [e.jsxs("table", {
                  ...
                  "tr", {
                    children: e.jsx("td", {
                      ...
                      children: v.length === 0 ?
                        ...
                        b.totalHits > 0 ?
                        `No hits match the current filters. ${b.totalHits} raw hits were found — try lowering Min confidence, raising Max age, or switching Direction to Any.` :
              ...
              children: [v.filter(s => s.status === "error")
                .slice(0, 10).map(s => e.jsxs("div", {
                  className: "text-rose-400/80",
                  children: ["err · ", s.ticker, ": ", s
                    .errorMsg
                  ]
                }, s.ticker)), v.filter(s => s.status ===
                  "skipped").slice(0, 5).map(s => e.jsxs(
                "div", {
                  children: ["skip · ", s.ticker, ": ", s
                    .errorMsg
                  ]
                }, s.ticker))
              ]
