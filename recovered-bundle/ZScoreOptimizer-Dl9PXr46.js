...
const Bt = [21, 42, 63, 126, 189, 252, 378, 504, 756, 1260],
  ...
  gr = ["close", "P/E LTM", "P/E FY2", "P/FFO LTM", "P/FFO FY2", "P/AFFO LTM", "P/AFFO FY2",
    "P/S LTM", "P/S FY2", "EV/EBITDA LTM", "EV/EBITDA FY2", "FFO Yield LTM", "FFO Yield FY2",
    "AFFO Yield LTM", "AFFO Yield FY2", "Dividend Yield", "Implied Cap Rate", "Short Interest%"
  ];
...
function hr(z, ve, k, A, h, F, o, E = "breakout", R, ee) {
  ...
  const ge = _e(B ? y : Q, "buy"),
    ...
    M = Le(V, "sell", J);
  let pe, D, xe, U;
  E === "both" && (pe = _e(Q, "buy"), D = _e(ue, "sell"), xe = Le(pe, "buy", J), U = Le(D, "sell",
    J));
  let ae = ((ge?.count ?? 0) > 0 ? 1 : 0) + ((V?.count ?? 0) > 0 ? 1 : 0),
    q = Ne.score + M.score;
  E === "both" && ((pe?.count ?? 0) > 0 && (ae++, q += xe.score), (D?.count ?? 0) > 0 && (ae++, q +=
    U.score));
...
function Ar() {
  const [z, ve] = a.useState([]), [k, A] = a.useState("P/FFO LTM"), [h, F] = a.useState(""), [o,
    E] = a.useState("single"), [R, ee] = a.useState([]), [W, J] = et("zscore-basket-mode",
    "stocks"), {
      baskets: B
    } = qt(), [v, te] = a.useState(""), [y, le] = a.useState(""), [Q, ue] = a.useState(-2), [I,
    ge] = a.useState(2), [V, Ne] = a.useState("threshold"), [M, pe] = a.useState("breakout"), [D,
      xe] = a.useState(.05), [U, ae] = a.useState(.05), [q, we] = a.useState(.1), [_, P] = a
    .useState("10y"), [m, he] = a.useState(() => Kt()), [S, ke] = a.useState(!1), [me, at] = a
    .useState({
      current: 0,
      total: 0
    }), [K, Be] = et("zscore:results", []), [Me, Oe] = a.useState(null), [ye, Ve] = a.useState(
      "bestScore"), [Ye, Pt] = a.useState("composite"), He = a.useMemo(() => Gt(Ye), [Ye]), [it,
    zt] = a.useState(new Set), At = a.useCallback(e => {
      zt(l => {
        const r = new Set(l);
        return r.has(e) ? r.delete(e) : r.add(e), r
      })
    }, []), Ze = a.useRef(!1), ct = a.useRef(!1), [Pe, dt] = a.useState("optimize"), [ie, ut] = a
    .useState("long"), [ze, pt] = et("zscore:evalResult", null), [Ae, xt] = a.useState(null), [Ue,
      $] = a.useState(!1), [ce, Ft] = a.useState("breakout"), [Se, Et] = a.useState(63), [je, Dt] =
    a.useState(2), [qe, Wt] = a.useState(0), {
      universeTickers: Ke,
      isFiltered: It
    } = Jt(), j = a.useMemo(() => Ke ? z.filter(e => Ke.has(e.ticker)) : z, [z, Ke]), Fe = ir(j,
      o === "universe", "zs-clf"), _t = Fe.filteredTickers, be = cr(z, o === "pairCombo",
    "zs-pc"), {
      frequency: Ce,
      setFrequency: Ge,
      frequencyUI: Lt
  ...
  a.useEffect(() => {
    Qt().then(e => {
      ve(e), e.length > 0 && !ct.current && F(e[0].ticker), e.length > 0 && (te(l => l || e[
        0].ticker), le(l => l || (e[1]?.ticker ?? e[0].ticker)))
    })
  }, []), a.useEffect(() => {
    j.length > 0 && h && z.some(e => e.ticker === h) && !j.find(e => e.ticker === h) && F(j[0]
      .ticker)
  }, [j, h, z]);
  const Ot = a.useCallback(async () => {
      ...
      for (let s = 0; s < l.length && !Ze.current; s++) {
        ...
        try {
          ...
          if (o === "pair" || o === "pairCombo") {
            ...
            i = p.indices.slice(), C = p.prices.slice(), u = p.prices.slice(), re = i.map(Z =>
              e[Z] || "")
          } else if (r) {
            ...
            if (u = C.slice(), re = i.map(p => e[p] || ""), console.log(
                "[ZScore Combined] aligned: allIndices.length=", i.length,
                "workbookDates.length=", e.length, "first wb date=", e[0], "last wb date=", e[e
                  .length - 1]), i.length < 50) {
            ...
            for (let O = 0; O < N.adjCloses.length; O++) {
              ...
              fe != null && fe >= 0 && oe.has(fe) && (i.push(fe), u.push(oe.get(fe)), C.push(N
                .adjCloses[O]))
            }
          ...
          if (g.length === 0) {
            r && console.warn(
              "[ZScore Combined] skipped: windowResults.length==0; metricValues.length=", L
              .length);
            continue
          }
          r && console.log("[ZScore Combined] windowResults built:", g.length,
            "metricValues.length=", L.length);
          const X = g.reduce((c, w) => c.compositeScore > w.compositeScore ? c : w);
          for (const c of g) c.window !== X.window && (c.buyProfiles = void 0, c.sellProfiles =
            void 0, c.buyRevProfiles = void 0, c.sellRevProfiles = void 0);
          const T = i.map(c => e[c] || ""),
            H = {
              prices: C,
              highs: C.slice(),
    ...
    Vt = a.useCallback(async () => {
      ...
      try {
        ...
        if (o === "pair") {
          ...
          r = f.indices.slice(), n = f.prices.slice(), d = f.prices.slice(), s = r.map(g => e[
            g] || "")
        } else if (o === "basket") {
          if (R.length === 0) {
            $(!1);
          ...
          if (W === "combined") {
            ...
            for (let b = 0; b < p.adjCloses.length; b++) {
              const N = oe.get(Z[b]);
              N != null && N >= 0 && c.has(N) && (r.push(N), d.push(c.get(N)), n.push(p
                .adjCloses[b]))
            }
            if (r.length < 50) {
              $(!1);
          ...
          for (let b = 0; b < p.adjCloses.length; b++) {
            const N = oe.get(Z[b]);
            N != null && N >= 0 && c.has(N) && (r.push(N), d.push(c.get(N)), n.push(p.adjCloses[
              b]))
          }
          if (r.length < 50) {
            $(!1);
        ...
        for (let f = 0; f < x.length; f++) {
          ...
          Y !== null && (i && Y >= de && g < de && re.push(f), i && Y <= L && g > L && se.push(
              f), u && Y < de && g >= de && re.push(f), u && Y > L && g <= L && se.push(f)), Y =
            g
        }
    ...
    ft = a.useMemo(() => o === "pair" ? `${v||"A"}/${y||"B"}` : o === "single" ? h || "—" : j[0]
      ?.ticker || "—", [o, v, y, h, j]),
    Yt = a.useCallback(() => ({
      selectedMetric: k,
      selectedTicker: h,
    ...
    Ht = a.useCallback(e => {
      e && (e.selectedMetric && A(e.selectedMetric), e.selectedTicker && (F(e.selectedTicker), ct
          .current = !0), e.pairTickerA && te(e.pairTickerA), e.pairTickerB && le(e
        .pairTickerB), (e.mode === "single" || e.mode === "universe" || e.mode === "pair" || e
          .mode === "pairCombo" || e.mode === "basket") && E(e.mode), e.pairCombo && be.hydrate(
          e.pairCombo), Array.isArray(e.basketTickers) && ee(e.basketTickers.filter(l =>
          typeof l == "string")), (e.basketMode === "stocks" || e.basketMode === "combined") &&
        J(e.basketMode), typeof e.buyThreshold == "number" && ue(e.buyThreshold), typeof e
        .sellThreshold == "number" && ge(e.sellThreshold), e.returnMode && Ne(e.returnMode),
        typeof e.targetReturn == "number" && xe(e.targetReturn), typeof e.bandMin == "number" &&
        ae(e.bandMin), typeof e.bandMax == "number" && we(e.bandMax), Array.isArray(e
        .results) && Be(e.results), e.expandedTicker !== void 0 && Oe(e.expandedTicker), e
        .sortBy && Ve(e.sortBy), e.signalType && pe(e.signalType), e.frequency === "daily" || e
        .frequency === "weekly" || e.frequency === "weekly_on_daily" ? Ge(e.frequency) : e
        .timeframe === "weekly" && Ge("weekly"))
    }, [Ge]);
  ...
  const gt = a.useMemo(() => K.map(e => {
    ...
    Je = a.useMemo(() => {
      const e = [...gt];
      return ye === "bestScore" ? e.sort((l, r) => r.bestScore - l.bestScore) : e.sort((l, r) => l
        .ticker.localeCompare(r.ticker)), e
    }, [gt, ye]),
    Zt = () => {
      const e = G.filter((s, x) => x >= 2),
        l = Je.map(s => {
          ...
          return e.forEach(u => {
            i[`buy_hitRate_${u.label}`] = x?.buySummary?.hitRate[u.label] ?? null, i[
              `sell_hitRate_${u.label}`] = x?.sellSummary?.hitRate[u.label] ?? null
          }), i
        }),
        r = Object.keys(l[0] || {}),
        d = [r.join(","), ...l.map(s => r.map(x => `"${String(s[x]??"").replace(/"/g,'""')}"`).join(
          ","))].join(`
`),
  ...
  return t.jsxs("div", {
    ...
    children: [t.jsxs("div", {
      ...
      children: [t.jsx("h2", {
        ...
        children: Pe === "optimize" ? "Search parameter space by hit rate" :
      ...
      children: [t.jsx("div", {
        ...
        children: t.jsxs("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsx("label", {
              ...
              className: "flex gap-px",
              children: ["breakout", "reversion", "both"].map(e => t
                .jsx("button", {
                  ...
                  onClick: () => Ft(e),
                  children: e === "breakout" ? "Breakout" :
                    e === "reversion" ? "Reversion" : "Both"
                }, e))
            })]
          }), t.jsxs("div", {
            className: "flex flex-col gap-0.5",
            ...
            children: [t.jsx("label", {
              ...
              onChange: e => xe((parseFloat(e.target.value) || 5) /
                100),
        ...
        children: [t.jsx(mr, {
          ...
          ticker: Ae.mode === "pair" ? Ae.pairLegA || "" : h || j[0]
            ?.ticker || "",
          priceContext: Ae,
          signals: ze.profiles,
            ...
            children: [t.jsx("label", {
              ...
              children: ["breakout", "reversion", "both"].map(e => t
                .jsx("button", {
                  ...
                  disabled: S,
                  title: e === "breakout" ?
                    "Signal when Z crosses through threshold (entering extreme)" :
                    e === "reversion" ?
                    "Signal when Z crosses back inside threshold (leaving extreme)" :
                    "Show both breakout and reversion signals",
                  children: e === "breakout" ? "Breakout" :
                    e === "reversion" ? "Reversion" : "Both"
                }, e))
            })]
        ...
        children: [K.length === 0 && !S && t.jsx("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsxs("h3", {
              ...
              children: [0, 25, 50, 75, 100].map(e => t.jsxs(
                "span", {
                  className: "flex items-center gap-1",
                  children: [t.jsx("span", {
            ...
            children: t.jsxs("table", {
              ...
              children: [t.jsx("thead", {
                ...
                children: Ee.matrix.map(e => {
                  const l = K.find(r => r.ticker === e
                    .ticker);
                  return t.jsxs("tr", {
                    className: "hover:bg-white/5 cursor-pointer",
                    onClick: () => Oe(Me === e
                      .ticker ? null : e.ticker),
                    children: [t.jsx("td", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsxs("h3", {
              className: "text-xs font-bold text-foreground uppercase tracking-wider",
              children: [o === "single" ? "Window Analysis" :
                "Results by Ticker", " — ", k, M !==
                "breakout" &&
                ` — ${M==="reversion"?"Reversion":"Breakout + Reversion"}`,
                V === "band" ? ` — band ${$e(U)}–${$e(q)}` :
                ` — target ${$e(D)}`
              ]
            }), t.jsxs("div", {
              ...
              children: [o === "universe" && t.jsxs("button", {
                ...
                children: t.jsxs("table", {
                  ...
                  children: [t.jsx("thead", {
                    ...
                    children: e.results.filter(r =>
                      r.buySummary && r
                      .sellSummary).flatMap(r => {
                      const d = r.window === e
                        .bestWindow,
                        n = [];
                      return M === "both" ? (n
                ...
                const r = e.results.find(n => n.window === e
                  .bestWindow);
                if (!r) return null;
                const d = [];
                return r.buyProfiles && r.buyProfiles
                  .length >= 10 && d.push({
                  ...
                  }), r.buyRevProfiles && r.buyRevProfiles
                  .length >= 10 && d.push({
                  ...
                  }), r.sellRevProfiles && r.sellRevProfiles
                  .length >= 10 && d.push({
