...
function Hr() {
  const [V, ie] = c.useState([]), [_, Ne] = c.useState(""), [zt, $o] = c.useState(null), [Ut, qt] =
    c.useState(!1), [w, it] = c.useState("stoch"), [Z, St] = c.useState("cross_out_of_band"), [O,
      Yt] = c.useState("threshold"), [G, Ct] = c.useState(.05), [oe, _t] = c.useState(.05), [re,
    Rt] = c.useState(.1), [R, $t] = c.useState(0), [Se, Zt] = c.useState("raw"), [a, ct] = c
    .useState("single"), [v, dt] = c.useState(""), [j, ut] = c.useState(""), [me, Gt] = c.useState(
    []), [pt, To] = c.useState("stocks"), {
      baskets: Tt
    } = tr(), [E, se] = c.useState(!1), [Ce, Ye] = c.useState({
      current: 0,
      total: 0
    }), [fe, ne] = c.useState([]), [Ze, Jt] = c.useState(null), [Wo, Bo] = c.useState(new Set), Po =
    c.useCallback(e => {
      Bo(s => {
        const l = new Set(s);
        return l.has(e) ? l.delete(e) : l.add(e), l
      })
    }, []), [_e, Qt] = c.useState("score"), [Wt, Ao] = c.useState("composite"), Xt = c.useMemo(() =>
      or(Wt), [Wt]), [Ge, eo] = c.useState(""), [to, Te] = c.useState("10y"), [D, We] = c.useState(
    () => rr()), [xt, oo] = c.useState("optimize"), [ce, ro] = c.useState("long"), [mt, so] = c
    .useState(null), [ft, no] = c.useState(null), [Bt, Je] = c.useState(!1), [Be, Eo] = c.useState(
      14), [Pe, Mo] = c.useState(3), [Ae, Oo] = c.useState(3), [Qe, Io] = c.useState(20), [Xe, Lo] =
    c.useState(80), [Ee, Do] = c.useState(5), [Me, Fo] = c.useState(34), [Oe, Ko] = c.useState(0),
    Re = c.useRef(!1), lo = c.useRef(!1), et = c.useRef(null), {
      universeTickers: Pt,
      isFiltered: Vo
    } = sr(), N = c.useMemo(() => Pt ? V.filter(e => Pt.has(e.ticker)) : V, [V, Pt]), gt = vr(N,
      a === "universe", "osc-clf"), bt = jr(N.map(e => e.ticker), a === "pairCombo", "osc-pc"), Ho =
    gt.filteredTickers, {
      frequency: de,
      setFrequency: ao,
      frequencyUI: zo
    } = Nr("osc", "daily", E || a === "pair" || a === "pairCombo"), ht = de === "weekly" ?
    "weekly" : "daily";
  c.useEffect(() => {
    nr().then(e => {
      ie(e), e.length > 0 && !lo.current && Ne(e[0].ticker), e.length > 0 && (dt(s => s ||
        e[0].ticker), ut(s => s || (e[1]?.ticker ?? e[0].ticker)))
    })
  }, []), c.useEffect(() => {
    N.length > 0 && _ && V.some(e => e.ticker === _) && !N.find(e => e.ticker === _) && Ne(N[0]
      .ticker)
  }, [N, _, V]);
  const tt = async (e, s) => {
      if (e === "__PAIR__" || e.startsWith("__PAIR__:")) {
        const [l, p] = e.startsWith("__PAIR__:") ? e.slice(9).split(":") : [v, j], n = await gr(l,
          p, s);
      ...
      if (Ye({
        ...
        if (de === "daily") {
          ...
          const b = s.map(async h => {
            if (!Re.current) try {
              ...
              const F = h.ticker === "__PAIR__" ? `${v}/${j}` : h.ticker.startsWith(
                  "__PAIR__:") && h.name || h.ticker,
                y = await r.run({
                  type: "run",
                  ticker: F,
                  name: h.name,
        ...
        if (de === "weekly_on_daily") {
          ...
          for (let r = 0; r < s.length && !Re.current; r++) {
            ...
            try {
              ...
              let S = 0,
                z = 0;
              for (let d = 0; d < b.prices.length; d++) S += b.prices[d], z++, d >= y && (S -=
                b.prices[d - y], z--), z > 0 && (W[d] = S / z);
                ...
                for (const C of jt) {
                  ...
                  for (const T of Nt) {
                    ...
                    for (const A of Ke) {
                      ...
                      A.direction === "buy" ? ae.push(nt) : ke.push(nt), R > 0 && (I = A
                        .index + R)
                    }
                    const Q = Ve(ae, "buy"),
                      we = Ve(ke, "sell"),
                      ...
                      It = ve.reduce((A, nt) => A.composite.score > nt.composite.score ? A :
                        nt, ve[0]);
                    K.push({
              ...
              const k = P / 100 * ge;
              let M = "None";
              $ !== null && ($ > k ? M = k > 0 ? "Above +Thr" : "Above 0" : $ < -k ? M = k >
                0 ? "Below -Thr" : "Below 0" : M = "In Zone", le !== null && (k === 0 ?
                  le <= 0 && $ > 0 ? M = "→ Cross Up" : le >= 0 && $ < 0 && (M =
                    "→ Cross Down") : le <= k && $ > k ? M = "→ Cross +Thr" : le >= -k &&
                  $ < -k && (M = "→ Cross -Thr")));
              const f = g.ticker === "__PAIR__" ? `${v}/${j}` : g.ticker.startsWith(
                "__PAIR__:") && g.name || g.ticker;
              o.push({
                ticker: f,
                name: g.name,
                configs: K,
        ...
        for (let o = 0; o < s.length && !Re.current; o++) {
          ...
          try {
            ...
            let y = 0,
              W = 0;
            for (let f = 0; f < u.closes.length; f++) y += u.closes[f], W++, f >= m && (y -= u
              .closes[f - m], W--), W > 0 && (F[f] = y / W);
              ...
              for (const d of jt) {
                ...
                for (const te of Nt) {
                  ...
                  for (const I of st) {
                    ...
                    I.direction === "buy" ? $e.push(we) : he.push(we), R > 0 && (ye = I
                      .index + R)
                  }
                  const De = Ve($e, "buy"),
                    T = Ve(he, "sell"),
                    ...
                    ke = ae.reduce((I, Q) => I.composite.score > Q.composite.score ? I : Q,
                      ae[0]);
                  U.push({
            ...
            const Y = be / 100 * z;
            let x = "None";
            P !== null && (P > Y ? x = Y > 0 ? "Above +Thr" : "Above 0" : P < -Y ? x = Y > 0 ?
              "Below -Thr" : "Below 0" : x = "In Zone", J !== null && (Y === 0 ? J <= 0 &&
                P > 0 ? x = "→ Cross Up" : J >= 0 && P < 0 && (x = "→ Cross Down") : J <=
                Y && P > Y ? x = "→ Cross +Thr" : J >= -Y && P < -Y && (x = "→ Cross -Thr"))
              );
            const k = r.ticker === "__PAIR__" ? `${v}/${j}` : r.ticker.startsWith(
              "__PAIR__:") && r.name || r.ticker,
              M = {
                prices: u.closes,
                highs: u.highs,
                lows: u.lows,
      ...
      for (let n = 0; n < s.length && !Re.current; n++) {
        ...
        try {
          ...
          let i, b, h, m = null,
            ...
            W = null;
          if (de === "weekly_on_daily") {
            if (u < 252 || (F = qe(r.closes, r.priceDates), y = qe(r.highs, r.priceDates), W =
                qe(r.lows, r.priceDates), F.prices.length < 52)) continue;
                  ...
                  for (const d of Ht) {
                    ...
                    if (de === "weekly_on_daily" && F) {
                      const H = xe => {
                        ...
                        return Vt(ve, F.weekIndex, u).map(A => Number.isFinite(A) ? A :
                          null)
                      };
                      te = H(C), Le = H(pe)
                    } else te = C, Le = pe;
                    const st = de === "weekly_on_daily" ? Math.max((x + k + M) * 5, 21) +
                      126 : ht === "weekly" ? x + k + M + 26 : x + k + M + 126,
                      $e = wo(te, Le, f, d, Z, st),
                      he = [],
                      ye = [],
                      De = O === "band" ? {
                    ...
                    for (const H of $e) {
                      ...
                      H.direction === "buy" ? he.push(ve) : ye.push(ve), R > 0 && (T = H
                        .index + R)
                    }
                    const Fe = O === "band",
                      Ke = Ve(he, "buy"),
                      ...
                      we = Q.reduce((H, xe) => H.composite.score > xe.composite.score ? H :
                        xe, Q[0]);
                    S.push({
          ...
          let $ = "None";
          if (B !== null && (B <= X ? $ = "Oversold" : B >= q ? $ = "Overbought" : $ =
              "Neutral", P !== null))
            if (Z === "cross_out_of_band") P <= X && B > X ? $ = "→ Exit OS" : P >= q && B <
              q && ($ = "→ Exit OB");
            else {
              const x = be[be.length - 1],
                k = be[be.length - 2] ?? null;
              x !== null && k !== null && (P <= k && B > x && B <= X && x <= X ? $ =
                "→ K×D Buy" : P >= k && B < x && B >= q && x >= q && ($ = "→ K×D Sell"))
            } const le = o.ticker === "__PAIR__" ? `${v}/${j}` : o.ticker.startsWith(
              "__PAIR__:") && o.name || o.ticker,
            Y = m ? {
              prices: m.closes,
              highs: m.highs,
              lows: m.lows,
      ...
      ne(p), se(!1)
    }, [N, _, v, j, a, w, Z, G, O, oe, re, R, de, D, me, pt, Tt]), qo = c.useCallback(
async () => {
      ...
      try {
        ...
        const {
          ...
          priceDates: g,
          globalIndices: u
        } = l, i = g.length === p.length ? g : new Array(p.length).fill(""), h = ce ===
          "long" ? "buy" : "sell", m = [];
        if (w === "stoch") {
    ...
    }, [w, Z, Be, Pe, Ae, Qe, Xe, Ee, Me, Oe, ce]), co = c.useMemo(() => a === "pair" ?
      `${v||"A"}/${j||"B"}` : a === "single" ? _ || "—" : N[0]?.ticker || "—", [a, v, j, _, N]),
    At = c.useCallback(() => ({
      selectedTicker: _,
      subMode: w,
      stochSignalMode: Z,
      ...
      e && (e.selectedTicker && (Ne(e.selectedTicker), lo.current = !0), e.subMode && it(e
          .subMode), e.stochSignalMode && St(e.stochSignalMode), typeof e.targetReturn ==
        "number" && Ct(e.targetReturn), e.returnMode && Yt(e.returnMode), typeof e.bandMin ==
        "number" && _t(e.bandMin), typeof e.bandMax == "number" && Rt(e.bandMax), typeof e
        .minHold == "number" && $t(e.minHold), (e.ewoDisplay === "raw" || e.ewoDisplay ===
          "pct") && Zt(e.ewoDisplay), e.frequency === "daily" || e.frequency === "weekly" || e
        .frequency === "weekly_on_daily" ? ao(e.frequency) : e.timeframe === "weekly" && e
        .frequency === void 0 && ao("weekly"), (e.mode === "single" || e.mode ===
          "universe" || e.mode === "pair" || e.mode === "pairCombo" || e.mode === "basket") &&
        ct(e.mode), e.pairCombo && bt.hydrate(e.pairCombo), Array.isArray(e.results) && ne(e
          .results), e.expandedTicker !== void 0 && Jt(e.expandedTicker), e.sortBy && Qt(e
          .sortBy), e.pairTickerA && dt(e.pairTickerA), e.pairTickerB && ut(e.pairTickerB),
        Array.isArray(e.basketTickers) && Gt(e.basketTickers.filter(s => typeof s ==
          "string")))
    }, []);
  ...
  const Yo = c.useCallback(() => {
    ...
    Mt = c.useMemo(() => {
      const e = Ge.trim().toLowerCase(),
        s = e ? yt.filter(l => l.ticker.toLowerCase().includes(e) || l.name && l.name
        .toLowerCase().includes(e)) : [...yt];
      ...
      const e = je.filter((o, r) => r >= 2),
        s = Mt.map(o => {
          const r = o.configs.reduce((b, h) => b.bestScore > h.bestScore ? b : h, o.configs[0]),
            u = r?.categories.reduce((b, h) => b.composite.score > h.composite.score ? b : h, r
          ...
          return e.forEach(b => {
            i[`hitRate_${b.label}`] = u?.hitRate[b.label] ?? null, i[`avgReturn_${b.label}`] =
              u?.avgReturn[b.label] ?? null
          }), i
        }),
        l = Object.keys(s[0] || {}),
        p = [l.join(","), ...s.map(o => l.map(r => `"${String(o[r]??"").replace(/"/g,'""')}"`).join(
          ","))].join(`
`),
    ...
    Jo = e => e === null ? "text-muted-foreground" : w === "stoch" ? e <= 20 ? "text-emerald-400" :
    e <= 40 ? "text-green-400" : e >= 80 ? "text-red-400" : e >= 60 ? "text-orange-400" :
    "text-yellow-400" : e > 0 ? "text-green-400" : e < 0 ? "text-red-400" : "text-yellow-400",
    uo = e => e.includes("Oversold") || e.includes("Buy") || e.includes("Cross Up") || e.includes(
      "Above +Thr") || e.includes("Above 0") || e.includes("Exit OS") ?
    "bg-emerald-600/20 text-emerald-400 border-emerald-600/30" : e.includes("Overbought") || e
    .includes("Sell") || e.includes("Cross Down") || e.includes("Below -Thr") || e.includes(
      "Below 0") || e.includes("Exit OB") ? "bg-red-600/20 text-red-400 border-red-600/30" : e
    .includes("→") ? "bg-blue-600/20 text-blue-400 border-blue-600/30" : e.includes("Neutral") || e
    .includes("In Zone") ? "bg-yellow-600/20 text-yellow-400 border-yellow-600/30" :
    ...
    po = e => {
      ...
      const s = e.currentValue != null ? e.currentValue.toFixed(3) : "–",
        l = e.currentValuePct != null ?
        `${e.currentValuePct>=0?"+":""}${e.currentValuePct.toFixed(2)}%` : "–";
    ...
    children: [t.jsxs("div", {
      ...
      children: [t.jsx("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                max: 100,
                value: Be,
                onChange: e => Eo(parseInt(e.target.value) ||
                  14),
              ...
              children: [t.jsx("label", {
                ...
                max: 20,
                value: Pe,
                onChange: e => Mo(parseInt(e.target.value) ||
                  3),
                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
              })]
            }), t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                max: 20,
                value: Ae,
                onChange: e => Oo(parseInt(e.target.value) ||
                  3),
                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
              })]
            }), t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                max: 50,
                value: Qe,
                onChange: e => Io(parseInt(e.target.value) ||
                  20),
              ...
              children: [t.jsx("label", {
                ...
                max: 99,
                value: Xe,
                onChange: e => Lo(parseInt(e.target.value) ||
                  80),
                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[55px]"
              })]
            })]
            ...
            children: [t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                max: 200,
                value: Ee,
                onChange: e => Do(parseInt(e.target.value) ||
                  5),
                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
              })]
            }), t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                max: 400,
                value: Me,
                onChange: e => Fo(parseInt(e.target.value) ||
                  34),
                className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 text-foreground w-[60px]"
              })]
            }), t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                min: 0,
                value: Oe,
                onChange: e => Ko(parseFloat(e.target
                  .value) || 0),
            ...
            children: [t.jsx("label", {
              ...
              onChange: e => Ct((parseFloat(e.target.value) || 5) /
                100),
        ...
        children: [t.jsx(yr, {
          ...
          ticker: ft.mode === "pair" ? ft.pairLegA || "" : _ || N[0]
            ?.ticker || "",
          priceContext: ft,
          signals: mt.profiles,
          ...
          children: [t.jsxs("div", {
            children: [t.jsxs("div", {
              ...
              children: [t.jsx("p", {
                ...
                children: ["Last fetched: ", Math.round((Date
                  .now() - zt) / 6e4), "m ago"]
              }), t.jsx("button", {
                onClick: async () => {
                  const e = _;
            ...
            children: [t.jsx("label", {
              ...
              className: "flex gap-px",
              children: ["cross_out_of_band", "k_crosses_d_in_zone"]
                .map(e => t.jsx("button", {
                  ...
                  onClick: () => St(e),
                  disabled: E,
                  children: e === "cross_out_of_band" ?
                    "Exit Band" : "K×D in Zone"
                }, e))
            })]
          }), w === "ewo" && t.jsxs("div", {
            className: "flex flex-col gap-0.5",
            ...
            children: [t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                onChange: e => _t(Number(e.target.value) /
                  100),
                disabled: E
              })]
            }), t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                onChange: e => Rt(Number(e.target.value) /
                  100),
                disabled: E
              })]
            })]
            ...
            children: [t.jsx("label", {
              ...
              className: "text-xs font-mono bg-background border border-border rounded px-2 py-1 w-14",
              value: R,
              onChange: e => $t(Math.max(0, Math.min(126, Math
            ...
            children: [t.jsx("label", {
              ...
              onClick: () => {
                Re.current = !0, et.current?.terminate(), et
                  .current = null, se(!1)
              },
        ...
        children: [fe.length === 0 && !E && t.jsx("div", {
          ...
          children: t.jsxs("div", {
            ...
            children: [t.jsxs("div", {
              ...
              children: ["Computing ", w === "stoch" ?
                "Slow Stochastic" : "EWO", " signals..."
              ]
            }), t.jsxs("div", {
              className: "text-xs font-mono text-muted-foreground",
              children: [Ce.current, "/", Ce.total, " tickers × ",
                er, " configs"
              ]
            }), t.jsx("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsxs("h3", {
              ...
              children: [Mt.length, Ge ? ` of ${fe.length}` : "",
                " tickers — ", w === "stoch" ?
                `Stoch (${Z==="cross_out_of_band"?"Exit Band":"K×D"})` :
                "EWO", " — ", O === "band" ?
                `band ${ze(oe)}–${ze(re)}` : `target ${ze(G)}`,
                R > 0 ? ` — min hold ${R}d` : ""
              ]
            }), t.jsxs("div", {
              className: "flex items-center gap-1",
              ...
              children: [t.jsx("thead", {
                children: t.jsxs("tr", {
                  ...
                  children: [t.jsx("th", {
                    ...
                    }, e.label)), je.filter((e, s) =>
                    s >= 2).map(e => t.jsxs("th", {
                    className: "text-center px-2 py-1 font-bold",
                    children: ["Avg ", e.label]
                  }, `avg-${e.label}`)), je.filter((e,
                    s) => s >= 2).map(e => t.jsxs(
                    "th", {
                      className: "text-center px-2 py-1 font-bold",
                      children: ["PF ", e.label]
                ...
                children: Mt.map(e => {
                  const s = Ze === e.ticker,
                    l = e.configs.reduce((o, r) => o
                      .bestScore > r.bestScore ? o : r, e
                      .configs[0]),
                    n = l?.categories.reduce((o, r) => o
                      .composite.score > r.composite
                      .score ? o : r, l.categories[0])
                    ?.summary;
                  return t.jsxs("tr", {
            ...
            return t.jsxs("div", {
              ...
              children: [t.jsxs("h4", {
                ...
                children: s.slice(0, 6).map((l, p) => {
                  const n = l.categories.reduce((o, r) =>
                    o.composite.score > r.composite
                    .score ? o : r, l.categories[0]);
                  return t.jsxs("div", {
                    ...
                    }), l.categories.filter(o => o
                      .summary.count > 0).sort((o,
                        r) => r.composite.score -
                      o.composite.score).map(
                    o => {
                      const r =
                        `${e.ticker}::${l.configLabel}::${o.category}`,
                        g = Wo.has(r),
                        u = !!(o.profiles && o
                          .profiles.length >=
                          10 && e.priceContext);
