...
function N({
  ...
  const [o, p] = n.useState(s || ""), [m, a] = n.useState(!1), [d, c] = n.useState(0), x = n.useRef(
    null), w = n.useRef(null);
  n.useEffect(() => {
    p(s || "")
  }, [s]), n.useEffect(() => {
    function e(r) {
  ...
  const i = n.useMemo(() => {
      ...
      return e ? l.filter(r => r.ticker.toLowerCase().includes(e) || r.name && r.name
      .toLowerCase().includes(e)).slice(0, 50) : l.slice(0, 50)
    }, [l, o]),
    ...
    y = e => {
      ...
      e.key === "ArrowDown" ? (e.preventDefault(), c(r => Math.min(r + 1, Math.max(i.length - 1,
          0)))) : e.key === "ArrowUp" ? (e.preventDefault(), c(r => Math.max(r - 1, 0))) : e.key ===
        "Enter" ? (e.preventDefault(), m && i[d] ? u(i[d].ticker) : u(o)) : e.key === "Escape" && a(
          !1)
    };
  return t.jsxs("div", {
    ref: x,
      ...
      children: [t.jsxs("div", {
        ...
        children: [t.jsx("input", {
          ...
          children: [i.length === 0 ? t.jsxs("div", {
            ...
            children: ["No workbook match. Press Enter to use", " ", t
              .jsx("span", {
          ...
          }, e.ticker)), o.trim() && !i.find(e => e.ticker
          .toUpperCase() === o.trim().toUpperCase()) && t.jsxs("button", {
            type: "button",
