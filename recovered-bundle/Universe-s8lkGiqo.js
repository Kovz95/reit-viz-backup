...
function Re() {
  const {
    ...
    return s
  }, [x]), [f, Z] = i.useState("ticker"), [k, U] = i.useState("asc"), [c, N] = i.useState(null), [
    z, v
  ] = i.useState(""), j = i.useRef(null);
  i.useEffect(() => {
  ...
  const Q = (t, s, r) => {
    ...
    re = () => {
      ...
      r.download = `reit-viz-classification-overrides-${a}.json`, document.body.appendChild(r), r
        .click(), document.body.removeChild(r), URL.revokeObjectURL(s)
    },
    g = i.useRef(null),
    ae = () => g.current?.click(),
    oe = async t => {
...
Click Cancel to REPLACE all existing overrides.`) ? "merge" : "replace";
      ...
      d !== 0 && window.confirm(
        `Reset all ${d} reclassification override(s) back to the workbook defaults?`) && Ce()
    };
  return e.jsxs("div", {
      ...
      children: [e.jsxs("div", {
        ...
        children: [R ? e.jsxs("div", {
          ...
          children: [d > 0 && e.jsxs("div", {
            ...
            title: b > 0 ?
              `${$} active override(s) on tickers in this workbook · ${b} inert (ticker not in workbook — will re-activate if ticker returns)` :
        ...
        children: [e.jsxs("div", {
          ...
          className: "h-6 px-2 text-[11px] text-muted-foreground",
          onClick: () => {
            window.confirm(`Restore all ${p.size} excluded ticker(s)?`) &&
              he("workbook")
          },
          children: [e.jsx(B, {
            className: "w-3 h-3 mr-0.5"
              ...
              children: [e.jsx("td", {
                ...
                children: e.jsxs("div", {
                  ...
                  children: [o && e.jsx("button", {
                    ...
                    onClick: () => {
                      window.confirm(
                        `Revert all reclassification overrides for ${t.ticker}?`
                        ) && ke(t.ticker)
                    },
