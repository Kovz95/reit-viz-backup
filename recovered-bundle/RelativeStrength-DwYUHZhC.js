  ...
  for (let m = 0; m < a; m++)
    for (let b = 0; b < i; b++) {
      ...
      for (const P of n) {
        ...
        let S = NaN;
        r.xs.scope === "peer" ? S = A : r.xs.scope === "universe" ? S = T : Number.isFinite(A) &&
          Number.isFinite(T) ? S = f * A + p * T : Number.isFinite(A) ? S = A : Number.isFinite(
          T) && (S = T);
  ...
  for (let u = 0; u < i; u++) {
    ...
    for (const R of l) {
      ...
      const D = t[R],
        ...
        v = D.direction;
      let g = NaN;
      s.xs.scope === "peer" ? g = S : s.xs.scope === "universe" ? g = h : Number.isFinite(S) &&
        Number.isFinite(h) ? g = f * S + p * h : Number.isFinite(S) ? g = S : Number.isFinite(h) &&
        (g = h);
      ...
      let d = NaN;
      Number.isFinite(F) && Number.isFinite(c) ? d = s.alpha * F + (1 - s.alpha) * c : Number
        .isFinite(F) ? d = F : Number.isFinite(c) && (d = c);
      const w = x[R] / o;
      P.push({
        metric: R,
        label: E.label,
...
function ze(t, r, n) {
    ...
    for (const g of _) {
      ...
      for (const j of l) {
        const M = r.matrix[j][h],
          ...
          V = N[j],
          q = v[j];
        Number.isFinite(M) && Number.isFinite(I) && M > 0 && Number.isFinite(V) && q >= 0 && B
      .push({
          i: j,
          r: I / M - 1,
          b: q,
  ...
  for (let h = 0; h < T.length; h++) E *= 1 + T[h].ret, D *= 1 + S[h].ret, A *= 1 + (T[h].ret - S[h]
    .ret), R.push({
    date: T[h].date,
    long: E,
    short: D,
...
const Le = ["valuation", "growth", "technical", "macro"],
  ...
  Ne = ["P/AFFO FY2", "AFFO Yield FY2", "FY2 AFFO Growth", "Dividend Yield", "3M Price Chg%",
    "% off 52wk High"
  ],
  Ve = {
    metrics: Ne,
...
function Je() {
  ...
  ye("relative-strength", () => ({
    ...
    const d = c;
    d.mode && n(d.mode), d.cfg && a(d.cfg), typeof d.pairA == "string" && l(d.pairA), typeof d
      .pairB == "string" && x(d.pairB), typeof d.singleTicker == "string" && p(d.singleTicker),
      typeof d.doBacktest == "boolean" && b(d.doBacktest), typeof d.hitThreshold == "string" &&
      k(d.hitThreshold), typeof d.rebalanceBars == "number" && R(d.rebalanceBars), typeof d
      .nBuckets == "number" && D(d.nBuckets)
  });
  const B = K.useCallback(async () => {
    h(!0), v(null), F("");
    try {
      const [c, d] = await Promise.all([Se(), Me()]), w = new Set(t.visibleTickers ?? c.map(
        y => y.ticker)), O = c.filter(y => w.has(y.ticker));
  ...
  return K.useMemo(() => (t.visibleTickers ?? []).slice(), [t.visibleTickers]), e.jsxs("div", {
    ...
    children: [e.jsxs("header", {
      ...
      children: [e.jsx("span", {
        ...
        onClick: () => n(c),
        children: c === "universe" ? "Universe Ranking" : c === "pair" ?
          "Pair Trade" : "Single-Name"
        ...
        children: [e.jsxs("div", {
          children: [e.jsx("label", {
            ...
            children: [e.jsx("input", {
              ...
              children: [Math.round(s.alpha * 100), "% XS / ",
                100 - Math.round(s.alpha * 100), "% TS"
              ]
            })]
          })]
        }), e.jsxs("div", {
          ...
          children: [e.jsx("label", {
            ...
            children: [e.jsx("span", {
              ...
              onChange: c => a(d => ({
                ...
                xs: {
                  ...d.xs,
                  peerWeight: parseFloat(c.target.value) ||
                    0
                }
              })),
          ...
          children: [e.jsx("label", {
            ...
            children: [e.jsx("span", {
              ...
              onChange: c => a(d => ({
                ...
                ts: {
                  ...d.ts,
                  rollingBars: parseInt(c.target.value,
                    10) || 252
                }
              })),
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("span", {
              ...
              min: "5",
              value: P,
              onChange: c => R(parseInt(c.target.value, 10) ||
                21),
              className: "w-16 h-6 text-xs"
            })]
          }), e.jsxs("div", {
...
`,
      i = t.map((f, p) =>
        `${p+1},${f.ticker},${f.score.toFixed(2)},${f.scorePercentile.toFixed(1)}`).join(`
`),
      l = new Blob([a + i], {
        type: "text/csv"
      }),
...
function We({
  ...
  if (!t || !r) return e.jsxs("div", {
    ...
    children: ["One or both tickers not found in scored universe: ", t ? "" : n, " ", r ? "" :
      s
    ]
  });
        ...
        children: [...a.entries()].map(([i, {
          ...
          return e.jsxs("tr", {
            ...
            children: [e.jsx("td", {
              ...
              className: $("p-1 text-right font-semibold", x > 0 ?
                "text-green-600" : x < 0 ? "text-red-600" : ""),
              children: [x > 0 ? "+" : "", U(x)]
            })]
          }, i)
        })
        ...
        children: [e.jsx("thead", {
          ...
          children: t.breakdown.map(i => e.jsxs("tr", {
            ...
            children: [e.jsx("td", {
              ...
              className: $("p-1 text-right font-semibold", i
                .contribution > 5 ? "text-green-600" : i
                .contribution < -5 ? "text-red-600" : ""),
...
function Ze({
  ...
  return e.jsxs("div", {
    ...
    children: [e.jsx("h3", {
      ...
      className: "text-xs text-muted-foreground",
      children: [t.nObservations, " ticker-date observations across ", t.nDates,
        " rebalance dates"
      ]
    }), e.jsxs("div", {
      children: [e.jsx("h4", {
        ...
        children: [e.jsx("thead", {
          ...
          children: t.longShort.map(r => e.jsxs("tr", {
            ...
            children: [e.jsx("td", {
              ...
              className: $("p-1 text-right font-semibold", r
                .meanReturn > 0 ? "text-green-600" :
                "text-red-600"),
            ...
            return e.jsxs("tr", {
              ...
              children: [e.jsx("td", {
                ...
                className: $("p-1 text-right font-semibold",
                  n !== null && n > 0 ? "text-green-600" :
                  n !== null && n < 0 ? "text-red-600" : ""),
      ...
      children: [e.jsx("h4", {
        ...
        children: [e.jsx("thead", {
          ...
          children: Array.from(new Set(t.bucketStats.map(r => r.bucket))).map(
            r => e.jsxs("tr", {
              className: "border-b",
              children: [e.jsx("td", {
                ...
                const s = t.bucketStats.find(a => a.bucket === r &&
                  a.horizon === n.label);
                return e.jsx("td", {
                  className: $("p-1 text-right", s && s
                    .meanReturn > 0 ? "text-green-600" : s &&
                    s.meanReturn < 0 ? "text-red-600" : ""),
                  children: s && Number.isFinite(s.meanReturn) ?
                    G(s.meanReturn * 100, 2) : "—"
                }, n.label)
              })]
            }, r))
        })]
