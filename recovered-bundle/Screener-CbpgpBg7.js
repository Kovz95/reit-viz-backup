...
async function _r(r, i) {
  ...
  if (o === "custom") {
    ...
    if (b) {
      const s = b.replace(/-/g, "");
      if (u = r.findIndex(v => (typeof v.time == "string" ? v.time.replace(/-/g, "") : String(v
          .time)) >= s), u === -1) return null
    }
    if (c) {
      const s = c.replace(/-/g, "");
      for (let v = r.length - 1; v >= u; v--)
        if ((typeof r[v].time == "string" ? r[v].time.replace(/-/g, "") : String(r[v].time)) <=
          s) {
          l = v;
          break
        }
...
async function Zr(r, i) {
  ...
  if (c === "now") {
    ...
    else if (i.rightType === "metric" && u) w = u[u.length - 1].value, T = b && u.length >= 2 ? u[
      u.length - 2].value : w;
...
function Ze(r) {
  ...
  let d = r.leftMetric;
  i === "correlation" ? d =
    `Corr(${r.leftMetric} × ${r.sourceTicker2??"?"}:${r.sourceMetric2??"close"}, ${r.derivedWindow??60}d)` :
    i === "derived" && (d =
      `${Dt.find(v=>v.type===r.derivedType)?.label??r.derivedType??"ratio"}(${r.leftMetric} × ${r.sourceTicker2??"?"}:${r.sourceMetric2??"close"})`
      );
  ...
  let l = "";
  if (u === "preset") l =
    ` (any in ${Ot.find(v=>v.days===(r.lookbackPresetDays??21))?.label??"1M"})`;
  else if (u === "custom") {
    ...
    children: [i > 0 && e.jsx("span", {
      ...
      children: Br.map(s => e.jsx("button", {
        onClick: () => {
          ...
          s.value !== "metric" && !c.sourceTicker2 && b.length > 0 && (v
            .sourceTicker2 = b[0]?.ticker ?? "", v.sourceMetric2 = "close", v
            .derivedWindow = 60), s.value === "derived" && !c.derivedType && (v
            .derivedType = "ratio"), l(v)
        },
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx(O, {
          ...
          onChange: s => l({
            rightPercentile: Math.max(1, Math.min(99, parseInt(s.target
              .value) || 50))
          }),
          className: "h-7 w-14 text-[11px] bg-muted/20 border-border text-center px-1",
...
function ns() {
  const {
    ...
    manualTickers: s,
    setManualTickers: v
  } = er(), [$, G] = g.useState(!0), [k, y] = g.useState([_e()]), [j, w] = g.useState([]), [T, C] =
    g.useState(!1), [P, I] = g.useState(null), [S, Ce] = g.useState("all"), [Z, Pe] = g.useState(
      "subsector"), [Ue, $t] = g.useState("P/FFO FY2"), [He, It] = g.useState("FY2 FFO Growth"), [
      De, Yt
    ] = g.useState(.5), [B, ee] = g.useState(!1), [te, Ae] = g.useState(null), [ue, W] = g.useState(
      null), [Te, re] = g.useState(null), [R, Ke] = g.useState({
      key: "ticker",
      dir: "asc"
    }), [A, xe] = g.useState("single"), [U, We] = g.useState("close"), [H, qe] = g.useState(
    "close"), [K, Re] = g.useState(60), [se, Je] = g.useState(52), [me, Qe] = g.useState(8), [pe,
      Xe] = g.useState(52), [ae, et] = g.useState(.5), [ie, tt] = g.useState(500), [ne, rt] = g
    .useState("all"), [he, Oe] = g.useState([]), [fe, $e] = g.useState(!1), [st, ge] = g.useState(
      null), [Y, at] = g.useState({
      key: "absRawZ",
      dir: "desc"
  ...
  const {
    ...
    queryFn: Rr
  }), je = g.useMemo(() => r ? ve.filter(t => r.has(t.ticker)) : ve, [ve, r]), le = Ir(je.map(t =>
    t.ticker), A === "pairCombo", "screener-pc"), Vt = g.useCallback(() => ({
    conditions: k,
    runConditions: P,
    results: j,
    hasRun: T,
  ...
  }), [k, P, j, T, R, A, U, H, K, se, me, pe, ae, ie, ne, he, fe, Y, le]), zt = g.useCallback(
  t => {
    if (!t) return;
      ...
      const n = a.map(m => m.id),
        p = t.results.map(m => {
          ...
          const f = Object.keys(m.values),
            x = {},
            M = {};
          for (let F = 0; F < Math.min(f.length, n.length); F++) x[n[F]] = m.values[f[F]], m
            .matchDates && (M[n[F]] = m.matchDates[f[F]]);
          return {
            ...m,
            values: x,
            matchDates: M
    ...
    typeof t.hasRun == "boolean" && C(t.hasRun), Array.isArray(t.runConditions) ? I(t
        .runConditions) : t.hasRun && a.length > 0 ? I(a) : I(null), t.sort && Ke(t.sort), (t
        .screenMode === "single" || t.screenMode === "pairs" || t.screenMode === "pairCombo") &&
      xe(t.screenMode), t.pairCombo && le.hydrate(t.pairCombo), t.pairsMetricA && We(t
        .pairsMetricA), t.pairsMetricB && qe(t.pairsMetricB), t.pairsZWindow !== void 0 && Re(t
        .pairsZWindow), t.pairsBetaLookback !== void 0 && Je(t.pairsBetaLookback), t
      .pairsSpreadZWindow !== void 0 && Qe(t.pairsSpreadZWindow), t.pairsOlsResidWindow !==
      void 0 && Xe(t.pairsOlsResidWindow), t.pairsMinCorr !== void 0 && et(t.pairsMinCorr), t
      .pairsMaxHalfLife !== void 0 && tt(t.pairsMaxHalfLife), t.pairsZFilter && rt(t
        .pairsZFilter), Array.isArray(t.pairsResults) && Oe(t.pairsResults), typeof t
      .pairsHasRun == "boolean" && $e(t.pairsHasRun), t.pairsSort && at(t.pairsSort)
  }, []), _t = Or();
  rr("screener", Vt, zt, {
    universeSig: _t,
    ...
    try {
      ...
      if (S !== "all" && n.length > 0 && !be.current) {
        ...
        try {
          ...
          const F = S === "attractive" ? "Attractive" : S === "expensive" ? "Expensive" :
            "Neutral";
          m = n.map(D => ({
            ...D,
            rv: M.get(D.ticker)
  ...
  async function dt() {
    if (!B) {
      ...
      try {
        ...
        ge(t ?
          `Analyzing ${a.length} selected pair${a.length!==1?"s":""} (${n.length} unique legs)...` :
          `Analyzing ${p} pairs across ${n.length} tickers...`);
        ...
        ae > 0 && (f = f.filter(x => Math.abs(x.correlation) >= ae)), ie < 9999 && (f = f.filter(
          x => x.halfLife !== null && x.halfLife <= ie)), ne === "extreme" ? f = f.filter(x =>
          Math.abs(x.rawZ) >= 1.5) : ne === "mean_revert" && (f = f.filter(x => Math.abs(x
          .rawZ) >= 1.5 && x.halfLife !== null && x.halfLife <= 300)), Oe(f), $e(!0)
      } catch (t) {
  ...
  const q = g.useMemo(() => {
    ...
    return t.sort((a, n) => {
      ...
      } else p = a[h] ?? (Y.dir === "asc" ? 9999 : -9999), m = n[h] ?? (Y.dir === "asc" ?
        9999 : -9999);
      const f = p - m;
  ...
  function qt() {
    ...
    const t =
      "Ticker A,Ticker B,Ratio,Log Ratio,Raw Z,Spread Z,OLS Resid Z,Correlation,Rolling Beta,Rolling R2,Beta-Adj Spread,Half-Life,Data Points",
      a = x => x ?? "N/A",
      n = q.map(x =>
        `${x.tickerA},${x.tickerB},${a(x.ratio)},${a(x.logRatio)},${a(x.rawZ)},${a(x.spreadZ)},${a(x.olsResidZ)},${a(x.correlation)},${a(x.rollingBeta)},${a(x.rollingR2)},${a(x.betaAdjSpread)},${a(x.halfLife)},${a(x.dataPoints)}`
        ),
      p = [t, ...n].join(`
`),
      m = new Blob([p], {
  ...
  const ut = g.useMemo(() => P && P.length > 0 ? P : k, [P, k]),
    ...
    mt = g.useMemo(() => {
      ...
      return t.sort((a, n) => {
        let p, m;
        if (R.key === "ticker" ? (p = a.ticker, m = n.ticker) : R.key === "name" ? (p = a
            .name, m = n.name) : R.key === "sector" ? (p = a.sector, m = n.sector) : R.key ===
          "rv_label" ? (p = a.rv?.label ?? "", m = n.rv?.label ?? "") : R.key ===
          "rv_prem_pct" ? (p = a.rv?.premPctile ?? -1 / 0, m = n.rv?.premPctile ?? -1 / 0) : R
          .key === "rv_growth_pct" ? (p = a.rv?.growthPctile ?? -1 / 0, m = n.rv
            ?.growthPctile ?? -1 / 0) : R.key === "rv_prem_gap" ? (p = a.rv?.premGap ?? -1 /
            0, m = n.rv?.premGap ?? -1 / 0) : (p = a.values[R.key] ?? -1 / 0, m = n.values[R
            .key] ?? -1 / 0), p === m) return a.ticker.localeCompare(n.ticker);
    ...
    Jt = () => {
      const t = P ?? k,
        a = mt.map(h => {
          ...
          }), S !== "all" && h.rv && (f["RV Verdict"] = h.rv.label, f["Prem Pctile"] = h.rv
            .premPctile ?? null, f["Growth Pctile"] = h.rv.growthPctile ?? null, f[
            "Prem Gap %"] = h.rv.premGap ?? null, f["Implied Prem %"] = h.rv.impliedPrem ??
            null, f["Today Prem %"] = h.rv.lastP ?? null, f["Today Growth Diff (pp)"] = h.rv
            .lastG ?? null), f
        }),
        n = Object.keys(a[0] || {}),
        p = [n.join(","), ...a.map(h => n.map(f => `"${String(h[f]??"").replace(/"/g,'""')}"`).join(
          ","))].join(`
`),
      ...
      children: [e.jsx(bt, {
        ...
        children: [e.jsx(we, {
          ...
          children: [e.jsx("div", {
            ...
            children: ["Saves ", k.length, " condition", k.length !==
              1 ? "s" : ""
            ]
          })]
        })]
        ...
        children: [e.jsx(we, {
          ...
          children: e.jsxs("button", {
            ...
            children: [e.jsx(nr, {
                size: 9
              }), "RV: ", S === "all" ? "Off" : S === "attractive" ?
              "Attractive" : S === "expensive" ? "Expensive" :
              "Neutral", e.jsx(Ge, {
                size: 9
              })
            ]
      ...
      children: [e.jsxs("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: ["Scanning ", te.done, " of ", te.total,
              " tickers…"]
          })]
        })
        ...
        children: [!T && !B && e.jsxs("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsxs("span", {
              ...
              children: [j.length, " of ", je.length,
                " tickers match"
              ]
            }), j.length > 0 && e.jsx(ur, {
              size: 12,
                  ...
                  children: [e.jsx(Be, {
                    ...
                    return [e.jsxs("th", {
                      ...
                      "span", {
                        ...
                        children: t
                          .leftIndicator ?
                          `${t.leftIndicator.type}(${t.leftIndicator.period})` :
                          t.leftMetric
                      }), e.jsx(Q, {
                        colKey: t.id
                      })]
                  ...
                  children: [e.jsx("td", {
                    ...
                    .Fragment, {
                      children: [e.jsx("td", {
                        ...
                        children: t.rv
                          ?.premGap != null ?
                          `${t.rv.premGap>0?"+":""}${t.rv.premGap.toFixed(1)}%` :
                          "—"
                      })]
                    })]
                }, t.ticker))
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("span", {
              ...
              className: "flex rounded overflow-hidden border border-border/60 h-7",
              children: [20, 60, 120, 250].map(t => e.jsxs(
                "button", {
                  onClick: () => Re(t),
              ...
              max: 2e3,
              value: K,
              onChange: t => Re(Math.max(5, parseInt(t.target
                .value) || 60)),
              className: "h-7 w-14 text-[11px] bg-muted/20 border-border text-center px-1",
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("span", {
              ...
              max: 2e3,
              value: se,
              onChange: t => Je(Math.max(5, parseInt(t.target
                .value) || 52)),
              className: "h-7 w-14 text-[11px] bg-muted/20 border-border text-center px-1",
            ...
            children: [e.jsx("span", {
              ...
              max: 500,
              value: me,
              onChange: t => Qe(Math.max(2, parseInt(t.target
                .value) || 8)),
              className: "h-7 w-14 text-[11px] bg-muted/20 border-border text-center px-1",
            ...
            children: [e.jsx("span", {
              ...
              max: 2e3,
              value: pe,
              onChange: t => Xe(Math.max(5, parseInt(t.target
                .value) || 52)),
              className: "h-7 w-14 text-[11px] bg-muted/20 border-border text-center px-1",
            ...
            children: [e.jsx("span", {
              ...
              max: 1,
              value: ae,
              onChange: t => et(Math.max(0, Math.min(1,
            ...
            children: [e.jsx("span", {
              ...
              max: 9999,
              value: ie,
              onChange: t => tt(Math.max(1, parseInt(t.target
                .value) || 500)),
              className: "h-7 w-14 text-[11px] bg-muted/20 border-border text-center px-1",
            ...
            children: [e.jsx("span", {
              ...
              className: "flex rounded overflow-hidden border border-border/60 h-7",
              children: ["all", "extreme", "mean_revert"].map(t =>
                e.jsx("button", {
                  onClick: () => rt(t),
              ...
              children: [e.jsx("thead", {
                ...
                children: q.map((t, a) => {
                  const n = m => {
                      ...
                      const h = Math.abs(m);
                      return h >= 2 ? "text-red-400" :
                        h >= 1.5 ? "text-amber-400" :
                        "text-foreground"
                    },
                    p = (m, h = 2) => m != null ? Number(
                      m).toFixed(h) : "—";
                  return e.jsxs("tr", {
                    className: `border-b border-border/30 hover:bg-muted/20 transition-colors ${a%2===0?"":"bg-muted/5"}`,
                    ...
                    children: [e.jsxs("td", {
                      ...
                      className: "px-1.5 py-1.5 text-right font-mono tabular-nums",
                      children: p(t.correlation,
                        3)
                    }), e.jsx("td", {
                      className: "px-1.5 py-1.5 text-right font-mono tabular-nums",
                      children: p(t.rollingBeta,
                        3)
                    }), e.jsx("td", {
                      className: "px-1.5 py-1.5 text-right font-mono tabular-nums",
                      children: p(t.rollingR2,
                        3)
                    }), e.jsx("td", {
                      className: "px-1.5 py-1.5 text-right font-mono tabular-nums",
                      children: p(t
