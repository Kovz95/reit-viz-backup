...
const pe = ["close", "open", "high", "low", "P/E LTM", "P/E FY2", "P/S LTM", "P/S FY2",
    "EV/EBITDA LTM", "EV/EBITDA FY2", "P/FFO LTM", "P/FFO FY2", "P/AFFO LTM", "P/AFFO FY2",
    "Implied Cap Rate", "FFO Yield LTM", "FFO Yield FY2", "AFFO Yield LTM", "AFFO Yield FY2",
    "Dividend Yield", "EPS FY1", "EPS FY2", "FFO FY1", "FFO FY2", "AFFO FY1", "AFFO FY2",
    "EBITDA FY1", "EBITDA FY2", "Sales FY1", "Sales FY2", "EPS LTM", "FFO LTM", "AFFO LTM",
    "EBITDA LTM", "Sales LTM", "EPS FY0", "FFO FY0", "AFFO FY0", "Dividend", "Enterprise Value",
    "FY1 EPS Growth", "FY2 EPS Growth", "FY1 FFO Growth", "FY2 FFO Growth", "FY1 AFFO Growth",
    "FY2 AFFO Growth", "52wk High", "52wk Low", "% off 52wk High", "% off 52wk Low",
    "1Y Price Chg%", "6M Price Chg%", "3M Price Chg%", "1M Price Chg%", "Short Interest%",
...
function Ye() {
  ...
  const [m, S] = i.useState("workbook"), [k, M] = i.useState(""), [v, A] = i.useState("sector"), [x,
      u
    ] = i.useState(""), [p, L] = i.useState("All"), [w, r] = i.useState("small"), [N, y] = i
    .useState(30), [a, j] = i.useState("ticker"), [f, n] = i.useState("asc"), [l, g] = i.useState(
    []), {
      baskets: F
      ...
      total: 0,
      current: ""
    }), [O, D] = i.useState([]), [H, ee] = i.useState([]), X = i.useRef(0), [re, oe] = i.useState(
      null);
  i.useEffect(() => {
    ...
    children: [e.jsxs("div", {
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsxs("label", {
          ...
          children: [e.jsx("span", {
            ...
            children: ["workbook", "basket", "classification"].map(t =>
              e.jsx("button", {
                onClick: () => S(t),
          ...
          children: [e.jsx("span", {
            ...
            className: "flex rounded border border-border/40 overflow-hidden",
            children: ["1Y", "3Y", "5Y", "All"].map(t => e.jsx(
            "button", {
              onClick: () => L(t),
        ...
        children: [Y ? e.jsxs("span", {
          ...
          children: [O.length, " computed", H.length > 0 &&
            ` · ${H.length} n/a (${H.slice(0,6).join(", ")}${H.length>6?"…":""})`
          ]
        }), e.jsxs("span", {
          ...
          children: [e.jsx("span", {
            className: "text-foreground/40",
            children: "Sort:"
          }), ["ticker", "current", "percentile", "z", "median"].map(t =>
            e.jsxs("button", {
              onClick: () => ae(t),
      ...
      children: [Y && O.length === 0 && e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: ["All ", H.length,
            " tickers returned n/a. Try a different metric in the sidebar."
          ]
        })]
      ...
      children: e.jsxs("svg", {
        ...
        children: [e.jsx("line", {
          ...
          const l = S.has(n.ticker),
            ...
            $ = g ? 2.5 : 1,
            O = n.pts.map((D, H) =>
              `${H===0?"M":"L"}${D.x.toFixed(1)},${j(D.y).toFixed(1)}`).join(
              " ");
          return e.jsxs("g", {
            children: [e.jsx("path", {
              d: O,
      ...
      children: [e.jsxs("div", {
        ...
        return e.jsxs("div", {
          ...
          children: [e.jsx("span", {
            ...
            style: {
              backgroundColor: l ? q(n.ticker, 1) :
      ...
      children: [e.jsx("line", {
        ...
        return e.jsxs("g", {
          ...
          children: [e.jsx("rect", {
            ...
            cy: a,
            r: 3.5,
            fill: Math.abs(r.z) > 1 ? r.z > 0 ? "rgb(248 113 113)" :
              "rgb(52 211 153)" : "rgb(251 191 36)",
