...
function Ke(o, s) {
  ...
  let i = 0;
  for (let r = 0; r < o.length; r++) i += o[r], r >= s && (i -= o[r - s]), r >= s - 1 && (l[r] = i /
    s);
  return l
}
...
function Mr(o, s) {
  ...
  for (let n = s + 1; n < o.length; n++) {
    const p = o[n] - o[n - 1],
      z = p > 0 ? p : 0,
      se = p < 0 ? -p : 0;
    i = (i * (s - 1) + z) / s, r = (r * (s - 1) + se) / s, l[n] = r === 0 ? i === 0 ? 50 : 100 :
      100 - 100 / (1 + i / r)
  }
  return l
}
...
function Ut(o, s, l) {
  ...
  switch (o.kind) {
    ...
    case "death_cross": {
      ...
      l.smaByPeriod.has(o.fastPeriod) || l.smaByPeriod.set(o.fastPeriod, r), l.smaByPeriod.has(o
        .slowPeriod) || l.smaByPeriod.set(o.slowPeriod, n);
      for (let p = 1; p < s.length; p++) {
        if (r[p] === null || n[p] === null || r[p - 1] === null || n[p - 1] === null) continue;
        const z = r[p] > n[p],
          se = r[p - 1] > n[p - 1];
        o.kind === "golden_cross" && z && !se && i.push(p), o.kind === "death_cross" && !z && se &&
          i.push(p)
      }
      break
    }
    ...
    case "price_below": {
      ...
      for (let n = 1; n < s.length; n++) {
        ...
        const p = s[n] > r[n],
          z = s[n - 1] > r[n - 1];
        o.kind === "price_above" && p && !z && i.push(n), o.kind === "price_below" && !p && z && i
          .push(n)
      }
      break
    }
    ...
    case "roc_below_thresh": {
      ...
      const n = o.threshold;
      for (let p = 1; p < s.length; p++) !Number.isFinite(r[p]) || !Number.isFinite(r[p - 1]) || (o
        .kind === "roc_above_thresh" && r[p - 1] <= n && r[p] > n && i.push(p), o.kind ===
        "roc_below_thresh" && r[p - 1] >= -n && r[p] < -n && i.push(p));
      break
    }
    case "roc_zero_up":
    case "roc_zero_down": {
      const r = l.rocByPeriod.get(o.rocPeriod) ?? xt(s, o.rocPeriod);
      l.rocByPeriod.has(o.rocPeriod) || l.rocByPeriod.set(o.rocPeriod, r);
      for (let n = 1; n < s.length; n++) !Number.isFinite(r[n]) || !Number.isFinite(r[n - 1]) || (o
        .kind === "roc_zero_up" && r[n - 1] <= 0 && r[n] > 0 && i.push(n), o.kind ===
        "roc_zero_down" && r[n - 1] >= 0 && r[n] < 0 && i.push(n));
      break
    }
    ...
    case "rsi_cross_down_hi": {
      ...
      for (let n = 1; n < r.length; n++) {
        const p = r[n],
          z = r[n - 1];
        p === null || z === null || (o.kind === "rsi_cross_up_lo" && z <= 30 && p > 30 && i.push(n),
          o.kind === "rsi_cross_down_hi" && z >= 70 && p < 70 && i.push(n))
      }
      break
    }
  }
...
function eo() {
  const [o, s] = d.useState([]), [l, i] = d.useState(""), [r, n] = ct("combo-input-selection", Vt),
    [p, z] = d.useState(null), [se, Te] = d.useState(!1), [v, de] = d.useState(""), [$, ge] = d
    .useState(""), [u, ue] = d.useState("single"), [Q, ft] = d.useState([]), [me, bt] = d.useState(
      "stocks"), {
      baskets: Re
    } = lr(), [B, Ue] = d.useState("3M"), [Ve, Gt] = d.useState("composite"), Be = d.useMemo(() =>
      ar(Ve), [Ve]), [pe, gt] = d.useState("both"), [xe, ht] = d.useState(2), [ne, Ge] = d.useState(
      .05), [he, yt] = d.useState(15), [Me, kt] = d.useState(0), [le, qe] = d.useState(1), [we,
    jt] = d.useState(10), [qt, Ye] = d.useState("10y"), [G, We] = d.useState(() => ir()), [M, Ne] =
    d.useState(!1), [vt, wt] = d.useState({
      current: 0,
      total: 0
    }), [ye, Fe] = ct("combo:results", []), [Ie, Nt] = d.useState(""), [Je, Ct] = d.useState(null),
    [Yt, Wt] = d.useState(new Set), Jt = d.useCallback(e => {
      Wt(c => {
        const k = new Set(c);
        return k.has(e) ? k.delete(e) : k.add(e), k
      })
    }, []), [Ce, Xe] = d.useState("optimize"), [te, Ze] = d.useState(""), [fe, Pt] = d.useState([]),
    [ee, Qe] = d.useState("long"), [Pe, et] = ct("combo:evalResult", null), [Ee, _t] = d.useState(
      null), [tt, q] = d.useState(!1), rt = d.useRef(!1), Xt = d.useRef(!1), {
      frequency: ae,
      setFrequency: ot,
      frequencyUI: Zt
      ...
      ({
        ...
        frequency: ae,
        inputSelection: r
      }), [l, v, $, Q, me, u, B, pe, xe, ne, he, Me, le, we, Ce, ee, te, fe, ye, Je, Pe, ae, r]),
    nt = d.useCallback(e => {
      if (e && (e.selectedTicker && (i(e.selectedTicker), Xt.current = !0), e.pairTickerA && de(e
            .pairTickerA), e.pairTickerB && ge(e.pairTickerB), (e.mode === "single" || e.mode ===
            "universe" || e.mode === "pair" || e.mode === "pairCombo" || e.mode === "basket") &&
          ue(e.mode), e.pairCombo && Le.hydrate(e.pairCombo), Array.isArray(e.basketTickers) &&
          ft(e.basketTickers.filter(c => typeof c == "string")), (e.basketMode === "stocks" || e
            .basketMode === "combined") && bt(e.basketMode), (e.horizon === "1M" || e.horizon ===
            "2M" || e.horizon === "3M" || e.horizon === "6M") && Ue(e.horizon), (e.direction ===
            "both" || e.direction === "buy" || e.direction === "sell") && gt(e.direction),
          typeof e.maxFilters == "number" && ht(e.maxFilters), typeof e.targetReturn ==
          "number" && Ge(e.targetReturn), typeof e.minSignals == "number" && yt(e.minSignals),
          typeof e.minLift == "number" && kt(e.minLift), typeof e.minHold == "number" && qe(e
            .minHold), typeof e.topN == "number" && jt(e.topN), (e.view === "optimize" || e
            .view === "evaluate") && Xe(e.view), (e.evalDirection === "long" || e
            .evalDirection === "short") && Qe(e.evalDirection), typeof e.evalTriggerKey ==
          "string" && Ze(e.evalTriggerKey), Array.isArray(e.evalFilterKeys) && Pt(e
            .evalFilterKeys), Array.isArray(e.results) && Fe(e.results), e.expandedTicker !==
          void 0 && Ct(e.expandedTicker), e.evalResult !== void 0 && et(e.evalResult), e
          .frequency === "daily" || e.frequency === "weekly" || e.frequency ===
          "weekly_on_daily" ? ot(e.frequency) : e.timeframe === "weekly" && e.frequency ===
          void 0 && ot("weekly"), e.inputSelection && typeof e.inputSelection == "object")) {
  ...
  d.useEffect(() => {
    ur().then(e => {
      s(e), e.length > 0 && (i(e[0].ticker), de(e[0].ticker), ge(e[1]?.ticker ?? e[0]
        .ticker))
    })
  }, []), d.useEffect(() => {
    R.length > 0 && l && o.some(e => e.ticker === l) && !R.find(e => e.ticker === l) && i(R[0]
      .ticker)
  }, [R, l, o]);
  const Y = d.useMemo(() => $r(), []),
    O = d.useMemo(() => Ar(), []),
        ...
        try {
          ...
          if (u === "pair" || u === "pairCombo") {
            ...
            if (ae === "weekly_on_daily") {
              if (g = w, I = N, A = D, F = H, U = F.map(T => J.get(T) ?? -1), w.length < 252)
                continue
            } else {
              const T = dt({
                dates: H,
              ...
              g = T.adjCloses, I = T.highs, A = T.lows, F = T.dates, U = F.map(K => J.get(K) ??
                -1);
          ...
          for (const a of at) {
            ...
            b += N.length;
            const D = N.map(j => _(j, a.direction === "buy" ? "buy" : "sell")).filter(j => j !==
              null && j.returns[B] !== null);
            ...
            const H = $t(D, a.direction === "buy" ? "buy" : "sell"),
              ...
              X = (j, C) => {
                ...
                const y = j.map(L => _(L, a.direction === "buy" ? "buy" : "sell")).filter(L =>
                  L !== null && L.returns[B] !== null);
          ...
          const S = Me / 100,
            V = h.filter(a => a.filterLabels.length === 0 ? !0 : (a.summary.hitRate[B] ?? 0) - a
              .baselineHitRate >= S);
    ...
    or = d.useCallback(async () => {
      ...
      try {
        ...
        if (ae === "weekly") {
          ...
          if (A = h.adjCloses, E = h.highs, F = h.lows, w = h.dailyIndexMap.map(b => I[b] ?? -
            1), g = h.dates, f) {
  ...
  const St = d.useMemo(() => {
    ...
    Tt = d.useMemo(() => u === "pair" ? `${v||"A"}/${$||"B"}` : u === "single" ? l || "—" : R[0]
      ?.ticker || "—", [u, v, $, l, R]),
    He = d.useMemo(() => {
      const e = Ie.trim().toLowerCase(),
        c = e ? ye.filter(k => k.ticker.toLowerCase().includes(e) || k.name && k.name
    ...
    sr = () => {
      ...
      const c = Object.keys(e[0] || {}),
        k = [c.join(","), ...e.map(m => c.map(f => `"${String(m[f]??"").replace(/"/g,'""')}"`).join(
          ","))].join(`
`),
    ...
    nr = e => e >= .1 ? "text-emerald-400 font-bold" : e >= .05 ? "text-emerald-400" : e >= .02 ?
    "text-emerald-500/80" : e > 0 ? "text-foreground" : e > -.02 ? "text-muted-foreground" :
    "text-red-400";
  return t.jsxs("div", {
    ...
    children: [t.jsxs("div", {
      ...
      children: [t.jsx("h2", {
        ...
        children: Ce === "optimize" ? "Search trigger+filter patterns by hit rate" :
          "Score one specific trigger+filter setup"
      }), t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsxs("div", {
              ...
              children: [t.jsx("p", {
                ...
                children: [Math.round((Date.now() - p) / 6e4),
                  "m ago"
                ]
              }), t.jsx("button", {
                onClick: async () => {
            ...
            }), u !== "pair" && u !== "pairCombo" && Zt, u ===
            "pairCombo" && t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                className: "flex gap-px",
                children: ["both", "buy", "sell"].map(e => t.jsx(
                  "button", {
              ...
              children: [t.jsx("label", {
                ...
                className: "flex gap-px",
                children: ["1M", "2M", "3M", "6M"].map(e => t.jsx(
                  "button", {
              ...
              children: [t.jsx("label", {
                ...
                onChange: e => Ge(Math.max(.005, Math.min(.5,
                  Number(e.target.value) / 100 || .05))),
                disabled: M,
              ...
              children: [t.jsx("label", {
                ...
                children: [0, 1, 2].map(e => t.jsx("button", {
                  ...
                  disabled: M,
                  title: e === 0 ?
                    "Trigger alone (baseline only)" :
                    `Up to ${e} AND-combined filters`,
                  children: e
                }, e))
              })]
            }), t.jsxs("div", {
              ...
              children: [t.jsx("label", {
                ...
                value: he,
                onChange: e => yt(Math.max(1, Math.min(500, Math
                  .floor(Number(e.target.value) || 1)))),
                disabled: M,
              ...
              children: [t.jsx("label", {
                ...
                className: "text-xs font-mono bg-background border border-border rounded px-1.5 py-1 w-14",
                value: le,
                onChange: e => qe(Math.max(0, Math.min(60, Math
              ...
              children: [t.jsx("label", {
                ...
                className: "text-xs font-mono bg-background border border-border rounded px-1.5 py-1 w-14",
                value: we,
                onChange: e => jt(Math.max(1, Math.min(50, Math
                  .floor(Number(e.target.value) || 10)))),
                disabled: M,
          ...
          children: [t.jsxs("span", {
            ...
            children: ["Combos/trigger: ", t.jsx("span", {
              className: "text-foreground",
              children: xe === 0 ? 1 : xe === 1 ? 1 + O.length :
                1 + O.length + O.length * (O.length - 1) / 2
            })]
          })]
        })]
      }), t.jsxs("div", {
        ...
        children: [ye.length === 0 && !M && t.jsxs("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsx("input", {
              ...
              className: "text-[10px] font-mono text-muted-foreground",
              children: [He.length, " ticker", He.length !== 1 ?
                "s" : ""
              ]
            }), t.jsxs("div", {
              className: "flex items-center gap-1",
            ...
            children: t.jsxs("table", {
              ...
              children: [t.jsx("thead", {
                ...
                children: He.map(e => {
                  const c = Je === e.ticker;
                  return (c ? e.topCombos : e.topCombos
                    .slice(0, 1)).flatMap((x, m) => {
                    const f = x.summary.hitRate[B] ??
                      0,
                      g = f - x.baselineHitRate,
                      I = x.summary.avgReturn[B] ?? 0,
                      A = x.summary.profitFactor[B] ??
                      0,
                      E = m === 0,
                      F = x.direction === "buy" ?
                      "bg-emerald-600/5 hover:bg-emerald-600/10" :
                      "bg-red-600/5 hover:bg-red-600/10",
                      U =
                      `${e.ticker}::${m}::${x.triggerLabel}::${x.filterLabels.join("|")}`,
                      w = Yt.has(U),
                      re = !!(c && x.profiles && x
                        .profiles.length >= 10 && e
                        .priceContext),
                      ie = [];
            ...
            children: ["Click a row to expand all top ", we,
              " combos for that ticker. Lift = combo hit rate − trigger-alone hit rate."
            ]
          })]
        })]
      })]
      ...
      children: [t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsx("label", {
              ...
              onChange: e => Ge((parseFloat(e.target.value) ||
                5) / 100),
        ...
        children: [_e && t.jsxs("div", {
          ...
          children: [t.jsx("span", {
            ...
            }), "-side event (typically traded ", _e.expected,
            ") but you are scoring it as ", t.jsx("span", {
              className: "uppercase",
              children: _e.chosen
            }), ". Results will reflect that fade. Switch Side to ", t.jsx(
              "span", {
          ...
          ticker: Ee.mode === "pair" ? Ee.pairLegA || "" : l || R[0]
            ?.ticker || "",
          priceContext: Ee,
          signals: Pe.profiles,
