...
function bt(n, N) {
  ...
  return n.type === "horizontal" || n.type === "fib" ? new Array(T).fill(n.price) : n.type ===
    "ma" && n.maType && n.maPeriod ? ct(N.closes, n.maPeriod, n.maType) : new Array(T).fill(null)
}
...
function kt(n) {
  return n.type === "ma" ? `MA: ${n.maType??"MA"}(${n.maPeriod??"?"})` : n.type === "fib" ?
    `Fib ${((n.fibLevel??0)*100).toFixed(1)}%` : "Horizontal"
}
...
function yt() {
  ...
  const [p, de] = o.useState("universe"), [D, pe] = o.useState(""), [V, ue] = o.useState(""), [J,
      me] = o.useState(""), [q, xe] = o.useState(""), [k, he] = o.useState(() => Xe()), [E, fe] = o
    .useState(""), [L, ge] = o.useState(() => new Set), [re, Oe] = o.useState("workbook"), {
      metas: be
    } = gt(), He = 50, ee = 500, [se, ke] = o.useState("3y"), [I, ye] = o.useState(() => $e("3y")),
    [X, ve] = o.useState("daily"), [R, je] = o.useState(!0), [$, Ne] = o.useState(!0), [B, Se] = o
    .useState(!0), [w, Ce] = o.useState(!0), Q = R || $ || B, [U, Ae] = o.useState(1), [O, Te] = o
    .useState(0), [H, we] = o.useState(10), Fe = o.useMemo(() => ({
      ...lt,
      enableHorizontal: R,
      enableMA: $,
      enableFib: B
      ...
      current: 0,
      total: 0
    }), [_, ae] = o.useState([]), [z, oe] = o.useState([]), ie = o.useRef(!1), S = o.useMemo(() =>
      p !== "pairCombo" ? [] : k.economy.size + k.sector.size + k.subsector.size + k.industryGroup
      .size + k.industry.size + k.subindustry.size + L.size + (E.trim().length > 0 ? 1 : 0) === 0 ?
      [] : Qe(re === "global" ? be : n, k, E, L).map(c => c.ticker.toUpperCase()).filter((c, a,
        s) => s.indexOf(c) === a), [p, n, be, re, k, E, L]), te = o.useMemo(() => {
      const e = S.length;
      ...
      if (!(!e || typeof e != "object")) {
        if (typeof e.source == "string" && de(e.source), typeof e.basketId == "string" && pe(e
            .basketId), typeof e.singleTicker == "string" && ue(e.singleTicker), typeof e
          .pairTickerA == "string" && me(e.pairTickerA), typeof e.pairTickerB == "string" && xe(e
            .pairTickerB), e.pcFiltersSer && typeof e.pcFiltersSer == "object") {
        ...
        typeof e.pcClassSearch == "string" && fe(e.pcClassSearch), Array.isArray(e
            .pcManualTickersSer) && ge(new Set(e.pcManualTickersSer)), typeof e.datePreset ==
          "string" && ke(e.datePreset), e.dateRange && ye(e.dateRange), e.timeframe && ve(e
            .timeframe), typeof e.scanHorizontal == "boolean" && je(e.scanHorizontal), typeof e
          .scanMA == "boolean" && Ne(e.scanMA), typeof e.scanFib == "boolean" && Se(e.scanFib),
          typeof e.scanTrendlines == "boolean" && Ce(e.scanTrendlines), typeof e.lookback ==
          "number" && Ae(e.lookback), typeof e.minScore == "number" && Te(e.minScore), typeof e
          .topN == "number" && we(e.topN), Array.isArray(e.rows) && ae(e.rows), Array.isArray(e
            .skipped) && oe(e.skipped)
      }
    }, []);
  ...
  const Ke = o.useCallback(async () => {
      ...
      for (let c = 0; c < m.length && !ie.current; c++) {
        ...
        try {
          ...
          if (p === "pair" || p === "pairCombo") {
            ...
            j = A.map(v => h[v]), s = A.map(v => u[v]), i = s.slice(), C = s.slice(), f = s
              .length
          } else {
            ...
            s = d.adjCloses, i = d.highs.map((x, h) => {
              const u = d.closes[h],
                b = d.adjCloses[h];
              return u && u > 0 && Number.isFinite(u) && Number.isFinite(b) ? x * (b / u) :
                x
            }), C = d.lows.map((x, h) => {
              const u = d.closes[h],
                b = d.adjCloses[h];
      ...
      r.sort((c, a) => c.candlesAgo !== a.candlesAgo ? c.candlesAgo - a.candlesAgo : a.score - c
        .score), ae(r), oe(e), Me(!1)
    ...
    We = o.useCallback(e => {
      try {
        ...
        c.textContent = `Sent ${e.subtype} for ${l} → Charts tab`, c.className =
          ...
          document.body.appendChild(c), setTimeout(() => {
            c.remove()
          }, 2500), r && e.pairA && e.pairB ? nt(e.pairA.toUpperCase(), e.pairB.toUpperCase()) :
          at(l)
      } catch (r) {
    ...
    children: t.jsxs("div", {
      ...
      children: [t.jsxs("div", {
        ...
        children: [t.jsx("span", {
          ...
          children: "Source"
        }), ["single", "pair", "pairCombo", "basket", "universe"].map(e => t.jsx(
          "button", {
            ...
            title: e === "pairCombo" ?
              ...
              void 0,
            children: e === "single" ? "Single" : e === "pair" ? "Pair (A/B)" :
              e === "pairCombo" ? "Pair combo" : e === "basket" ? "Basket" :
              "Universe"
          ...
          children: p === "pairCombo" ?
            `${S.length} leg${S.length===1?"":"s"} → ${m.length} pair${m.length===1?"":"s"} queued${te>m.length?` (capped from ${te})`:""}` :
            `${m.length} ticker${m.length===1?"":"s"} queued`
        ...
        children: [t.jsx(ft, {
          ...
          children: [S.length < 2 ? t.jsx(t.Fragment, {
            ...
            children: [S.length, " legs → ", t.jsx("span", {
                className: "font-bold",
                children: te
              }), " unordered pairs (A/B == B/A)", " ", te > ee && t
              .jsxs("span", {
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsx("label", {
            ...
            children: [t.jsxs("label", {
              ...
              children: [R && "Horizontal", $ && "MA", B && "Fib",
                w && "Trendlines"
              ].filter(Boolean).join(" · ") || t.jsx("span", {
          ...
          children: ne ? t.jsx("button", {
            ...
            title: !Q && !w ? "Select at least one detector category" :
              void 0,
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsxs("span", {
            ...
            children: ["Results: ", _.length, " cross", _.length === 1 ?
              "" : "es", z.length > 0 && t.jsxs("span", {
                className: "ml-2 text-[10px] text-muted-foreground",
