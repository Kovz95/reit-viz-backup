...
function Zt() {
  const [i, R] = u.useState([]), [m, c] = u.useState("P/FFO LTM"), [x, k] = u.useState("threshold"),
    [g, N] = u.useState(.05), [b, $] = u.useState(.05), [S, l] = u.useState(.1), [h, C] = u
    .useState(-2), [f, M] = u.useState(2), [w, te] = u.useState("breakout"), [v, re] = u.useState(
      "scan"), [F, se] = u.useState("subsector"), [A, G] = u.useState("ratio"), [Z, Se] = u
    .useState(""), [V, ve] = u.useState(""), [y, Oe] = u.useState(!1), {
      frequency: ne,
      setFrequency: De,
      frequencyUI: ct
      ...
      total: 0,
      label: ""
    }), [q, le] = Nt("pair:results", []), [oe, Xe] = u.useState(null), [K, qe] = u.useState(
    "score"), we = u.useRef(!1), Re = u.useRef(!1), {
      universeTickers: Me,
      isFiltered: it
    } = kt(), Ue = u.useMemo(() => Me ? i.filter(e => Me.has(e.ticker)) : i, [i, Me]), ae = Lt(Ue,
      v === "scan", "pair-opt-clf"), ce = v === "scan" ? ae.filteredTickers : Ue, [dt, ut] = u
    .useState(ot);
  u.useEffect(() => {
    St().then(e => {
      if (R(e), e.length > 0 && !Re.current && (Se(e[0].ticker), ve(e.length > 1 ? e[1]
          .ticker : e[0].ticker)), e.length > 0 && e[0].metrics) {
  ...
  const Be = u.useCallback(async (e, r, o, p, a, n, d, B, T = "ratio", pe = "breakout", We =
      "daily") => {
      const U = pe;
      try {
        const [Ye, Ge] = await Promise.all([at(e), at(r)]), Ze = vt(o), Ve = wt(o), Ke = Ye[o],
          Qe = Ge[o], Je = Ye.close, et = Ge.close;
        ...
        const de = T === "ratio" ? P.map(s => fe.get(s) / ie.get(s)) : P.map(s => fe.get(s) - ie
            .get(s)),
        ...
        for (const s of Xt) {
          ...
          for (let ee = 0; ee < j.length; ee++) {
            ...
            if (W !== null) {
              const O = he(ee);
              L && W >= n && _ < n && O >= 0 && nt.push(je(be, O, a, "buy", B)), L && W <= d &&
                _ > d && O >= 0 && lt.push(je(be, O, a, "sell", B)), E && W < n && _ >= n &&
                O >= 0 && Ae.push(je(be, O, a, "buy", B)), E && W > d && _ <= d && O >= 0 && $e
                .push(je(be, O, a, "sell", B))
            }
            W = _
          }
          ...
          if (U === "both") {
            const ee = ke(Fe, "buy", ge),
              _ = ke(Te, "sell", ge);
            (Fe?.count ?? 0) > 0 && (ye++, Ee += ee.score), (Te?.count ?? 0) > 0 && (ye++, Ee +=
              _.score)
          }
    ...
    xt = u.useCallback(async () => {
      ...
      if (v === "manual") {
        ...
        for (let a = 0; a < o.length && !we.current; a++) {
          ...
          T && T.compositeScore > 0 && p.push(T), (a % 10 === 0 || a === o.length - 1) && le([
            ...p
          ])
        }
        le(p)
    ...
    pt = u.useCallback(e => {
      e && (e.selectedMetric && c(e.selectedMetric), typeof e.targetReturn == "number" && N(e
          .targetReturn), typeof e.buyThreshold == "number" && C(e.buyThreshold), typeof e
        .sellThreshold == "number" && M(e.sellThreshold), e.signalType && te(e.signalType), e
        .mode && re(e.mode), e.groupBy && se(e.groupBy), e.spreadMethod && G(e.spreadMethod), e
        .returnMode && k(e.returnMode), typeof e.bandMin == "number" && $(e.bandMin), typeof e
        .bandMax == "number" && l(e.bandMax), e.tickerA && (Se(e.tickerA), Re.current = !0), e
        .tickerB && (ve(e.tickerB), Re.current = !0), Array.isArray(e.results) && le(e.results),
        e.expandedPair !== void 0 && Xe(e.expandedPair), e.sortBy && qe(e.sortBy), Ht(e
          .frequency) && De(e.frequency))
    }, [De]);
  At("pair-optimizer", mt, pt);
  const me = u.useMemo(() => {
      const e = [...q];
      return K === "score" ? e.sort((r, o) => o.compositeScore - r.compositeScore) : K ===
        "halfLife" ? e.sort((r, o) => r.halfLife - o.halfLife) : e.sort((r, o) => r
          .hurstExponent - o.hurstExponent), e
    }, [q, K]),
    ft = () => {
      const e = Y.filter((n, d) => d >= 2),
        r = me.map(n => {
          ...
          return e.forEach(B => {
            d[`buy_hitRate_${B.label}`] = n.buySummary?.hitRate[B.label] ?? null, d[
              `sell_hitRate_${B.label}`] = n.sellSummary?.hitRate[B.label] ?? null
          }), d
        }),
        o = Object.keys(r[0] || {}),
        p = [o.join(","), ...r.map(n => o.map(d => `"${String(n[d]??"").replace(/"/g,'""')}"`).join(
          ","))].join(`
`),
  ...
  return t.jsxs("div", {
    ...
    children: [t.jsx("div", {
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsx("label", {
            ...
            children: ["scan", "manual"].map(e => t.jsx("button", {
              ...
              onClick: () => re(e),
              disabled: y,
              children: e === "scan" ? "Subsector Scan" :
                "Manual Pair"
            }, e))
          })]
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsx("label", {
              ...
              value: `${b}-${S}`,
              onChange: e => {
                const [r, o] = e.target.value.split("-").map(
                  Number);
                $(r), l(o)
              },
              disabled: y,
          ...
          children: [t.jsx("label", {
            ...
            className: "flex gap-px",
            children: ["breakout", "reversion", "both"].map(e => t.jsx(
              "button", {
                ...
                children: e === "breakout" ? "Breakout" : e ===
                  "reversion" ? "Reversion" : "Both"
              }, e))
          })]
        }), t.jsxs("div", {
          className: "flex flex-col gap-0.5",
      ...
      children: [q.length === 0 && !y && t.jsx("div", {
        ...
        children: v === "scan" ?
          `Scans all pairs within the same ${_e.find(e=>e.key===F)?.label?.toLowerCase()||"group"} for mean-reversion signals` :
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsxs("h3", {
            ...
            children: [me.length, " pairs — ", m, " (", A === "ratio" ?
              "A/B" : "A−B", ") — ", v === "scan" ?
              `by ${_e.find(e=>e.key===F)?.label||F}` : "manual",
              " — ", x === "band" ? `band ${D(b)}–${D(S)}` :
              `target ${D(g)}`
            ]
          }), t.jsxs("div", {
            ...
            children: [
              ["score", "halfLife", "hurst"].map(e => t.jsx(
              "button", {
            ...
            children: [t.jsx("thead", {
              children: t.jsxs("tr", {
                ...
                children: [t.jsx("th", {
                    ...
                    className: "text-center px-2 py-1 font-bold",
                    children: [x === "band" ? "Band" :
                      "Hit", " ", e.label
                    ]
                  }, e.label)), Y.filter((e, r) => r >= 2)
                  .map(e => t.jsxs("th", {
                    className: "text-center px-2 py-1 font-bold",
                    children: ["PF ", e.label]
                  }, `pf-${e.label}`)), t.jsx("th", {
              ...
              children: me.map(e => {
                ...
                return t.jsxs("tr", {
                  ...
                  children: [t.jsxs("td", {
                    ...
                    children: e.hurstExponent.toFixed(
                      3)
                  }), t.jsx("td", {
                    ...
                    children: e.adfPValue <= .01 ?
                      "<.01" : e.adfPValue.toFixed(2)
                  }), t.jsxs("td", {
                  ...
                  }), Y.filter((n, d) => d >= 2).map(
                    n => {
                      const d = p.count > 0 ? p
                        .profitFactor[n.label] : a
                        .profitFactor[n.label];
                      return t.jsx("td", {
            ...
            children: [t.jsxs("h4", {
              ...
              children: [t.jsxs("div", {
                children: [t.jsxs("div", {
                  ...
                  children: ["BUY SPREAD (Long ", e
                    .tickerA, " / Short ", e.tickerB,
                    ") — ", e.buySummary?.count ?? 0,
                    " signals"
                  ]
                }), t.jsxs("table", {
                  className: "w-full text-[10px] font-mono",
                ...
                children: [t.jsxs("div", {
                  ...
                  children: ["SELL SPREAD (Short ", e
                    .tickerA, " / Long ", e.tickerB,
                    ") — ", e.sellSummary?.count ?? 0,
                    " signals"
                  ]
                }), t.jsxs("table", {
                  className: "w-full text-[10px] font-mono",
