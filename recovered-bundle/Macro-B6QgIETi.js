...
const ct = {
  ...
  E = ["#0ea5e9", "#22c55e", "#f59e0b", "#a855f7", "#ec4899", "#14b8a6", "#f97316", "#06b6d4",
    "#8b5cf6", "#ef4444", "#84cc16", "#e879f9", "#fb923c", "#2dd4bf", "#fbbf24"
  ],
  ...
  ut = [{
    ...
    ids: ["PHOE004BPPRIVSA", "DALL148BPPRIVSA", "ATLA013BPPRIVSA", "HOUS448BPPRIVSA",
      "AUST448BPPRIVSA", "NASH947BPPRIVSA"
    ],
    group: "Regional"
  }, {
    label: "Coastal Permits",
    ids: ["NEWY636BPPRIVSA", "LOSA106BPPRIVSA", "SANF806BPPRIVSA", "BOST625BPPRIVSA",
      "SEAT653BPPRIVSA", "CHIC917BPPRIVSA"
    ],
    group: "Regional"
  }, {
    label: "FL Permits",
    ...
    ids: ["MEDLISPRI38060", "MEDLISPRI19100", "MEDLISPRI12060", "MEDLISPRI26420",
      "MEDLISPRI12420", "MEDLISPRI19740"
    ],
    group: "Home Prices"
  }];
let ce = 1;
        ...
        if (r) {
          ...
          if (o.mean.length > 0) {
            ...
            for (const f of o.bands) {
              const y = n.addSeries(N, {
                color: Math.abs(f.mult) === 1 ? "rgba(99, 102, 241, 0.4)" :
          ...
          if (o.length >= 2) {
            ...
            for (const w of [1, -1, 2, -2]) {
              const Y = n.addSeries(N, {
                color: Math.abs(w) === 1 ? "rgba(99, 102, 241, 0.4)" :
                  "rgba(99, 102, 241, 0.25)",
                lineWidth: 1,
                title: `${w>0?"+":""}${w}σ`,
                lineStyle: k.Dotted,
        ...
        children: [
          ["raw", "zscore", "percentile"].map(a => {
            ...
            return t.jsx("button", {
              ...
              title: a === "raw" ? "Raw data" : a === "zscore" ? "Z-Score" :
                "Percentile",
...
function ht() {
  const h = Ce(),
    ...
    [g, G] = u.useState("auto"),
    [q, K] = u.useState(new Set(["Regional Permits (Sunbelt)", "Regional Permits (Coastal)",
      "Regional Labor (Sunbelt)", "Regional Labor (Coastal)", "Regional Employment (Sunbelt)",
      "Regional Employment (Coastal)", "Regional Listing Prices"
    ])),
    te = u.useRef(!1),
    de = u.useCallback(() => ({
      panes: R,
    ...
    ue = u.useCallback(e => {
      e.panes !== void 0 && (A(e.panes), te.current = !0), e.selectedIds !== void 0 && $(e
          .selectedIds), e.macroGridLayout !== void 0 && ee(e.macroGridLayout), e
        .macroChartType !== void 0 && I(e.macroChartType), e.collapsedCategories !== void 0 && K(
          new Set(e.collapsedCategories)), e.indicatorsMap !== void 0 && b(e.indicatorsMap),
        typeof e.showIndicators == "boolean" && J(e.showIndicators), e.addMode !== void 0 && V(e
          .addMode), e.targetPaneId !== void 0 && G(e.targetPaneId)
    }, []);
  Pe("macro", de, ue);
  const [H, a] = u.useState(null), n = u.useRef(new Map), M = u.useRef(null), ie = u.useCallback((e,
      s) => {
      s ? n.current.set(e, s) : n.current.delete(e), M.current && cancelAnimationFrame(M.current),
    ...
    }, []), O = u.useRef(new Map), P = u.useRef(new Map), B = u.useRef(!1), Q = u.useRef(new Map),
    r = u.useCallback((e, s) => {
      O.current.set(e, s);
      const l = c => {
  ...
  const Y = u.useCallback((e, s, l) => {
      A(i => {
        ...
        const c = new Set(i.flatMap(v => v.series.map(D => D.color))),
          m = E.find(v => !c.has(v)) || E[i.reduce((v, D) => v + D.series.length, 0) % E
            .length],
          S = {
            id: e,
            label: s.label || e,
  ...
  u.useCallback(e => {
    A(s => {
      ...
      return l && $(i => i.filter(c => !l.series.some(m => m.id === c))), s.filter(i => i
        .id !== e)
    })
  }, []), u.useEffect(() => {
  ...
  const re = u.useMemo(() => {
    ...
    Se = (e, s) => {
      ...
      })).filter(m => m.series.length > 0)), $(i => i.filter(c => c !== e))) : ($(i => [...i, e]),
        s && f?.[e] && Y(e, s, g !== "auto" ? g : void 0))
    };
  u.useEffect(() => {
    if (f)
      for (const e of x) {
...
`),
    ...
    ye = ["Rates", "Housing", "Labor", "Inflation", "Economy", "Commodities", "Markets",
      "Home Prices", "Regional Permits (Sunbelt)", "Regional Permits (Coastal)",
      "Regional Labor (Sunbelt)", "Regional Labor (Coastal)", "Regional Employment (Sunbelt)",
      "Regional Employment (Coastal)", "Regional Listing Prices"
    ],
    ...
    children: [t.jsxs("div", {
        ...
        children: ye.filter(e => re[e]).map(e => t.jsxs("div", {
          children: [t.jsxs("button", {
            ...
            children: [q.has(e) ? t.jsx(Le, {
              ...
              children: [re[e].filter(s => x.includes(s.id))
                .length, "/", re[e].length
              ]
            })]
          }), !q.has(e) && re[e].map(s => {
            ...
            return t.jsxs("label", {
              ...
              children: [t.jsx("input", {
                ...
                style: {
                  backgroundColor: i.series.find(c => c.id ===
                    s.id)?.color
                }
              }), t.jsx("span", {
      ...
      children: [H && t.jsxs("div", {
        ...
        children: [t.jsx(Me, {
          ...
          className: "text-[10px] text-muted-foreground",
          children: [x.length, " series · ", R.length, " pane", R.length !==
            1 ? "s" : "", w.data && t.jsxs(t.Fragment, {
              children: [" · Last refresh: ", new Date(w.data.timestamp)
                .toLocaleString()
              ]
            })
          ]
