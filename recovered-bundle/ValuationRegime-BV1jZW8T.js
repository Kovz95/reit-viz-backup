...
const ke = [{
  ...
  ve = ["P/E LTM", "P/E FY2", "P/S LTM", "P/S FY2", "EV/EBITDA LTM", "EV/EBITDA FY2", "P/FFO LTM",
    "P/FFO FY2", "P/AFFO LTM", "P/AFFO FY2", "FFO Yield LTM", "FFO Yield FY2", "AFFO Yield LTM",
    "AFFO Yield FY2", "Dividend Yield", "Implied Cap Rate"
  ],
  rt = new Set(["FFO Yield LTM", "FFO Yield FY2", "AFFO Yield LTM", "AFFO Yield FY2",
    "Dividend Yield", "Implied Cap Rate"
  ]);

function at() {
  const [M, we] = c.useState([]), [j, q] = c.useState(["P/FFO LTM", "P/E LTM", "EV/EBITDA LTM",
      "Dividend Yield"
    ]), [u, F] = c.useState(""), [f, J] = c.useState("threshold"), [S, ee] = c.useState(.05), [k,
    W] = c.useState(.05), [N, V] = c.useState(.1), [R, te] = c.useState("single"), [b, z] = c
    .useState(!1), [v, re] = c.useState({
      current: 0,
      total: 0
    }), [w, O] = c.useState([]), [C, se] = c.useState(null), [$, oe] = c.useState("score"), [ne,
    Me] = c.useState("best"), U = c.useRef(!1), le = c.useRef(!1), {
      universeTickers: H,
      isFiltered: Se
    } = Ie(), h = c.useMemo(() => H ? M.filter(e => H.has(e.ticker)) : M, [M, H]), [Re, Te] = c
    .useState(ve);
  c.useEffect(() => {
    We().then(e => {
    ...
    h.length > 0 && u && M.some(e => e.ticker === u) && !h.find(e => e.ticker === u) && F(h[0]
      .ticker)
  }, [h, u, M]);
  const Be = c.useCallback(async () => {
              ...
              for (const x of ke) {
                ...
                for (let g = 0; g < E.length; g++) {
                  ...
                  const xe = [...de].sort((L, I) => L - I),
                    ...
                    G = ae ? 1 - me : me,
                    ue = x.threshold[1] >= 1;
                  if (!(G >= x.threshold[0] && (ue ? G <= x.threshold[1] : G < x.threshold[1])))
                    continue;
                  if (g > 0) {
                    ...
                    if (I.length >= 20) {
                      const be = [...I].sort((X, De) => X - De),
                        ...
                        Q = ae ? 1 - pe : pe;
                      if (Q >= x.threshold[0] && (ue ? Q <= x.threshold[1] : Q < x.threshold[
                        1])) continue
                    }
                  }
                  const Pe = f === "band" ? {
    ...
    Ce = c.useCallback(e => {
      e && (Array.isArray(e.selectedMetrics) && q(e.selectedMetrics), e.selectedTicker && (F(e
          .selectedTicker), le.current = !0), typeof e.targetReturn == "number" && ee(e
          .targetReturn), e.returnMode && J(e.returnMode), typeof e.bandMin == "number" && W(e
          .bandMin), typeof e.bandMax == "number" && V(e.bandMax), e.mode && te(e.mode), Array
        .isArray(e.results) && O(e.results), e.expandedTicker !== void 0 && se(e
        .expandedTicker), e.sortBy && oe(e.sortBy), e.viewMetric && Me(e.viewMetric))
    }, []);
  Ge("val-regime", Fe, Ce);
  const _ = c.useMemo(() => {
      const e = [...w];
      return $ === "score" ? e.sort((s, l) => l.bestScore - s.bestScore) : e.sort((s, l) => s
        .ticker.localeCompare(l.ticker)), e
    }, [w, $]),
    $e = () => {
      const e = p.filter((r, n) => n >= 2),
        s = _.map(r => {
          const n = r.results.reduce((i, m) => i.bestScore > m.bestScore ? i : m, r.results[0]),
            B = n?.bands.reduce((i, m) => i.composite.score > m.composite.score ? i : m, n.bands[
              0])?.summary,
            y = {
              ticker: r.ticker,
              name: r.name,
        ...
        l = Object.keys(s[0] || {}),
        o = [l.join(","), ...s.map(r => l.map(n => `"${String(r[n]??"").replace(/"/g,'""')}"`).join(
          ","))].join(`
`),
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsxs("div", {
            ...
            children: [t.jsx("label", {
              ...
              value: `${k}-${N}`,
              onChange: e => {
                const [s, l] = e.target.value.split("-").map(
                  Number);
                W(s), V(l)
              },
              disabled: b,
      ...
      children: [w.length === 0 && !b && t.jsx("div", {
        ...
        children: t.jsxs("div", {
          ...
          children: [t.jsx("div", {
            ...
            children: [v.current, "/", v.total, " tickers × ", j.length,
              " metrics × ", Ne.length, " windows"
            ]
          }), t.jsx("div", {
        ...
        children: [t.jsxs("div", {
          ...
          children: [t.jsxs("h3", {
            ...
            children: [_.length, " tickers — ", f === "band" ?
              `band ${Y(k)}–${Y(N)}` : `target ${Y(S)}`
            ]
          }), t.jsxs("div", {
            ...
            children: [t.jsx("thead", {
              children: t.jsxs("tr", {
                ...
                children: [t.jsx("th", {
                    ...
                    className: "text-center px-2 py-1 font-bold",
                    children: "Best Band"
                  }), p.filter((e, s) => s >= 2).map(e => t
                    .jsxs("th", {
                      className: "text-center px-2 py-1 font-bold",
                      children: [f === "band" ? "Band" :
                        "Hit", " ", e.label
                      ]
                    }, e.label)), p.filter((e, s) => s >= 2)
                  .map(e => t.jsxs("th", {
                    className: "text-center px-2 py-1 font-bold",
                    children: ["Avg ", e.label]
                  }, `avg-${e.label}`)), p.filter((e, s) =>
                    s >= 2).map(e => t.jsxs("th", {
                    className: "text-center px-2 py-1 font-bold",
                    children: ["PF ", e.label]
                  }, `pf-${e.label}`)), t.jsx("th", {
              ...
              children: _.map(e => {
                const s = e.results.reduce((r, n) => r
                    .bestScore > n.bestScore ? r : n, e.results[
                      0]),
                  o = s?.bands.reduce((r, n) => r.composite
                    .score > n.composite.score ? r : n, s.bands[
                      0])?.summary,
                  a = C === e.ticker;
                return t.jsxs("tr", {
                  ...
                  children: [t.jsx("td", {
                    ...
                    children: e.bestBand
                  }), p.filter((r, n) => n >= 2).map(
                    r => {
                      const n = o ? f === "band" ? o
                        .bandHitRate?.[r.label] ?? o
                        .hitRate[r.label] : o.hitRate[r
                          .label] : 0;
                      return t.jsx("td", {
                    ...
                    r => t.jsx("td", {
                      ...
                      children: o ? ge(o.avgReturn[r
                        .label]) : "–"
                    }, `avg-${r.label}`)), p.filter((r,
                    n) => n >= 2).map(r => t.jsx("td", {
                    className: `text-center px-2 py-1 ${o?et(o.profitFactor[r.label]):""}`,
                    children: o ? o.profitFactor[r
                        .label] >= 99 ? "∞" : o
                      .profitFactor[r.label]
                      .toFixed(2) : "–"
                  }, `pf-${r.label}`)), t.jsx("td", {
          ...
          if (!e) return null;
          const s = new Map;
          for (const l of e.results) s.has(l.metric) || s.set(l.metric, []), s
            .get(l.metric).push(l);
          return t.jsxs("div", {
            ...
            children: [t.jsxs("h4", {
              ...
              children: [e.ticker, " — ", e.name,
                " — All Metric × Window × Band Results"
              ]
