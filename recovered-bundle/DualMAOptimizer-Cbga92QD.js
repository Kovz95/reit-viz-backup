...
function ot(s, n) {
  ...
  for (let l = 0; l < i; l++) {
    ...
    u === null && (T === 1 && $ ? (u = "long", k = l, m = h) : T === -1 && O && n.allowShort && (u =
      "short", k = l, m = h)), N[l] = u === "long" ? 1 : u === "short" ? -1 : 0, f[l] = A
  }
  if (u !== null) {
    const l = i - 1,
      h = s[l],
...
function Kt(s) {
  ...
  for (const i of s.slopeMethods) {
    ...
    n += s.biasMATypes.length * s.biasLens.length * s.triggerMATypes.length * s.triggerLens.length *
      s.slopeLookbacks.length * g.length * s.allowShortOptions.length
  }
  return n
}
...
function ke(s) {
  const n = s.slopeMethod === "diff_pct" ?
    `${Pe[s.slopeMethod]}(${s.slopeLookback}, ${(s.slopeMinPct*100).toFixed(2)}%)` :
    `${Pe[s.slopeMethod]}(${s.slopeLookback})`;
...
function De(s) {
  return s == null || !Number.isFinite(s) ? "text-muted-foreground" : s >= 1 ? "text-emerald-400" :
    s >= .5 ? "text-green-400" : s >= 0 ? "text-yellow-400" : "text-red-400"
}

function X(s) {
  return s == null || !Number.isFinite(s) ? "text-muted-foreground" : s >= 0 ? "text-green-400" :
    "text-red-400"
}

function Be(s) {
  return s == null || !Number.isFinite(s) ? "text-muted-foreground" : s >= -.05 ? "text-green-400" :
    s >= -.15 ? "text-yellow-400" : "text-red-400"
}

function as() {
  const [s, n] = c.useState([]), [i, g] = c.useState(""), [v, j] = c.useState(""), [N, w] = c
    .useState(""), [f, u] = c.useState([]), [k, m] = c.useState("stocks"), {
      baskets: A
    } = bt(), B = c.useRef(!1), [l, h] = be("dual-ma-input-selection", Ft), [y, P] = be(
      "dualma:cfg", Ht), [d, U] = c.useState(y.mode ?? "single"), [T, J] = c.useState(y.gridSize ??
      "quick"), [$] = c.useState(y.topK ?? 10), O = y, [R, b] = c.useState(y.biasMAType ?? "EMA"), [
      L, ye
    ] = c.useState(y.biasLen ?? O.emaLen ?? 50), [Z, Ee] = c.useState(y.triggerMAType ?? "WMA"), [Q,
      Ne
    ] = c.useState(y.triggerLen ?? O.wmaLen ?? 20), [W, $e] = c.useState(y.slopeMethod ?? "diff"), [
      ee, Ie
    ] = c.useState(y.slopeLookback ?? 5), [te, ze] = c.useState(y.slopeMinPct ?? .001), [G, _e] = c
    .useState(y.allowShort ?? !0), [xe, je] = c.useState(""), [ne, pe] = be("dualma:results", []), [
      x, Oe
    ] = be("dualma:evalResult", null), [ue, Ke] = c.useState("optimize"), [_, oe] = c.useState(!1),
    [F, K] = c.useState(!1), [se, qe] = c.useState({
      current: 0,
      total: 0
    }), [Me, He] = c.useState(null), [le, Ue] = c.useState("sharpe"), [ie, ve] = c.useState(!1), [
    q] = c.useState(() => gt()), Te = c.useRef(!1), {
      universeTickers: Se,
      isFiltered: lt
    } = kt(), D = c.useMemo(() => Se ? s.filter(t => Se.has(t.ticker)) : s, [s, Se]), fe = Bt(D,
      d === "universe", "dualma-clf"), Y = Pt(D.map(t => t.ticker), d === "pairCombo",
    "dualma-pc"), {
      frequency: H,
      setFrequency: We,
      frequencyUI: Ge
  ...
  c.useEffect(() => {
    yt().then(t => {
      n(t), t.length > 0 && !B.current && (g(t[0].ticker), je(t[0].ticker)), t.length > 0 &&
        (j(a => a || t[0].ticker), w(a => a || (t[1]?.ticker ?? t[0].ticker)))
    })
  }, []);
  ...
  const ct = c.useCallback(() => ({
    ...
    dt = c.useCallback(t => {
      if (t && (t.selectedTicker && typeof t.selectedTicker == "string" && (g(t.selectedTicker), B
            .current = !0), t.evalTicker && typeof t.evalTicker == "string" && je(t.evalTicker), t
          .pairTickerA && typeof t.pairTickerA == "string" && j(t.pairTickerA), t.pairTickerB &&
          typeof t.pairTickerB == "string" && w(t.pairTickerB), (t.mode === "single" || t.mode ===
            "universe" || t.mode === "pair" || t.mode === "pairCombo" || t.mode === "basket") &&
          U(t.mode), (t.gridSize === "quick" || t.gridSize === "standard" || t.gridSize ===
            "deep") && J(t.gridSize), t.pairCombo && Y.hydrate(t.pairCombo), Array.isArray(t
            .basketTickers) && u(t.basketTickers.filter(a => typeof a == "string")), (t
            .basketMode === "stocks" || t.basketMode === "combined") && m(t.basketMode), Array
          .isArray(t.results) && pe(t.results), t.expandedTicker !== void 0 && He(t
            .expandedTicker), t.sortKey && typeof t.sortKey == "string" && Ue(t.sortKey), typeof t
          .sortAsc == "boolean" && ve(t.sortAsc), typeof t.evalBiasLen == "number" && ye(t
            .evalBiasLen), typeof t.evalTriggerLen == "number" && Ne(t.evalTriggerLen), typeof t
          .evalBiasMAType == "string" && ge.includes(t.evalBiasMAType) && b(t.evalBiasMAType),
          typeof t.evalTriggerMAType == "string" && ge.includes(t.evalTriggerMAType) && Ee(t
            .evalTriggerMAType), typeof t.evalEmaLen == "number" && t.evalBiasLen == null && ye(t
            .evalEmaLen), typeof t.evalWmaLen == "number" && t.evalTriggerLen == null && Ne(t
            .evalWmaLen), (t.evalSlopeMethod === "diff" || t.evalSlopeMethod === "ols" || t
            .evalSlopeMethod === "diff_pct") && $e(t.evalSlopeMethod), typeof t
          .evalSlopeLookback == "number" && Ie(t.evalSlopeLookback), typeof t.evalSlopeMinPct ==
          "number" && ze(t.evalSlopeMinPct), typeof t.evalAllowShort == "boolean" && _e(t
            .evalAllowShort), (t.frequency === "daily" || t.frequency === "weekly" || t
            .frequency === "weekly_on_daily") && We(t.frequency), t.inputSelection && typeof t
  ...
  const xt = c.useCallback(async () => {
    ...
    me = c.useMemo(() => {
      ...
      return t.sort((a, p) => {
        ...
        return Number.isFinite(r) || (r = -1 / 0), Number.isFinite(M) || (M = -1 / 0), ie ?
          r - M : M - r
      }), t
    }, [ne, le, ie]);
  ...
  return e.jsxs("div", {
    ...
    children: [e.jsxs("div", {
      ...
      children: [e.jsx("h2", {
        ...
        children: ue === "optimize" ? "Grid-search EMA/WMA parameter space" :
          "Run one specific DualMA config"
      })]
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("label", {
              ...
              className: "flex gap-px",
              children: ["quick", "standard", "deep"].map(t => e
                .jsx("button", {
                  ...
                  onClick: () => J(t),
                  disabled: _,
                  children: t.charAt(0).toUpperCase() + t.slice(
                    1)
                }, t))
            }), e.jsxs("span", {
            ...
            children: [e.jsx("label", {
              ...
              children: ["single", "universe", "pair", "pairCombo",
                ...
                onClick: () => U(t),
                disabled: _,
                children: t === "single" ? "Single" : t ===
                  "universe" ? "Universe" : t === "pair" ?
                  "Pair" : t === "pairCombo" ? "Pair Combo" :
                  "Basket"
              }, t))
            })]
            ...
            children: e.jsxs("table", {
              ...
              children: [e.jsx("thead", {
                ...
                children: me.map(t => {
                  ...
                  if (!a) return null;
                  const p = Me === t.ticker,
                    S = Number.isFinite(a.stats
                      .totalReturn) && Number.isFinite(a
                      .stats.buyHoldReturn) ? a.stats
                    .totalReturn - a.stats.buyHoldReturn :
                    NaN;
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("label", {
              ...
              step: 1,
              value: L,
              onChange: t => ye(Math.max(2, parseInt(t.target.value,
                10) || 50)),
            ...
            children: [e.jsx("label", {
              ...
              step: 1,
              value: Q,
              onChange: t => Ne(Math.max(2, parseInt(t.target.value,
                10) || 20)),
              className: "text-[11px] font-mono bg-background border border-border rounded px-2 py-1 w-[70px]",
              disabled: F
            })]
            ...
            children: [e.jsx("label", {
              ...
              disabled: F,
              children: Object.entries(Pe).map(([t, a]) => e.jsx(
                "option", {
                  value: t,
                  children: a
                }, t))
            ...
            children: [e.jsx("label", {
              ...
              step: 1,
              value: ee,
              onChange: t => Ie(Math.max(1, parseInt(t.target.value,
                10) || 5)),
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              children: [{
                ...
                label: "Profit Factor",
                value: Number.isFinite(x.stats.profitFactor) ?
                  x.stats.profitFactor > 99 ? "∞" : de(x.stats
                    .profitFactor) : "–",
                color: x.stats.profitFactor >= 1 ?
                  "text-green-400" : "text-red-400"
              }, {
                label: "Max DD",
            ...
            children: [e.jsxs("div", {
              className: "text-[9px] font-mono text-muted-foreground uppercase tracking-wider mb-2",
              children: ["Last ", Math.min(50, x.trades.length),
                " of ", x.trades.length, " Trades"
              ]
            }), e.jsx("div", {
              className: "overflow-x-auto",
              children: e.jsxs("table", {
                ...
                children: [e.jsx("thead", {
                  ...
                  children: x.trades.slice(-50).map((t,
                    a) => {
                    const p = x.trades.length - Math
                      .min(50, x.trades.length) + a;
                    return e.jsxs("tr", {
