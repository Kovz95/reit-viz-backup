...
//
// This module backs the "Diagonal Trendlines" sub-tab of the Levels page. It
// provides the named bindings that LevelsAndTrendlines.tsx imports via:
//   import { d as detectTrendlines, D as TrendlinesPanel, T as TrendlinesSubPanel }
//     from "@/components/Trendlines";
//
//   • d  → detectTrendlines  (the real detection algorithm)
//   • D  → TrendlinesPanel   (default config object, consumed as a value)
//   • T  → TrendlinesSubPanel (the full control panel + results UI)
...
export function TrendlinesSubPanel(): ReactElement {
  ...
  const detectionConfig: TrendlineConfig = useMemo(() => ({
    ...DEFAULT_CONFIG,
    method,
      ...
      <div className="p-3 text-xs font-mono">
        ...
        <div className="grid grid-cols-[auto_1fr_auto] gap-2 items-center mb-2">
          ...
          <div className="flex gap-1 items-center">
            ...
            {([["all", "ALL"], ["20y", "20Y"], ["10y", "10Y"], ["5y", "5Y"], ["3y", "3Y"], ["1y", "1Y"], ["ytd", "YTD"]] as const).map(([val, label]) => (
              <button
                key={val}
