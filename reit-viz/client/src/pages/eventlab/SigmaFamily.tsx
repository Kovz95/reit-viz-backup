// Event Lab port of SigmaMove.tsx (wholesale copy; only the component name differs).
// Original: reconstructed from recovered-bundle/SigmaMove-BeLjHH1_.js on 2026-06-11
