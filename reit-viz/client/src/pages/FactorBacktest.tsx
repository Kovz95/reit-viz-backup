...
const METRIC_GROUPS_BASE: Record<string, string[]> = {
  ...
  Growth:      ["EPS Growth (Default)", "EPS Growth FY1 (Default)", "FY1 FFO Growth", "FY2 FFO Growth", "FY1 AFFO Growth", "FY2 AFFO Growth", "FY1 EPS Growth", "FY2 EPS Growth"],
  Performance: ["1Y Price Chg%", "6M Price Chg%", "3M Price Chg%", "1M Price Chg%", "% off 52wk High", "% off 52wk Low"],
  Estimates:   ["EPS (Default)", "EPS FY1 (Default)", "EPS FY2", "FFO FY2", "AFFO FY2", "EBITDA FY2"],
