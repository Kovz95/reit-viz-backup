    ...
    <div className="h-full overflow-y-auto bg-background">
      <div className="max-w-4xl mx-auto p-4 sm:p-6">
        ...
        <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
          ...
          custom) and rebalance frequency. Expand any saved basket below to edit
          its tickers and weighting, see how each weight is derived, and open the
          metric inspector to view the exact aggregation math.
        </p>
        <div
        ...
        {/* Saved-baskets manager: expand each basket to see its tickers, edit the
            weighting scheme (with the derivation formula), add/remove tickers, and
            open the metric inspector to view the aggregation math. */}
        <div className="mt-4">
          <BasketManager tickers={tickerList ?? []} />
        </div>
      </div>
    </div>
  );
